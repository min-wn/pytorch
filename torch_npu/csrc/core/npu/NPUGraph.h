...
TORCH_NPU_API void dual_fused_infer_attention_score_update(
    ...
    int64_t next_tokens,
    bool softmax_lse_flag);
TORCH_NPU_API void dual_split_fused_infer_attention_score_update(
    c10_npu::NPUStream update_stream,
    NPUTaskGroupHandle handle_0,
    NPUEvent* event_0,
    NPUTaskGroupHandle handle_1,
    NPUEvent* event_1,
    const at::Tensor& query_0,
    const at::Tensor& key_0,
    const at::Tensor& value_0,
    const c10::optional<at::Tensor>& atten_mask_0,
    const c10::optional<at::Tensor>& block_table_0,
    const std::vector<int64_t>& actual_seq_lengths_0,
    const std::vector<int64_t>& actual_seq_lengths_kv_0,
    const c10::optional<at::Tensor>& workspace_0,
    at::Tensor attention_out_0,
    at::Tensor softmax_lse_0,
    int64_t num_heads_0,
    double scale_0,
    ...
    const c10::optional<at::Tensor>& atten_mask_1,
    const c10::optional<at::Tensor>& block_table_1,
    const std::vector<int64_t>& actual_seq_lengths_1,
    const std::vector<int64_t>& actual_seq_lengths_kv_1,
    const c10::optional<at::Tensor>& workspace_1,
    at::Tensor attention_out_1,
    at::Tensor softmax_lse_1,
    int64_t num_heads_1,
    double scale_1,
