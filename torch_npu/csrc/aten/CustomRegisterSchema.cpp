...
int64_t wrapper__npu_change_data_ptr(const at::Tensor & dst, const at::Tensor & src, int64_t index) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_change_data_ptr", dst, src, index);
      int64_t res = at_npu::native::NPUNativeFunctions::npu_change_data_ptr(dst, src, index);
...
int64_t wrapper__get_npu_format(const at::Tensor & self) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("get_npu_format", self);
      int64_t res = at_npu::native::NPUNativeFunctions::get_npu_format(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper_Tensor_npu_format_cast(const at::Tensor & self, const at::Tensor & dst, ::std::optional<int64_t> customize_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_format_cast.Tensor", self, dst, customize_dtype);
      at::Tensor res = at_npu::native::NPUNativeFunctions::npu_format_cast(self, dst, customize_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return at_npu::native::NPUNativeFunctions::npu_format_cast(self, dst, customize_dtype);
}

at::Tensor & wrapper_acl_format_npu_format_cast_(at::Tensor & self, int64_t acl_format, ::std::optional<int64_t> customize_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_format_cast_.acl_format", self, acl_format, customize_dtype);
      at::Tensor & res = at_npu::native::NPUNativeFunctions::npu_format_cast_(self, acl_format, customize_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return at_npu::native::NPUNativeFunctions::npu_format_cast_(self, acl_format, customize_dtype);
}

at::Tensor & wrapper__npu_format_cast_(at::Tensor & self, const at::Tensor & src, ::std::optional<int64_t> customize_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_format_cast_", self, src, customize_dtype);
      at::Tensor & res = at_npu::native::NPUNativeFunctions::npu_format_cast_(self, src, customize_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return at_npu::native::NPUNativeFunctions::npu_format_cast_(self, src, customize_dtype);
}
...
at::Tensor wrapper__empty_with_format(at::IntArrayRef size, ::std::optional<at::ScalarType> dtype, ::std::optional<at::Layout> layout, ::std::optional<at::Device> device, ::std::optional<bool> pin_memory, int64_t acl_format, ::std::optional<int64_t> base_addr_aligned_kb) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("empty_with_format", size, dtype, layout, device, pin_memory, acl_format, base_addr_aligned_kb);
      at::Tensor res = at_npu::native::NPUNativeFunctions::empty_with_format(size, dtype, layout, device, pin_memory, acl_format, base_addr_aligned_kb);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__unsafe_empty_with_format(at::IntArrayRef size, ::std::optional<at::ScalarType> dtype, ::std::optional<at::Layout> layout, ::std::optional<at::Device> device, ::std::optional<bool> pin_memory, int64_t acl_format, bool keep_format) {
  ...
  const c10::DeviceGuard device_guard(device_or_default(device));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("unsafe_empty_with_format", size, dtype, layout, device, pin_memory, acl_format, keep_format);
      at::Tensor res = at_npu::native::NPUNativeFunctions::unsafe_empty_with_format(size, dtype, layout, device, pin_memory, acl_format, keep_format);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper_names_empty_with_format(at::IntArrayRef size, ::std::optional<at::DimnameList> names, ::std::optional<at::ScalarType> dtype, ::std::optional<at::Layout> layout, ::std::optional<at::Device> device, ::std::optional<bool> pin_memory, int64_t acl_format) {
  ...
  const c10::DeviceGuard device_guard(device_or_default(device));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("empty_with_format.names", size, names, dtype, layout, device, pin_memory, acl_format);
      at::Tensor res = at_npu::native::NPUNativeFunctions::empty_with_format(size, names, dtype, layout, device, pin_memory, acl_format);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__copy_memory_(at::Tensor & self, const at::Tensor & src, bool non_blocking) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("copy_memory_", self, src, non_blocking);
      at::Tensor & res = at_npu::native::NPUNativeFunctions::copy_memory_(self, src, non_blocking);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
int64_t wrapper__get_storage_size(const at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("get_storage_size", self);
      int64_t res = at_npu::native::NPUNativeFunctions::get_storage_size(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_format_cast(const at::Tensor & self, int64_t acl_format, ::std::optional<int64_t> customize_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_format_cast", self, acl_format, customize_dtype);
      at::Tensor res = at_npu::native::NPUNativeFunctions::npu_format_cast(self, acl_format, customize_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return at_npu::native::NPUNativeFunctions::npu_format_cast(self, acl_format, customize_dtype);
}
...
at::Tensor wrapper___npu_format_cast(const at::Tensor & self, int64_t acl_format) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_format_cast", self, acl_format);
      at::Tensor res = at_npu::native::NPUNativeFunctions::_npu_format_cast(self, acl_format);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper_aclnn__npu_format_cast(const at::Tensor & self, int64_t acl_format, int64_t customize_dtype) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, self, "wrapper_aclnn__npu_format_cast", "self");
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_format_cast.aclnn", self, acl_format, customize_dtype);
      at::Tensor res = at_npu::native::NPUNativeFunctions::_npu_format_cast(self, acl_format, customize_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return at_npu::native::NPUNativeFunctions::_npu_format_cast(self, acl_format, customize_dtype);
}
...
at::Tensor wrapper__empty_with_swapped_memory(at::IntArrayRef size, ::std::optional<at::ScalarType> dtype, ::std::optional<at::Device> device) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("empty_with_swapped_memory", size, dtype, device);
      at::Tensor res = at_npu::native::NPUNativeFunctions::empty_with_swapped_memory(size, dtype, device);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_top_k_top_p_sample(const at::Tensor & logits, const at::Tensor & top_k, const at::Tensor & top_p, const ::std::optional<at::Tensor> & q, double eps, bool is_need_logits, int64_t top_k_guess) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(logits);
      c10_npu::check_npu_tensor_is_safe(top_k);
      c10_npu::check_npu_tensor_is_safe(top_p);
      c10_npu::check_npu_tensor_is_safe(q);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, logits, "wrapper__npu_top_k_top_p_sample", "logits");
  c10::impl::check_and_update_common_device(common_device, top_k, "wrapper__npu_top_k_top_p_sample", "top_k");
  c10::impl::check_and_update_common_device(common_device, top_p, "wrapper__npu_top_k_top_p_sample", "top_p");
  c10::impl::check_and_update_common_device(common_device, q, "wrapper__npu_top_k_top_p_sample", "q");
  const c10::OptionalDeviceGuard device_guard(device_of(logits));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_top_k_top_p_sample", logits, top_k, top_p, q, eps, is_need_logits, top_k_guess);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_top_k_top_p_sample(logits, top_k, top_p, q, eps, is_need_logits, top_k_guess);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_top_k_top_p_sample(logits, top_k, top_p, q, eps, is_need_logits, top_k_guess);
}
...
at::Tensor wrapper__npu_gather_backward(const at::Tensor & grad, c10::SymIntArrayRef self_size, int64_t dim, const at::Tensor & index, bool sparse_grad) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gather_backward", grad, self_size, dim, index, sparse_grad);
      at::Tensor res = op_plugin::npu_gather_backward_symint(grad, self_size, dim, index, sparse_grad);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
bool wrapper___amp_foreach_non_finite_check(at::TensorList scaled_grads) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_amp_foreach_non_finite_check", scaled_grads);
      bool res = op_plugin::_amp_foreach_non_finite_check(scaled_grads);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_gelu(const at::Tensor & self, c10::string_view approximate) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gelu", self, approximate);
      at::Tensor res = op_plugin::npu_gelu(self, approximate);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_gelu_backward(const at::Tensor & grad_output, const at::Tensor & self, c10::string_view approximate) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gelu_backward", grad_output, self, approximate);
      at::Tensor res = op_plugin::npu_gelu_backward(grad_output, self, approximate);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper___conv_depthwise2d_backward(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & weight, at::IntArrayRef kernel_size, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, ::std::array<bool,2> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_conv_depthwise2d_backward", grad_output, self, weight, kernel_size, stride, padding, dilation, output_mask);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::_conv_depthwise2d_backward(grad_output, self, weight, kernel_size, stride, padding, dilation, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper___dropout_with_byte_mask(const at::Tensor & self, double p) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_dropout_with_byte_mask", self, p);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::_dropout_with_byte_mask(self, p);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___dropout_with_byte_mask_backward(const at::Tensor & grad_output, const at::Tensor & mask, double p) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_dropout_with_byte_mask_backward", grad_output, mask, p);
      at::Tensor res = op_plugin::_dropout_with_byte_mask_backward(grad_output, mask, p);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper___npu_ciou(const at::Tensor & self, const at::Tensor & gtboxes, bool trans, bool is_cross, int64_t mode, bool atan_sub_flag) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_ciou", self, gtboxes, trans, is_cross, mode, atan_sub_flag);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::_npu_ciou(self, gtboxes, trans, is_cross, mode, atan_sub_flag);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper___npu_dropout(const at::Tensor & self, double p) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_dropout", self, p);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::_npu_dropout(self, p);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper_Tensor__npu_dropout_gen_mask(const at::Tensor & self, at::IntArrayRef size, double p, int64_t seed, int64_t offset, ::std::optional<bool> parallel, ::std::optional<bool> sync) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_dropout_gen_mask.Tensor", self, size, p, seed, offset, parallel, sync);
      at::Tensor res = op_plugin::_npu_dropout_gen_mask(self, size, p, seed, offset, parallel, sync);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___npu_silent_check(at::Tensor & input_grad, const at::Tensor & val, at::Tensor & pre_val, at::Tensor & min_val, at::Tensor & max_val, const at::Tensor & val_counter, int64_t c_min_steps, double c_thresh_l1, double c_coeff_l1, double c_thresh_l2, double c_coeff_l2) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_silent_check", input_grad, val, pre_val, min_val, max_val, val_counter, c_min_steps, c_thresh_l1, c_coeff_l1, c_thresh_l2, c_coeff_l2);
      at::Tensor res = op_plugin::_npu_silent_check(input_grad, val, pre_val, min_val, max_val, val_counter, c_min_steps, c_thresh_l1, c_coeff_l1, c_thresh_l2, c_coeff_l2);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___npu_silent_check_v2(const at::Tensor & val, at::Tensor & input_grad, at::Tensor & sfda, at::Tensor & step, int64_t c_min_steps, double c_thresh_l1, double c_coeff_l1, double c_thresh_l2, double c_coeff_l2, int64_t npu_asd_detect) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_silent_check_v2", val, input_grad, sfda, step, c_min_steps, c_thresh_l1, c_coeff_l1, c_thresh_l2, c_coeff_l2, npu_asd_detect);
      at::Tensor res = op_plugin::_npu_silent_check_v2(val, input_grad, sfda, step, c_min_steps, c_thresh_l1, c_coeff_l1, c_thresh_l2, c_coeff_l2, npu_asd_detect);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___npu_silent_check_v3(const at::Tensor & val, at::Tensor & input_grad, at::Tensor & step, at::Tensor & max, at::Tensor & avg, double c_thresh_l1, double c_thresh_l2, double betal, int64_t npu_asd_detect) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(val));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_silent_check_v3", val, input_grad, step, max, avg, c_thresh_l1, c_thresh_l2, betal, npu_asd_detect);
      at::Tensor res = op_plugin::_npu_silent_check_v3(val, input_grad, step, max, avg, c_thresh_l1, c_thresh_l2, betal, npu_asd_detect);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__batch_norm_gather_stats_update(const at::Tensor & input, const at::Tensor & mean, const at::Tensor & invstd, const ::std::optional<at::Tensor> & running_mean, const ::std::optional<at::Tensor> & running_var, double momentum, double eps, const at::Tensor & counts) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("batch_norm_gather_stats_update", input, mean, invstd, running_mean, running_var, momentum, eps, counts);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::batch_norm_gather_stats_update(input, mean, invstd, running_mean, running_var, momentum, eps, counts);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__batch_norm_reduce(const at::Tensor & input, double eps) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("batch_norm_reduce", input, eps);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::batch_norm_reduce(input, eps);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__dropout_with_byte_mask(const at::Tensor & self, double p, bool train) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("dropout_with_byte_mask", self, p, train);
      at::Tensor res = op_plugin::dropout_with_byte_mask(self, p, train);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__fast_gelu(const at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("fast_gelu", self);
      at::Tensor res = op_plugin::fast_gelu(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__kl_div_backward(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & target, int64_t reduction, bool log_target) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("kl_div_backward", grad_output, self, target, reduction, log_target);
      at::Tensor res = op_plugin::kl_div_backward(grad_output, self, target, reduction, log_target);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__l1_loss_backward(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & target, int64_t reduction) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("l1_loss_backward", grad_output, self, target, reduction);
      at::Tensor res = op_plugin::l1_loss_backward(grad_output, self, target, reduction);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__slow_conv_dilated2d_backward(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & weight, at::IntArrayRef kernel_size, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, ::std::array<bool,3> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("slow_conv_dilated2d_backward", grad_output, self, weight, kernel_size, stride, padding, dilation, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::slow_conv_dilated2d_backward(grad_output, self, weight, kernel_size, stride, padding, dilation, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__matmul_double_backward(const ::std::optional<at::Tensor> & grad_self, const ::std::optional<at::Tensor> & grad_other, const at::Tensor & grad_out, const at::Tensor & self, const at::Tensor & other, ::std::array<bool,3> mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("matmul_double_backward", grad_self, grad_other, grad_out, self, other, mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::matmul_double_backward(grad_self, grad_other, grad_out, self, other, mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_add_layer_norm(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & gamma, const at::Tensor & beta, double epsilon, bool additional_output) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_add_layer_norm", x1, x2, gamma, beta, epsilon, additional_output);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_add_layer_norm(x1, x2, gamma, beta, epsilon, additional_output);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_add_layer_norm_backward(const ::std::optional<at::Tensor> & dy_opt, const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & rstd, const at::Tensor & mean, const at::Tensor & gamma, const ::std::optional<at::Tensor> & dsum_opt) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_add_layer_norm_backward", dy_opt, x1, x2, rstd, mean, gamma, dsum_opt);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_add_layer_norm_backward(dy_opt, x1, x2, rstd, mean, gamma, dsum_opt);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_add_rms_norm(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & gamma, double epsilon) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x1));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_add_rms_norm", x1, x2, gamma, epsilon);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_add_rms_norm(x1, x2, gamma, epsilon);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_rms_norm_quant(const at::Tensor & x, const at::Tensor & gamma, const at::Tensor & beta, const at::Tensor & scale, const at::Tensor & offset, double epsilon) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, x, "wrapper__npu_rms_norm_quant", "x");
  c10::impl::check_and_update_common_device(common_device, gamma, "wrapper__npu_rms_norm_quant", "gamma");
  c10::impl::check_and_update_common_device(common_device, beta, "wrapper__npu_rms_norm_quant", "beta");
  c10::impl::check_and_update_common_device(common_device, scale, "wrapper__npu_rms_norm_quant", "scale");
  c10::impl::check_and_update_common_device(common_device, offset, "wrapper__npu_rms_norm_quant", "offset");
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rms_norm_quant", x, gamma, beta, scale, offset, epsilon);
      at::Tensor res = op_plugin::npu_rms_norm_quant(x, gamma, beta, scale, offset, epsilon);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_rms_norm_quant(x, gamma, beta, scale, offset, epsilon);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_add_rms_norm_cast(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & gamma, double epsilon) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x1));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_add_rms_norm_cast", x1, x2, gamma, epsilon);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_add_rms_norm_cast(x1, x2, gamma, epsilon);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_add_rms_norm_quant(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & gamma, const at::Tensor & scales1, const ::std::optional<at::Tensor> & zero_points1, const ::std::optional<at::Tensor> & beta, const ::std::optional<at::Tensor> & scales2, const ::std::optional<at::Tensor> & zero_points2, int64_t axis, double epsilon, bool div_mode) {
  ...
  c10::impl::check_and_update_common_device(common_device, beta, "wrapper__npu_add_rms_norm_quant", "beta");
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x1));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_add_rms_norm_quant", x1, x2, gamma, scales1, zero_points1, beta, scales2, zero_points2, axis, epsilon, div_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_add_rms_norm_quant(x1, x2, gamma, scales1, zero_points1, beta, scales2, zero_points2, axis, epsilon, div_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_add_rms_norm_quant(x1, x2, gamma, scales1, zero_points1, beta, scales2, zero_points2, axis, epsilon, div_mode);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_attention_update(at::TensorList lse, at::TensorList local_out, int64_t update_type) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(lse);
      c10_npu::check_npu_tensor_is_safe(local_out);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, lse, "wrapper__npu_attention_update", "lse");
  c10::impl::check_and_update_common_device(common_device, local_out, "wrapper__npu_attention_update", "local_out");
  const c10::OptionalDeviceGuard device_guard(device_of(lse));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_attention_update", lse, local_out, update_type);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_attention_update(lse, local_out, update_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_attention_update(lse, local_out, update_type);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_alltoallv_gmm(const at::Tensor & gmm_x, const at::Tensor & gmm_weight, c10::string_view hcom, int64_t ep_world_size, at::IntArrayRef send_counts, at::IntArrayRef recv_counts, const ::std::optional<at::Tensor> & send_counts_tensor, const ::std::optional<at::Tensor> & recv_counts_tensor, const ::std::optional<at::Tensor> & mm_x, const ::std::optional<at::Tensor> & mm_weight, bool trans_gmm_weight, bool trans_mm_weight, bool permute_out_flag) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_alltoallv_gmm", gmm_x, gmm_weight, hcom, ep_world_size, send_counts, recv_counts, send_counts_tensor, recv_counts_tensor, mm_x, mm_weight, trans_gmm_weight, trans_mm_weight, permute_out_flag);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_alltoallv_gmm(gmm_x, gmm_weight, hcom, ep_world_size, send_counts, recv_counts, send_counts_tensor, recv_counts_tensor, mm_x, mm_weight, trans_gmm_weight, trans_mm_weight, permute_out_flag);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_gmm_alltoallv(const at::Tensor & gmm_x, const at::Tensor & gmm_weight, c10::string_view hcom, int64_t ep_world_size, at::IntArrayRef send_counts, at::IntArrayRef recv_counts, const ::std::optional<at::Tensor> & send_counts_tensor, const ::std::optional<at::Tensor> & recv_counts_tensor, const ::std::optional<at::Tensor> & mm_x, const ::std::optional<at::Tensor> & mm_weight, bool trans_gmm_weight, bool trans_mm_weight) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(gmm_x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gmm_alltoallv", gmm_x, gmm_weight, hcom, ep_world_size, send_counts, recv_counts, send_counts_tensor, recv_counts_tensor, mm_x, mm_weight, trans_gmm_weight, trans_mm_weight);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_gmm_alltoallv(gmm_x, gmm_weight, hcom, ep_world_size, send_counts, recv_counts, send_counts_tensor, recv_counts_tensor, mm_x, mm_weight, trans_gmm_weight, trans_mm_weight);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_all_gather_base_mm(const at::Tensor & self, const at::Tensor & x2, c10::string_view hcom, int64_t world_size, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & x1_scale, const ::std::optional<at::Tensor> & x2_scale, int64_t gather_index, bool gather_output, int64_t comm_turn, ::std::optional<at::ScalarType> output_dtype, ::std::optional<c10::string_view> comm_mode) {
  ...
  c10::impl::check_and_update_common_device(common_device, x1_scale, "wrapper__npu_all_gather_base_mm", "x1_scale");
  c10::impl::check_and_update_common_device(common_device, x2_scale, "wrapper__npu_all_gather_base_mm", "x2_scale");
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_all_gather_base_mm", self, x2, hcom, world_size, bias, x1_scale, x2_scale, gather_index, gather_output, comm_turn, output_dtype, comm_mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_all_gather_base_mm(self, x2, hcom, world_size, bias, x1_scale, x2_scale, gather_index, gather_output, comm_turn, output_dtype, comm_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_all_gather_base_mm(self, x2, hcom, world_size, bias, x1_scale, x2_scale, gather_index, gather_output, comm_turn, output_dtype, comm_mode);
}
...
at::Tensor wrapper__npu_alloc_float_status(const at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_alloc_float_status", self);
      at::Tensor res = op_plugin::npu_alloc_float_status(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_anchor_response_flags(const at::Tensor & self, at::IntArrayRef featmap_size, at::IntArrayRef stride, int64_t num_base_anchors) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_anchor_response_flags", self, featmap_size, stride, num_base_anchors);
      at::Tensor res = op_plugin::npu_anchor_response_flags(self, featmap_size, stride, num_base_anchors);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_anti_quant(const at::Tensor & x, const at::Tensor & scale, const ::std::optional<at::Tensor> & offset, ::std::optional<at::ScalarType> dst_dtype, ::std::optional<at::ScalarType> src_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_anti_quant", x, scale, offset, dst_dtype, src_dtype);
      at::Tensor res = op_plugin::npu_anti_quant(x, scale, offset, dst_dtype, src_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_apply_adam(const at::Scalar & beta1_power, const at::Scalar & beta2_power, const at::Scalar & lr, const at::Scalar & beta1, const at::Scalar & beta2, const at::Scalar & epsilon, const at::Tensor & grad, ::std::optional<bool> use_locking, ::std::optional<bool> use_nesterov) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_apply_adam", beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_locking, use_nesterov);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_apply_adam(beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_locking, use_nesterov);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor> wrapper_out_npu_apply_adam_out(const at::Scalar & beta1_power,const at::Scalar & beta2_power,const at::Scalar & lr,const at::Scalar & beta1,const at::Scalar & beta2,const at::Scalar & epsilon,const at::Tensor & grad,::std::optional<bool> use_locking,::std::optional<bool> use_nesterov, at::TensorList out) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_apply_adam.out", beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_locking, use_nesterov, var, m, v);
      ::std::tuple<at::Tensor &,at::Tensor &,at::Tensor &> res = op_plugin::npu_apply_adam_out(beta1_power, beta2_power, lr, beta1, beta2, epsilon, grad, use_locking, use_nesterov, var, m, v);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_apply_adam_w(const at::Scalar & beta1_power, const at::Scalar & beta2_power, const at::Scalar & lr, const at::Scalar & weight_decay, const at::Scalar & beta1, const at::Scalar & beta2, const at::Scalar & epsilon, const at::Tensor & grad, const ::std::optional<at::Tensor> & max_grad_norm, ::std::optional<bool> amsgrad, ::std::optional<bool> maximize) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_apply_adam_w", beta1_power, beta2_power, lr, weight_decay, beta1, beta2, epsilon, grad, max_grad_norm, amsgrad, maximize);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_apply_adam_w(beta1_power, beta2_power, lr, weight_decay, beta1, beta2, epsilon, grad, max_grad_norm, amsgrad, maximize);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor> wrapper_out_npu_apply_adam_w_out(const at::Scalar & beta1_power,const at::Scalar & beta2_power,const at::Scalar & lr,const at::Scalar & weight_decay,const at::Scalar & beta1,const at::Scalar & beta2,const at::Scalar & epsilon,const at::Tensor & grad,const ::std::optional<at::Tensor> & max_grad_norm,::std::optional<bool> amsgrad,::std::optional<bool> maximize, at::TensorList out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(var));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_apply_adam_w.out", beta1_power, beta2_power, lr, weight_decay, beta1, beta2, epsilon, grad, max_grad_norm, amsgrad, maximize, var, m, v);
      ::std::tuple<at::Tensor &,at::Tensor &,at::Tensor &> res = op_plugin::npu_apply_adam_w_out(beta1_power, beta2_power, lr, weight_decay, beta1, beta2, epsilon, grad, max_grad_norm, amsgrad, maximize, var, m, v);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_apply_rotary_pos_emb(const at::Tensor & query, const at::Tensor & key, const at::Tensor & cos, const at::Tensor & sin, c10::string_view layout, c10::string_view rotary_mode) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_apply_rotary_pos_emb", query, key, cos, sin, layout, rotary_mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_apply_rotary_pos_emb(query, key, cos, sin, layout, rotary_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_apply_rotary_pos_emb(query, key, cos, sin, layout, rotary_mode);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_kv_rmsnorm_rope_cache(const at::Tensor & kv, const at::Tensor & gamma, const at::Tensor & cos, const at::Tensor & sin, const at::Tensor & index, const at::Tensor & k_cache, const at::Tensor & ckv_cache, const ::std::optional<at::Tensor> & k_rope_scale, const ::std::optional<at::Tensor> & c_kv_scale, const ::std::optional<at::Tensor> & k_rope_offset, const ::std::optional<at::Tensor> & c_kv_offset, double epsilon, c10::string_view cache_mode, bool is_output_kv) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_kv_rmsnorm_rope_cache", kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_kv_rmsnorm_rope_cache(kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_kv_rmsnorm_rope_cache_v2(const at::Tensor & kv, const at::Tensor & gamma, const at::Tensor & cos, const at::Tensor & sin, const at::Tensor & index, at::Tensor & k_cache, at::Tensor & ckv_cache, const ::std::optional<at::Tensor> & k_rope_scale, const ::std::optional<at::Tensor> & c_kv_scale, const ::std::optional<at::Tensor> & k_rope_offset, const ::std::optional<at::Tensor> & c_kv_offset, double epsilon, c10::string_view cache_mode, bool is_output_kv) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, kv, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "kv");
  c10::impl::check_and_update_common_device(common_device, gamma, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "gamma");
  c10::impl::check_and_update_common_device(common_device, cos, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "cos");
  c10::impl::check_and_update_common_device(common_device, sin, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "sin");
  c10::impl::check_and_update_common_device(common_device, index, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "index");
  c10::impl::check_and_update_common_device(common_device, k_cache, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "k_cache");
  c10::impl::check_and_update_common_device(common_device, ckv_cache, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "ckv_cache");
  c10::impl::check_and_update_common_device(common_device, k_rope_scale, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "k_rope_scale");
  c10::impl::check_and_update_common_device(common_device, c_kv_scale, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "c_kv_scale");
  c10::impl::check_and_update_common_device(common_device, k_rope_offset, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "k_rope_offset");
  c10::impl::check_and_update_common_device(common_device, c_kv_offset, "wrapper__npu_kv_rmsnorm_rope_cache_v2", "c_kv_offset");
  const c10::OptionalDeviceGuard device_guard(device_of(kv));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_kv_rmsnorm_rope_cache_v2", kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_kv_rmsnorm_rope_cache_v2(kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_kv_rmsnorm_rope_cache_v2(kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
}

::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_kv_rmsnorm_rope_cache_v2_functional(const at::Tensor & kv, const at::Tensor & gamma, const at::Tensor & cos, const at::Tensor & sin, const at::Tensor & index, const at::Tensor & k_cache, const at::Tensor & ckv_cache, const ::std::optional<at::Tensor> & k_rope_scale, const ::std::optional<at::Tensor> & c_kv_scale, const ::std::optional<at::Tensor> & k_rope_offset, const ::std::optional<at::Tensor> & c_kv_offset, double epsilon, c10::string_view cache_mode, bool is_output_kv) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, kv, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "kv");
  c10::impl::check_and_update_common_device(common_device, gamma, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "gamma");
  c10::impl::check_and_update_common_device(common_device, cos, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "cos");
  c10::impl::check_and_update_common_device(common_device, sin, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "sin");
  c10::impl::check_and_update_common_device(common_device, index, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "index");
  c10::impl::check_and_update_common_device(common_device, k_cache, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "k_cache");
  c10::impl::check_and_update_common_device(common_device, ckv_cache, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "ckv_cache");
  c10::impl::check_and_update_common_device(common_device, k_rope_scale, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "k_rope_scale");
  c10::impl::check_and_update_common_device(common_device, c_kv_scale, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "c_kv_scale");
  c10::impl::check_and_update_common_device(common_device, k_rope_offset, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "k_rope_offset");
  c10::impl::check_and_update_common_device(common_device, c_kv_offset, "wrapper__npu_kv_rmsnorm_rope_cache_v2_functional", "c_kv_offset");
  const c10::OptionalDeviceGuard device_guard(device_of(kv));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_kv_rmsnorm_rope_cache_v2_functional", kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_kv_rmsnorm_rope_cache_v2_functional(kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_kv_rmsnorm_rope_cache_v2_functional(kv, gamma, cos, sin, index, k_cache, ckv_cache, k_rope_scale, c_kv_scale, k_rope_offset, c_kv_offset, epsilon, cache_mode, is_output_kv);
}
...
at::Tensor wrapper__npu_batch_gather_matmul(const at::Tensor & self, const at::Tensor & x, const at::Tensor & weight_b, const at::Tensor & indices, const ::std::optional<at::Tensor> & weight_a, int64_t layer_idx, double scale, int64_t y_offset, int64_t y_slice_size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_batch_gather_matmul", self, x, weight_b, indices, weight_a, layer_idx, scale, y_offset, y_slice_size);
      at::Tensor res = op_plugin::npu_batch_gather_matmul(self, x, weight_b, indices, weight_a, layer_idx, scale, y_offset, y_slice_size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__npu_batch_gather_matmul_(at::Tensor & self, const at::Tensor & x, const at::Tensor & weight_b, const at::Tensor & indices, const ::std::optional<at::Tensor> & weight_a, int64_t layer_idx, double scale, int64_t y_offset, int64_t y_slice_size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_batch_gather_matmul_", self, x, weight_b, indices, weight_a, layer_idx, scale, y_offset, y_slice_size);
      at::Tensor & res = op_plugin::npu_batch_gather_matmul_(self, x, weight_b, indices, weight_a, layer_idx, scale, y_offset, y_slice_size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_batch_nms(const at::Tensor & self, const at::Tensor & scores, double score_threshold, double iou_threshold, int64_t max_size_per_class, int64_t max_total_size, bool change_coordinate_frame, bool transpose_box) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_batch_nms", self, scores, score_threshold, iou_threshold, max_size_per_class, max_total_size, change_coordinate_frame, transpose_box);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_batch_nms(self, scores, score_threshold, iou_threshold, max_size_per_class, max_total_size, change_coordinate_frame, transpose_box);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_bert_apply_adam(const at::Scalar & lr, const at::Scalar & beta1, const at::Scalar & beta2, const at::Scalar & epsilon, const at::Tensor & grad, const at::Scalar & max_grad_norm, const at::Scalar & global_grad_norm, const at::Scalar & weight_decay, const ::std::optional<at::Scalar> & step_size, int64_t adam_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_bert_apply_adam", lr, beta1, beta2, epsilon, grad, max_grad_norm, global_grad_norm, weight_decay, step_size, adam_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_bert_apply_adam(lr, beta1, beta2, epsilon, grad, max_grad_norm, global_grad_norm, weight_decay, step_size, adam_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor> wrapper_out_npu_bert_apply_adam_out(const at::Scalar & lr,const at::Scalar & beta1,const at::Scalar & beta2,const at::Scalar & epsilon,const at::Tensor & grad,const at::Scalar & max_grad_norm,const at::Scalar & global_grad_norm,const at::Scalar & weight_decay,const ::std::optional<at::Scalar> & step_size,int64_t adam_mode, at::TensorList out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(var));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_bert_apply_adam.out", lr, beta1, beta2, epsilon, grad, max_grad_norm, global_grad_norm, weight_decay, step_size, adam_mode, var, m, v);
      ::std::tuple<at::Tensor &,at::Tensor &,at::Tensor &> res = op_plugin::npu_bert_apply_adam_out(lr, beta1, beta2, epsilon, grad, max_grad_norm, global_grad_norm, weight_decay, step_size, adam_mode, var, m, v);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_binary_cross_entropy_with_logits_backward(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & target, const ::std::optional<at::Tensor> & weight_opt, const ::std::optional<at::Tensor> & pos_weight_opt, int64_t reduction) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_binary_cross_entropy_with_logits_backward", grad_output, self, target, weight_opt, pos_weight_opt, reduction);
      at::Tensor res = op_plugin::npu_binary_cross_entropy_with_logits_backward(grad_output, self, target, weight_opt, pos_weight_opt, reduction);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_bmmV2(const at::Tensor & self, const at::Tensor & mat2, at::IntArrayRef output_sizes) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_bmmV2", self, mat2, output_sizes);
      at::Tensor res = op_plugin::npu_bmmV2(self, mat2, output_sizes);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_bmm_v2_mat1_backward(const at::Tensor & grad, const at::Tensor & mat1, const at::Tensor & mat2, c10::SymIntArrayRef size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_bmm_v2_mat1_backward", grad, mat1, mat2, size);
      at::Tensor res = op_plugin::npu_bmm_v2_mat1_backward_symint(grad, mat1, mat2, size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_bmm_v2_mat2_backward(const at::Tensor & grad, const at::Tensor & mat1, const at::Tensor & mat2, c10::SymIntArrayRef size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_bmm_v2_mat2_backward", grad, mat1, mat2, size);
      at::Tensor res = op_plugin::npu_bmm_v2_mat2_backward_symint(grad, mat1, mat2, size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_bounding_box_decode(const at::Tensor & rois, const at::Tensor & deltas, double means0, double means1, double means2, double means3, double stds0, double stds1, double stds2, double stds3, at::IntArrayRef max_shape, double wh_ratio_clip) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_bounding_box_decode", rois, deltas, means0, means1, means2, means3, stds0, stds1, stds2, stds3, max_shape, wh_ratio_clip);
      at::Tensor res = op_plugin::npu_bounding_box_decode(rois, deltas, means0, means1, means2, means3, stds0, stds1, stds2, stds3, max_shape, wh_ratio_clip);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_bounding_box_encode(const at::Tensor & anchor_box, const at::Tensor & ground_truth_box, double means0, double means1, double means2, double means3, double stds0, double stds1, double stds2, double stds3) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_bounding_box_encode", anchor_box, ground_truth_box, means0, means1, means2, means3, stds0, stds1, stds2, stds3);
      at::Tensor res = op_plugin::npu_bounding_box_encode(anchor_box, ground_truth_box, means0, means1, means2, means3, stds0, stds1, stds2, stds3);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_broadcast(const at::Tensor & self, at::IntArrayRef size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_broadcast", self, size);
      at::Tensor res = op_plugin::npu_broadcast(self, size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_broadcast_out(const at::Tensor & self, at::IntArrayRef size, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_broadcast.out", self, size, out);
      at::Tensor & res = op_plugin::npu_broadcast_out(self, size, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_ciou(const at::Tensor & self, const at::Tensor & gtboxes, bool trans, bool is_cross, int64_t mode, bool atan_sub_flag) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ciou", self, gtboxes, trans, is_cross, mode, atan_sub_flag);
      at::Tensor res = op_plugin::npu_ciou(self, gtboxes, trans, is_cross, mode, atan_sub_flag);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_ciou_backward(const at::Tensor & grad, const at::Tensor & bboxes, const at::Tensor & gtboxes, const ::std::optional<at::Tensor> & atan_sub, bool trans, bool is_cross, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ciou_backward", grad, bboxes, gtboxes, atan_sub, trans, is_cross, mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_ciou_backward(grad, bboxes, gtboxes, atan_sub, trans, is_cross, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_clear_float_status(const at::Tensor & self, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_clear_float_status", self, mode);
      at::Tensor res = op_plugin::npu_clear_float_status(self, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_confusion_transpose(const at::Tensor & self, at::IntArrayRef perm, at::IntArrayRef shape, bool transpose_first) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_confusion_transpose", self, perm, shape, transpose_first);
      at::Tensor res = op_plugin::npu_confusion_transpose(self, perm, shape, transpose_first);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_confusion_transpose_backward(const at::Tensor & grad, at::IntArrayRef perm, c10::SymIntArrayRef shape, bool transpose_first) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_confusion_transpose_backward", grad, perm, shape, transpose_first);
      at::Tensor res = op_plugin::npu_confusion_transpose_backward_symint(grad, perm, shape, transpose_first);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_conv2d(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv2d", input, weight, bias, stride, padding, dilation, groups);
      at::Tensor res = op_plugin::npu_conv2d(input, weight, bias, stride, padding, dilation, groups);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_conv2d_out(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, at::Tensor & out) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv2d.out", input, weight, bias, stride, padding, dilation, groups, out);
      at::Tensor & res = op_plugin::npu_conv2d_out(input, weight, bias, stride, padding, dilation, groups, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_conv2d_backward(const at::Tensor & input, const at::Tensor & grad_output, const at::Tensor & weight, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, ::std::array<bool,3> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv2d_backward", input, grad_output, weight, stride, padding, dilation, groups, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_conv2d_backward(input, grad_output, weight, stride, padding, dilation, groups, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_conv3d(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv3d", input, weight, bias, stride, padding, dilation, groups);
      at::Tensor res = op_plugin::npu_conv3d(input, weight, bias, stride, padding, dilation, groups);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_conv3d_out(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(out));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv3d.out", input, weight, bias, stride, padding, dilation, groups, out);
      at::Tensor & res = op_plugin::npu_conv3d_out(input, weight, bias, stride, padding, dilation, groups, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_conv3d_backward(const at::Tensor & input, const at::Tensor & grad, const at::Tensor & weight, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, ::std::array<bool,3> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv3d_backward", input, grad, weight, stride, padding, dilation, groups, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_conv3d_backward(input, grad, weight, stride, padding, dilation, groups, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_conv_transpose2d(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, at::IntArrayRef padding, at::IntArrayRef output_padding, at::IntArrayRef stride, at::IntArrayRef dilation, int64_t groups) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv_transpose2d", input, weight, bias, padding, output_padding, stride, dilation, groups);
      at::Tensor res = op_plugin::npu_conv_transpose2d(input, weight, bias, padding, output_padding, stride, dilation, groups);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_conv_transpose2d_backward(const at::Tensor & input, const at::Tensor & grad_output, const at::Tensor & weight, at::IntArrayRef padding, at::IntArrayRef output_padding, at::IntArrayRef stride, at::IntArrayRef dilation, int64_t groups, ::std::array<bool,3> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv_transpose2d_backward", input, grad_output, weight, padding, output_padding, stride, dilation, groups, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_conv_transpose2d_backward(input, grad_output, weight, padding, output_padding, stride, dilation, groups, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_conv_transpose3d_backward(const at::Tensor & input, const at::Tensor & grad_output, const at::Tensor & weight, at::IntArrayRef padding, at::IntArrayRef output_padding, at::IntArrayRef stride, at::IntArrayRef dilation, int64_t groups, ::std::array<bool,3> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_conv_transpose3d_backward", input, grad_output, weight, padding, output_padding, stride, dilation, groups, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_conv_transpose3d_backward(input, grad_output, weight, padding, output_padding, stride, dilation, groups, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_convert_weight_to_int4pack(const at::Tensor & weight, int64_t inner_k_tiles) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_convert_weight_to_int4pack", weight, inner_k_tiles);
      at::Tensor res = op_plugin::npu_convert_weight_to_int4pack(weight, inner_k_tiles);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_convolution(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_convolution", input, weight, bias, stride, padding, dilation, groups);
      at::Tensor res = op_plugin::npu_convolution(input, weight, bias, stride, padding, dilation, groups);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_convolution_backward(const at::Tensor & input, const at::Tensor & grad_output, const at::Tensor & weight, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, ::std::array<bool,3> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_convolution_backward", input, grad_output, weight, stride, padding, dilation, groups, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_convolution_backward(input, grad_output, weight, stride, padding, dilation, groups, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_convolution_transpose(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, at::IntArrayRef padding, at::IntArrayRef output_padding, at::IntArrayRef stride, at::IntArrayRef dilation, int64_t groups) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_convolution_transpose", input, weight, bias, padding, output_padding, stride, dilation, groups);
      at::Tensor res = op_plugin::npu_convolution_transpose(input, weight, bias, padding, output_padding, stride, dilation, groups);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_convolution_transpose_backward(const at::Tensor & input, const at::Tensor & grad, const at::Tensor & weight, at::IntArrayRef padding, at::IntArrayRef output_padding, at::IntArrayRef stride, at::IntArrayRef dilation, int64_t groups, ::std::array<bool,3> grad_input_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_convolution_transpose_backward", input, grad, weight, padding, output_padding, stride, dilation, groups, grad_input_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_convolution_transpose_backward(input, grad, weight, padding, output_padding, stride, dilation, groups, grad_input_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_deep_norm(const at::Tensor & x, const at::Tensor & gx, const at::Tensor & beta, const at::Tensor & gamma, double alpha, double epsilon) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_deep_norm", x, gx, beta, gamma, alpha, epsilon);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_deep_norm(x, gx, beta, gamma, alpha, epsilon);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_deep_norm_backward(const at::Tensor & dy, const at::Tensor & x, const at::Tensor & gx, const at::Tensor & gamma, const at::Tensor & mean, const at::Tensor & rstd, double alpha) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_deep_norm_backward", dy, x, gx, gamma, mean, rstd, alpha);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_deep_norm_backward(dy, x, gx, gamma, mean, rstd, alpha);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_deformable_conv2d(const at::Tensor & input, const at::Tensor & weight, const at::Tensor & offset, const ::std::optional<at::Tensor> & bias, at::IntArrayRef kernel_size, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, int64_t deformable_groups, bool modulated) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_deformable_conv2d", input, weight, offset, bias, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_deformable_conv2d(input, weight, offset, bias, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_deformable_conv2dbk(const at::Tensor & input, const at::Tensor & grad_output, const at::Tensor & offset_out, const at::Tensor & weight, const at::Tensor & offset, at::IntArrayRef kernel_size, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef dilation, int64_t groups, int64_t deformable_groups, bool modulated) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_deformable_conv2dbk", input, grad_output, offset_out, weight, offset, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_deformable_conv2dbk(input, grad_output, offset_out, weight, offset, kernel_size, stride, padding, dilation, groups, deformable_groups, modulated);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_diou(const at::Tensor & self, const at::Tensor & gtboxes, bool trans, bool is_cross, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_diou", self, gtboxes, trans, is_cross, mode);
      at::Tensor res = op_plugin::npu_diou(self, gtboxes, trans, is_cross, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_diou_backward(const at::Tensor & grad, const at::Tensor & bboxes, const at::Tensor & gtboxes, bool trans, bool is_cross, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_diou_backward", grad, bboxes, gtboxes, trans, is_cross, mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_diou_backward(grad, bboxes, gtboxes, trans, is_cross, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_dropout_backward(const at::Tensor & grad_output, const at::Tensor & mask, double p) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad_output));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dropout_backward", grad_output, mask, p);
      at::Tensor res = op_plugin::npu_dropout_backward(grad_output, mask, p);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_dropout_do_mask(const at::Tensor & self, const at::Tensor & mask, double p) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dropout_do_mask", self, mask, p);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_dropout_do_mask(self, mask, p);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_token_permute_with_routing_map(const at::Tensor & tokens, const at::Tensor & routing_map, const ::std::optional<at::Tensor> & probs, ::std::optional<int64_t> num_out_tokens, bool drop_and_pad) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(tokens);
      c10_npu::check_npu_tensor_is_safe(routing_map);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, tokens, "wrapper__npu_moe_token_permute_with_routing_map", "tokens");
  c10::impl::check_and_update_common_device(common_device, routing_map, "wrapper__npu_moe_token_permute_with_routing_map", "routing_map");
  c10::impl::check_and_update_common_device(common_device, probs, "wrapper__npu_moe_token_permute_with_routing_map", "probs");
  const c10::OptionalDeviceGuard device_guard(device_of(tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_permute_with_routing_map", tokens, routing_map, probs, num_out_tokens, drop_and_pad);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_token_permute_with_routing_map(tokens, routing_map, probs, num_out_tokens, drop_and_pad);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_token_permute_with_routing_map(tokens, routing_map, probs, num_out_tokens, drop_and_pad);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_moe_token_permute_with_routing_map_grad(const at::Tensor & permuted_token_out_grad, const ::std::optional<at::Tensor> & probs_grad, const at::Tensor & sorted_indices, const at::Tensor & routing_map, c10::SymInt experts_num, c10::SymInt tokens_num, bool drop_and_pad) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(permuted_token_out_grad);
      c10_npu::check_npu_tensor_is_safe(probs_grad);
      c10_npu::check_npu_tensor_is_safe(sorted_indices);
      c10_npu::check_npu_tensor_is_safe(routing_map);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, permuted_token_out_grad, "wrapper__npu_moe_token_permute_with_routing_map_grad", "permuted_token_out_grad");
  c10::impl::check_and_update_common_device(common_device, probs_grad, "wrapper__npu_moe_token_permute_with_routing_map_grad", "probs_grad");
  c10::impl::check_and_update_common_device(common_device, sorted_indices, "wrapper__npu_moe_token_permute_with_routing_map_grad", "sorted_indices");
  c10::impl::check_and_update_common_device(common_device, routing_map, "wrapper__npu_moe_token_permute_with_routing_map_grad", "routing_map");
  const c10::OptionalDeviceGuard device_guard(device_of(permuted_token_out_grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_permute_with_routing_map_grad", permuted_token_out_grad, probs_grad, sorted_indices, routing_map, experts_num, tokens_num, drop_and_pad);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_moe_token_permute_with_routing_map_grad_symint(permuted_token_out_grad, probs_grad, sorted_indices, routing_map, experts_num, tokens_num, drop_and_pad);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_token_permute_with_routing_map_grad_symint(permuted_token_out_grad, probs_grad, sorted_indices, routing_map, experts_num, tokens_num, drop_and_pad);
}
...
at::Tensor wrapper__npu_dropout_gen_mask(at::IntArrayRef size, double p, ::std::optional<at::ScalarType> dtype, ::std::optional<at::Layout> layout, ::std::optional<at::Device> device, ::std::optional<bool> pin_memory) {
  ...
  const c10::DeviceGuard device_guard(device_or_default(device));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dropout_gen_mask", size, p, dtype, layout, device, pin_memory);
      at::Tensor res = op_plugin::npu_dropout_gen_mask(size, p, dtype, layout, device, pin_memory);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_dropout_with_add_softmax(const at::Tensor & self, const at::Tensor & x1, const at::Scalar & alpha, double prob, int64_t dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dropout_with_add_softmax", self, x1, alpha, prob, dim);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_dropout_with_add_softmax(self, x1, alpha, prob, dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_dropout_with_add_softmax_backward(const at::Tensor & grad, const at::Tensor & mask, const at::Tensor & softmax_out, const at::Scalar & alpha, double prob, int64_t dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dropout_with_add_softmax_backward", grad, mask, softmax_out, alpha, prob, dim);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_dropout_with_add_softmax_backward(grad, mask, softmax_out, alpha, prob, dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_dtype_cast(const at::Tensor & self, at::ScalarType dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dtype_cast", self, dtype);
      at::Tensor res = op_plugin::npu_dtype_cast(self, dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___npu_dtype_cast(const at::Tensor & self, at::ScalarType dtype) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, self, "wrapper___npu_dtype_cast", "self");
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_dtype_cast", self, dtype);
      at::Tensor res = op_plugin::_npu_dtype_cast(self, dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_npu_dtype_cast(self, dtype);
}
...
at::Tensor & wrapper__npu_dtype_cast_(at::Tensor & self, const at::Tensor & src) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dtype_cast_", self, src);
      at::Tensor & res = op_plugin::npu_dtype_cast_(self, src);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_dtype_cast_backward(const at::Tensor & grad, at::ScalarType dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dtype_cast_backward", grad, dtype);
      at::Tensor res = op_plugin::npu_dtype_cast_backward(grad, dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___npu_dtype_cast_backward(const at::Tensor & grad, at::ScalarType dtype) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, grad, "wrapper___npu_dtype_cast_backward", "grad");
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_dtype_cast_backward", grad, dtype);
      at::Tensor res = op_plugin::_npu_dtype_cast_backward(grad, dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_npu_dtype_cast_backward(grad, dtype);
}
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_dynamic_quant(const at::Tensor & input, const ::std::optional<at::Tensor> & smooth_scales, const ::std::optional<at::Tensor> & group_index, ::std::optional<at::ScalarType> dst_type) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dynamic_quant", input, smooth_scales, group_index, dst_type);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_dynamic_quant(input, smooth_scales, group_index, dst_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_dynamic_quant_asymmetric(const at::Tensor & input, const ::std::optional<at::Tensor> & smooth_scales, const ::std::optional<at::Tensor> & group_index, ::std::optional<at::ScalarType> dst_type) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dynamic_quant_asymmetric", input, smooth_scales, group_index, dst_type);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_dynamic_quant_asymmetric(input, smooth_scales, group_index, dst_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_fast_gelu(const at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fast_gelu", self);
      at::Tensor res = op_plugin::npu_fast_gelu(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_fast_gelu_backward(const at::Tensor & grad, const at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fast_gelu_backward", grad, self);
      at::Tensor res = op_plugin::npu_fast_gelu_backward(grad, self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_ffn(const at::Tensor & x, const at::Tensor & weight1, const at::Tensor & weight2, c10::string_view activation, at::OptionalIntArrayRef expert_tokens, at::OptionalIntArrayRef expert_tokens_index, const ::std::optional<at::Tensor> & bias1, const ::std::optional<at::Tensor> & bias2, const ::std::optional<at::Tensor> & scale, const ::std::optional<at::Tensor> & offset, const ::std::optional<at::Tensor> & deq_scale1, const ::std::optional<at::Tensor> & deq_scale2, const ::std::optional<at::Tensor> & antiquant_scale1, const ::std::optional<at::Tensor> & antiquant_scale2, const ::std::optional<at::Tensor> & antiquant_offset1, const ::std::optional<at::Tensor> & antiquant_offset2, ::std::optional<int64_t> inner_precise, ::std::optional<at::ScalarType> output_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ffn", x, weight1, weight2, activation, expert_tokens, expert_tokens_index, bias1, bias2, scale, offset, deq_scale1, deq_scale2, antiquant_scale1, antiquant_scale2, antiquant_offset1, antiquant_offset2, inner_precise, output_dtype);
      at::Tensor res = op_plugin::npu_ffn(x, weight1, weight2, activation, expert_tokens, expert_tokens_index, bias1, bias2, scale, offset, deq_scale1, deq_scale2, antiquant_scale1, antiquant_scale2, antiquant_offset1, antiquant_offset2, inner_precise, output_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_fused_attention_score(const at::Tensor & query_layer, const at::Tensor & key_layer, const at::Tensor & value_layer, const at::Tensor & attention_mask, const at::Scalar & scale, double keep_prob, bool query_transpose, bool key_transpose, bool bmm_score_transpose_a, bool bmm_score_transpose_b, bool value_transpose, bool dx_transpose) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_attention_score", query_layer, key_layer, value_layer, attention_mask, scale, keep_prob, query_transpose, key_transpose, bmm_score_transpose_a, bmm_score_transpose_b, value_transpose, dx_transpose);
      at::Tensor res = op_plugin::npu_fused_attention_score(query_layer, key_layer, value_layer, attention_mask, scale, keep_prob, query_transpose, key_transpose, bmm_score_transpose_a, bmm_score_transpose_b, value_transpose, dx_transpose);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_fused_attention_score_backward(const at::Tensor & grad_output, const at::Tensor & softmax_output, const at::Tensor & query_layer, const at::Tensor & key_layer, const at::Tensor & value_layer, const at::Tensor & mask, const at::Scalar & scale, double keep_prob, bool query_transpose, bool key_transpose, bool value_transpose, bool dx_transpose) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad_output));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_attention_score_backward", grad_output, softmax_output, query_layer, key_layer, value_layer, mask, scale, keep_prob, query_transpose, key_transpose, value_transpose, dx_transpose);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_fused_attention_score_backward(grad_output, softmax_output, query_layer, key_layer, value_layer, mask, scale, keep_prob, query_transpose, key_transpose, value_transpose, dx_transpose);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_fused_attention_score_fwd(const at::Tensor & query_layer, const at::Tensor & key_layer, const at::Tensor & value_layer, const at::Tensor & attention_mask, const at::Scalar & scale, double keep_prob, bool query_transpose, bool key_transpose, bool bmm_score_transpose_a, bool bmm_score_transpose_b, bool value_transpose, bool dx_transpose) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query_layer));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_attention_score_fwd", query_layer, key_layer, value_layer, attention_mask, scale, keep_prob, query_transpose, key_transpose, bmm_score_transpose_a, bmm_score_transpose_b, value_transpose, dx_transpose);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_fused_attention_score_fwd(query_layer, key_layer, value_layer, attention_mask, scale, keep_prob, query_transpose, key_transpose, bmm_score_transpose_a, bmm_score_transpose_b, value_transpose, dx_transpose);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_fused_attention_score_grad(const at::Tensor & grad_output, const at::Tensor & softmax_output, const at::Tensor & query_layer, const at::Tensor & key_layer, const at::Tensor & value_layer, const at::Tensor & mask, const at::Scalar & scale, double keep_prob, bool query_transpose, bool key_transpose, bool value_transpose, bool dx_transpose) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad_output));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_attention_score_grad", grad_output, softmax_output, query_layer, key_layer, value_layer, mask, scale, keep_prob, query_transpose, key_transpose, value_transpose, dx_transpose);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_fused_attention_score_grad(grad_output, softmax_output, query_layer, key_layer, value_layer, mask, scale, keep_prob, query_transpose, key_transpose, value_transpose, dx_transpose);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor, at::Tensor> wrapper_out_npu_fused_infer_attention_score_out(const at::Tensor & query,const at::Tensor & key,const at::Tensor & value,const ::std::optional<at::Tensor> & pse_shift,const ::std::optional<at::Tensor> & atten_mask,at::OptionalSymIntArrayRef actual_seq_lengths,at::OptionalSymIntArrayRef actual_seq_lengths_kv,const ::std::optional<at::Tensor> & dequant_scale1,const ::std::optional<at::Tensor> & quant_scale1,const ::std::optional<at::Tensor> & dequant_scale2,const ::std::optional<at::Tensor> & quant_scale2,const ::std::optional<at::Tensor> & quant_offset2,const ::std::optional<at::Tensor> & antiquant_scale,const ::std::optional<at::Tensor> & antiquant_offset,const ::std::optional<at::Tensor> & key_antiquant_scale,const ::std::optional<at::Tensor> & key_antiquant_offset,const ::std::optional<at::Tensor> & value_antiquant_scale,const ::std::optional<at::Tensor> & value_antiquant_offset,const ::std::optional<at::Tensor> & block_table,const ::std::optional<at::Tensor> & query_padding_size,const ::std::optional<at::Tensor> & kv_padding_size,const ::std::optional<at::Tensor> & key_shared_prefix,const ::std::optional<at::Tensor> & value_shared_prefix,at::OptionalSymIntArrayRef actual_shared_prefix_len,const ::std::optional<at::Tensor> & query_rope,const ::std::optional<at::Tensor> & key_rope,const ::std::optional<at::Tensor> & key_rope_antiquant_scale,int64_t num_heads,double scale,int64_t pre_tokens,int64_t next_tokens,c10::string_view input_layout,int64_t num_key_value_heads,int64_t sparse_mode,int64_t inner_precise,int64_t block_size,int64_t antiquant_mode,int64_t key_antiquant_mode,int64_t value_antiquant_mode,bool softmax_lse_flag,const ::std::optional<at::Tensor> & workspace, at::TensorList out) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_infer_attention_score.out", query, key, value, pse_shift, atten_mask, actual_seq_lengths, actual_seq_lengths_kv, dequant_scale1, quant_scale1, dequant_scale2, quant_scale2, quant_offset2, antiquant_scale, antiquant_offset, key_antiquant_scale, key_antiquant_offset, value_antiquant_scale, value_antiquant_offset, block_table, query_padding_size, kv_padding_size, key_shared_prefix, value_shared_prefix, actual_shared_prefix_len, query_rope, key_rope, key_rope_antiquant_scale, num_heads, scale, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise, block_size, antiquant_mode, key_antiquant_mode, value_antiquant_mode, softmax_lse_flag, workspace, attention_out, softmax_lse);
      ::std::tuple<at::Tensor &,at::Tensor &> res = op_plugin::npu_fused_infer_attention_score_out_symint(query, key, value, pse_shift, atten_mask, actual_seq_lengths, actual_seq_lengths_kv, dequant_scale1, quant_scale1, dequant_scale2, quant_scale2, quant_offset2, antiquant_scale, antiquant_offset, key_antiquant_scale, key_antiquant_offset, value_antiquant_scale, value_antiquant_offset, block_table, query_padding_size, kv_padding_size, key_shared_prefix, value_shared_prefix, actual_shared_prefix_len, query_rope, key_rope, key_rope_antiquant_scale, num_heads, scale, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise, block_size, antiquant_mode, key_antiquant_mode, value_antiquant_mode, softmax_lse_flag, workspace, attention_out, softmax_lse);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___npu_fused_infer_attention_score_get_max_workspace(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & pse_shift, const ::std::optional<at::Tensor> & atten_mask, at::OptionalSymIntArrayRef actual_seq_lengths, at::OptionalSymIntArrayRef actual_seq_lengths_kv, const ::std::optional<at::Tensor> & dequant_scale1, const ::std::optional<at::Tensor> & quant_scale1, const ::std::optional<at::Tensor> & dequant_scale2, const ::std::optional<at::Tensor> & quant_scale2, const ::std::optional<at::Tensor> & quant_offset2, const ::std::optional<at::Tensor> & antiquant_scale, const ::std::optional<at::Tensor> & antiquant_offset, const ::std::optional<at::Tensor> & key_antiquant_scale, const ::std::optional<at::Tensor> & key_antiquant_offset, const ::std::optional<at::Tensor> & value_antiquant_scale, const ::std::optional<at::Tensor> & value_antiquant_offset, const ::std::optional<at::Tensor> & block_table, const ::std::optional<at::Tensor> & query_padding_size, const ::std::optional<at::Tensor> & kv_padding_size, const ::std::optional<at::Tensor> & key_shared_prefix, const ::std::optional<at::Tensor> & value_shared_prefix, at::OptionalSymIntArrayRef actual_shared_prefix_len, const ::std::optional<at::Tensor> & query_rope, const ::std::optional<at::Tensor> & key_rope, const ::std::optional<at::Tensor> & key_rope_antiquant_scale, int64_t num_heads, double scale, int64_t pre_tokens, int64_t next_tokens, c10::string_view input_layout, int64_t num_key_value_heads, int64_t sparse_mode, int64_t inner_precise, int64_t block_size, int64_t antiquant_mode, int64_t key_antiquant_mode, int64_t value_antiquant_mode, bool softmax_lse_flag) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_fused_infer_attention_score_get_max_workspace", query, key, value, pse_shift, atten_mask, actual_seq_lengths, actual_seq_lengths_kv, dequant_scale1, quant_scale1, dequant_scale2, quant_scale2, quant_offset2, antiquant_scale, antiquant_offset, key_antiquant_scale, key_antiquant_offset, value_antiquant_scale, value_antiquant_offset, block_table, query_padding_size, kv_padding_size, key_shared_prefix, value_shared_prefix, actual_shared_prefix_len, query_rope, key_rope, key_rope_antiquant_scale, num_heads, scale, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise, block_size, antiquant_mode, key_antiquant_mode, value_antiquant_mode, softmax_lse_flag);
      at::Tensor res = op_plugin::_npu_fused_infer_attention_score_get_max_workspace_symint(query, key, value, pse_shift, atten_mask, actual_seq_lengths, actual_seq_lengths_kv, dequant_scale1, quant_scale1, dequant_scale2, quant_scale2, quant_offset2, antiquant_scale, antiquant_offset, key_antiquant_scale, key_antiquant_offset, value_antiquant_scale, value_antiquant_offset, block_table, query_padding_size, kv_padding_size, key_shared_prefix, value_shared_prefix, actual_shared_prefix_len, query_rope, key_rope, key_rope_antiquant_scale, num_heads, scale, pre_tokens, next_tokens, input_layout, num_key_value_heads, sparse_mode, inner_precise, block_size, antiquant_mode, key_antiquant_mode, value_antiquant_mode, softmax_lse_flag);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_fused_infer_attention_score_v2(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & query_rope, const ::std::optional<at::Tensor> & key_rope, const ::std::optional<at::Tensor> & pse_shift, const ::std::optional<at::Tensor> & atten_mask, at::OptionalSymIntArrayRef actual_seq_qlen, at::OptionalSymIntArrayRef actual_seq_kvlen, const ::std::optional<at::Tensor> & block_table, const ::std::optional<at::Tensor> & dequant_scale_query, const ::std::optional<at::Tensor> & dequant_scale_key, const ::std::optional<at::Tensor> & dequant_offset_key, const ::std::optional<at::Tensor> & dequant_scale_value, const ::std::optional<at::Tensor> & dequant_offset_value, const ::std::optional<at::Tensor> & dequant_scale_key_rope, const ::std::optional<at::Tensor> & quant_scale_out, const ::std::optional<at::Tensor> & quant_offset_out, const ::std::optional<at::Tensor> & learnable_sink, int64_t num_query_heads, int64_t num_key_value_heads, double softmax_scale, int64_t pre_tokens, int64_t next_tokens, c10::string_view input_layout, int64_t sparse_mode, int64_t block_size, int64_t query_quant_mode, int64_t key_quant_mode, int64_t value_quant_mode, int64_t inner_precise, bool return_softmax_lse, ::std::optional<int64_t> query_dtype, ::std::optional<int64_t> key_dtype, ::std::optional<int64_t> value_dtype, ::std::optional<int64_t> query_rope_dtype, ::std::optional<int64_t> key_rope_dtype, ::std::optional<int64_t> key_shared_prefix_dtype, ::std::optional<int64_t> value_shared_prefix_dtype, ::std::optional<int64_t> dequant_scale_query_dtype, ::std::optional<int64_t> dequant_scale_key_dtype, ::std::optional<int64_t> dequant_scale_value_dtype, ::std::optional<int64_t> dequant_scale_key_rope_dtype) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, query, "wrapper__npu_fused_infer_attention_score_v2", "query");
  c10::impl::check_and_update_common_device(common_device, key, "wrapper__npu_fused_infer_attention_score_v2", "key");
  c10::impl::check_and_update_common_device(common_device, value, "wrapper__npu_fused_infer_attention_score_v2", "value");
  c10::impl::check_and_update_common_device(common_device, query_rope, "wrapper__npu_fused_infer_attention_score_v2", "query_rope");
  c10::impl::check_and_update_common_device(common_device, key_rope, "wrapper__npu_fused_infer_attention_score_v2", "key_rope");
  c10::impl::check_and_update_common_device(common_device, pse_shift, "wrapper__npu_fused_infer_attention_score_v2", "pse_shift");
  c10::impl::check_and_update_common_device(common_device, atten_mask, "wrapper__npu_fused_infer_attention_score_v2", "atten_mask");
  c10::impl::check_and_update_common_device(common_device, block_table, "wrapper__npu_fused_infer_attention_score_v2", "block_table");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_query, "wrapper__npu_fused_infer_attention_score_v2", "dequant_scale_query");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_key, "wrapper__npu_fused_infer_attention_score_v2", "dequant_scale_key");
  c10::impl::check_and_update_common_device(common_device, dequant_offset_key, "wrapper__npu_fused_infer_attention_score_v2", "dequant_offset_key");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_value, "wrapper__npu_fused_infer_attention_score_v2", "dequant_scale_value");
  c10::impl::check_and_update_common_device(common_device, dequant_offset_value, "wrapper__npu_fused_infer_attention_score_v2", "dequant_offset_value");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_key_rope, "wrapper__npu_fused_infer_attention_score_v2", "dequant_scale_key_rope");
  c10::impl::check_and_update_common_device(common_device, quant_scale_out, "wrapper__npu_fused_infer_attention_score_v2", "quant_scale_out");
  c10::impl::check_and_update_common_device(common_device, quant_offset_out, "wrapper__npu_fused_infer_attention_score_v2", "quant_offset_out");
  c10::impl::check_and_update_common_device(common_device, learnable_sink, "wrapper__npu_fused_infer_attention_score_v2", "learnable_sink");
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_infer_attention_score_v2", query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_fused_infer_attention_score_v2_symint(query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_fused_infer_attention_score_v2_symint(query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype);
}

::std::tuple<at::Tensor, at::Tensor> wrapper_out_npu_fused_infer_attention_score_v2_out(const at::Tensor & query,const at::Tensor & key,const at::Tensor & value,const ::std::optional<at::Tensor> & query_rope,const ::std::optional<at::Tensor> & key_rope,const ::std::optional<at::Tensor> & pse_shift,const ::std::optional<at::Tensor> & atten_mask,at::OptionalSymIntArrayRef actual_seq_qlen,at::OptionalSymIntArrayRef actual_seq_kvlen,const ::std::optional<at::Tensor> & block_table,const ::std::optional<at::Tensor> & dequant_scale_query,const ::std::optional<at::Tensor> & dequant_scale_key,const ::std::optional<at::Tensor> & dequant_offset_key,const ::std::optional<at::Tensor> & dequant_scale_value,const ::std::optional<at::Tensor> & dequant_offset_value,const ::std::optional<at::Tensor> & dequant_scale_key_rope,const ::std::optional<at::Tensor> & quant_scale_out,const ::std::optional<at::Tensor> & quant_offset_out,const ::std::optional<at::Tensor> & learnable_sink,int64_t num_query_heads,int64_t num_key_value_heads,double softmax_scale,int64_t pre_tokens,int64_t next_tokens,c10::string_view input_layout,int64_t sparse_mode,int64_t block_size,int64_t query_quant_mode,int64_t key_quant_mode,int64_t value_quant_mode,int64_t inner_precise,bool return_softmax_lse,::std::optional<int64_t> query_dtype,::std::optional<int64_t> key_dtype,::std::optional<int64_t> value_dtype,::std::optional<int64_t> query_rope_dtype,::std::optional<int64_t> key_rope_dtype,::std::optional<int64_t> key_shared_prefix_dtype,::std::optional<int64_t> value_shared_prefix_dtype,::std::optional<int64_t> dequant_scale_query_dtype,::std::optional<int64_t> dequant_scale_key_dtype,::std::optional<int64_t> dequant_scale_value_dtype,::std::optional<int64_t> dequant_scale_key_rope_dtype,const ::std::optional<at::Tensor> & workspace, at::TensorList out) {
  TORCH_CHECK(out.size() == 2, "expected tuple of 2 elements but got ", out.size(), OPS_ERROR(ErrCode::PARAM));
  at::Tensor attention_out = out[0];
  at::Tensor softmax_lse = out[1];
  if (c10_npu::get_npu_data_unsafe_flag()) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, attention_out, "wrapper_out_npu_fused_infer_attention_score_v2_out", "attention_out");
  c10::impl::check_and_update_common_device(common_device, softmax_lse, "wrapper_out_npu_fused_infer_attention_score_v2_out", "softmax_lse");
  c10::impl::check_and_update_common_device(common_device, query, "wrapper_out_npu_fused_infer_attention_score_v2_out", "query");
  c10::impl::check_and_update_common_device(common_device, key, "wrapper_out_npu_fused_infer_attention_score_v2_out", "key");
  c10::impl::check_and_update_common_device(common_device, value, "wrapper_out_npu_fused_infer_attention_score_v2_out", "value");
  c10::impl::check_and_update_common_device(common_device, query_rope, "wrapper_out_npu_fused_infer_attention_score_v2_out", "query_rope");
  c10::impl::check_and_update_common_device(common_device, key_rope, "wrapper_out_npu_fused_infer_attention_score_v2_out", "key_rope");
  c10::impl::check_and_update_common_device(common_device, pse_shift, "wrapper_out_npu_fused_infer_attention_score_v2_out", "pse_shift");
  c10::impl::check_and_update_common_device(common_device, atten_mask, "wrapper_out_npu_fused_infer_attention_score_v2_out", "atten_mask");
  c10::impl::check_and_update_common_device(common_device, block_table, "wrapper_out_npu_fused_infer_attention_score_v2_out", "block_table");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_query, "wrapper_out_npu_fused_infer_attention_score_v2_out", "dequant_scale_query");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_key, "wrapper_out_npu_fused_infer_attention_score_v2_out", "dequant_scale_key");
  c10::impl::check_and_update_common_device(common_device, dequant_offset_key, "wrapper_out_npu_fused_infer_attention_score_v2_out", "dequant_offset_key");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_value, "wrapper_out_npu_fused_infer_attention_score_v2_out", "dequant_scale_value");
  c10::impl::check_and_update_common_device(common_device, dequant_offset_value, "wrapper_out_npu_fused_infer_attention_score_v2_out", "dequant_offset_value");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_key_rope, "wrapper_out_npu_fused_infer_attention_score_v2_out", "dequant_scale_key_rope");
  c10::impl::check_and_update_common_device(common_device, quant_scale_out, "wrapper_out_npu_fused_infer_attention_score_v2_out", "quant_scale_out");
  c10::impl::check_and_update_common_device(common_device, quant_offset_out, "wrapper_out_npu_fused_infer_attention_score_v2_out", "quant_offset_out");
  c10::impl::check_and_update_common_device(common_device, learnable_sink, "wrapper_out_npu_fused_infer_attention_score_v2_out", "learnable_sink");
  c10::impl::check_and_update_common_device(common_device, workspace, "wrapper_out_npu_fused_infer_attention_score_v2_out", "workspace");
  const c10::OptionalDeviceGuard device_guard(device_of(attention_out));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_infer_attention_score_v2.out", query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype, workspace, attention_out, softmax_lse);
      ::std::tuple<at::Tensor &,at::Tensor &> res = op_plugin::npu_fused_infer_attention_score_v2_out_symint(query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype, workspace, attention_out, softmax_lse);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_fused_infer_attention_score_v2_out_symint(query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype, workspace, attention_out, softmax_lse);
}

at::Tensor wrapper___npu_fused_infer_attention_score_v2_get_max_workspace(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & query_rope, const ::std::optional<at::Tensor> & key_rope, const ::std::optional<at::Tensor> & pse_shift, const ::std::optional<at::Tensor> & atten_mask, at::OptionalSymIntArrayRef actual_seq_qlen, at::OptionalSymIntArrayRef actual_seq_kvlen, const ::std::optional<at::Tensor> & block_table, const ::std::optional<at::Tensor> & dequant_scale_query, const ::std::optional<at::Tensor> & dequant_scale_key, const ::std::optional<at::Tensor> & dequant_offset_key, const ::std::optional<at::Tensor> & dequant_scale_value, const ::std::optional<at::Tensor> & dequant_offset_value, const ::std::optional<at::Tensor> & dequant_scale_key_rope, const ::std::optional<at::Tensor> & quant_scale_out, const ::std::optional<at::Tensor> & quant_offset_out, const ::std::optional<at::Tensor> & learnable_sink, int64_t num_query_heads, int64_t num_key_value_heads, double softmax_scale, int64_t pre_tokens, int64_t next_tokens, c10::string_view input_layout, int64_t sparse_mode, int64_t block_size, int64_t query_quant_mode, int64_t key_quant_mode, int64_t value_quant_mode, int64_t inner_precise, bool return_softmax_lse, ::std::optional<int64_t> query_dtype, ::std::optional<int64_t> key_dtype, ::std::optional<int64_t> value_dtype, ::std::optional<int64_t> query_rope_dtype, ::std::optional<int64_t> key_rope_dtype, ::std::optional<int64_t> key_shared_prefix_dtype, ::std::optional<int64_t> value_shared_prefix_dtype, ::std::optional<int64_t> dequant_scale_query_dtype, ::std::optional<int64_t> dequant_scale_key_dtype, ::std::optional<int64_t> dequant_scale_value_dtype, ::std::optional<int64_t> dequant_scale_key_rope_dtype) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, query, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "query");
  c10::impl::check_and_update_common_device(common_device, key, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "key");
  c10::impl::check_and_update_common_device(common_device, value, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "value");
  c10::impl::check_and_update_common_device(common_device, query_rope, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "query_rope");
  c10::impl::check_and_update_common_device(common_device, key_rope, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "key_rope");
  c10::impl::check_and_update_common_device(common_device, pse_shift, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "pse_shift");
  c10::impl::check_and_update_common_device(common_device, atten_mask, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "atten_mask");
  c10::impl::check_and_update_common_device(common_device, block_table, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "block_table");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_query, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "dequant_scale_query");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_key, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "dequant_scale_key");
  c10::impl::check_and_update_common_device(common_device, dequant_offset_key, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "dequant_offset_key");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_value, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "dequant_scale_value");
  c10::impl::check_and_update_common_device(common_device, dequant_offset_value, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "dequant_offset_value");
  c10::impl::check_and_update_common_device(common_device, dequant_scale_key_rope, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "dequant_scale_key_rope");
  c10::impl::check_and_update_common_device(common_device, quant_scale_out, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "quant_scale_out");
  c10::impl::check_and_update_common_device(common_device, quant_offset_out, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "quant_offset_out");
  c10::impl::check_and_update_common_device(common_device, learnable_sink, "wrapper___npu_fused_infer_attention_score_v2_get_max_workspace", "learnable_sink");
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_fused_infer_attention_score_v2_get_max_workspace", query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype);
      at::Tensor res = op_plugin::_npu_fused_infer_attention_score_v2_get_max_workspace_symint(query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_npu_fused_infer_attention_score_v2_get_max_workspace_symint(query, key, value, query_rope, key_rope, pse_shift, atten_mask, actual_seq_qlen, actual_seq_kvlen, block_table, dequant_scale_query, dequant_scale_key, dequant_offset_key, dequant_scale_value, dequant_offset_value, dequant_scale_key_rope, quant_scale_out, quant_offset_out, learnable_sink, num_query_heads, num_key_value_heads, softmax_scale, pre_tokens, next_tokens, input_layout, sparse_mode, block_size, query_quant_mode, key_quant_mode, value_quant_mode, inner_precise, return_softmax_lse, query_dtype, key_dtype, value_dtype, query_rope_dtype, key_rope_dtype, key_shared_prefix_dtype, value_shared_prefix_dtype, dequant_scale_query_dtype, dequant_scale_key_dtype, dequant_scale_value_dtype, dequant_scale_key_rope_dtype);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,int64_t,int64_t,int64_t> wrapper__npu_fusion_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, int64_t head_num, c10::string_view input_layout, const ::std::optional<at::Tensor> & pse, const ::std::optional<at::Tensor> & padding_mask, const ::std::optional<at::Tensor> & atten_mask, double scale, double keep_prob, int64_t pre_tockens, int64_t next_tockens, int64_t inner_precise, at::OptionalIntArrayRef prefix, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen, int64_t sparse_mode, bool gen_mask_parallel, bool sync, c10::string_view softmax_layout) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fusion_attention", query, key, value, head_num, input_layout, pse, padding_mask, atten_mask, scale, keep_prob, pre_tockens, next_tockens, inner_precise, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, softmax_layout);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,int64_t,int64_t,int64_t> res = op_plugin::npu_fusion_attention(query, key, value, head_num, input_layout, pse, padding_mask, atten_mask, scale, keep_prob, pre_tockens, next_tockens, inner_precise, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, softmax_layout);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_fusion_attention(query, key, value, head_num, input_layout, pse, padding_mask, atten_mask, scale, keep_prob, pre_tockens, next_tockens, inner_precise, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, softmax_layout);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_fusion_attention_grad(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & dy, int64_t head_num, c10::string_view input_layout, const ::std::optional<at::Tensor> & pse, const ::std::optional<at::Tensor> & padding_mask, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & softmax_max, const ::std::optional<at::Tensor> & softmax_sum, const ::std::optional<at::Tensor> & softmax_in, const ::std::optional<at::Tensor> & attention_in, double scale_value, double keep_prob, int64_t pre_tockens, int64_t next_tockens, int64_t inner_precise, int64_t seed, int64_t offset, int64_t numels, at::OptionalIntArrayRef prefix, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen, int64_t sparse_mode, bool gen_mask_parallel, bool sync, c10::string_view softmax_layout) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fusion_attention_grad", query, key, value, dy, head_num, input_layout, pse, padding_mask, atten_mask, softmax_max, softmax_sum, softmax_in, attention_in, scale_value, keep_prob, pre_tockens, next_tockens, inner_precise, seed, offset, numels, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, softmax_layout);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_fusion_attention_grad(query, key, value, dy, head_num, input_layout, pse, padding_mask, atten_mask, softmax_max, softmax_sum, softmax_in, attention_in, scale_value, keep_prob, pre_tockens, next_tockens, inner_precise, seed, offset, numels, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, softmax_layout);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,int64_t,int64_t,int64_t> wrapper__npu_fusion_attention_v2(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, int64_t head_num, c10::string_view input_layout, const ::std::optional<at::Tensor> & pse, const ::std::optional<at::Tensor> & padding_mask, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & query_rope, const ::std::optional<at::Tensor> & key_rope, double scale, double keep_prob, int64_t pre_tokens, int64_t next_tokens, int64_t inner_precise, at::OptionalIntArrayRef prefix, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen, int64_t sparse_mode, bool gen_mask_parallel, bool sync, int64_t pse_type, at::OptionalIntArrayRef q_start_idx, at::OptionalIntArrayRef kv_start_idx) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fusion_attention_v2", query, key, value, head_num, input_layout, pse, padding_mask, atten_mask, query_rope, key_rope, scale, keep_prob, pre_tokens, next_tokens, inner_precise, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, pse_type, q_start_idx, kv_start_idx);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,int64_t,int64_t,int64_t> res = op_plugin::npu_fusion_attention_v2(query, key, value, head_num, input_layout, pse, padding_mask, atten_mask, query_rope, key_rope, scale, keep_prob, pre_tokens, next_tokens, inner_precise, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, pse_type, q_start_idx, kv_start_idx);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_fusion_attention_grad_v2(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & dy, int64_t head_num, c10::string_view input_layout, const ::std::optional<at::Tensor> & pse, const ::std::optional<at::Tensor> & padding_mask, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & softmax_max, const ::std::optional<at::Tensor> & softmax_sum, const ::std::optional<at::Tensor> & softmax_in, const ::std::optional<at::Tensor> & attention_in, const ::std::optional<at::Tensor> & query_rope, const ::std::optional<at::Tensor> & key_rope, double scale_value, double keep_prob, int64_t pre_tokens, int64_t next_tokens, int64_t inner_precise, int64_t seed, int64_t offset, int64_t numels, at::OptionalIntArrayRef prefix, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen, int64_t sparse_mode, bool gen_mask_parallel, bool sync, int64_t pse_type, at::OptionalIntArrayRef q_start_idx, at::OptionalIntArrayRef kv_start_idx) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fusion_attention_grad_v2", query, key, value, dy, head_num, input_layout, pse, padding_mask, atten_mask, softmax_max, softmax_sum, softmax_in, attention_in, query_rope, key_rope, scale_value, keep_prob, pre_tokens, next_tokens, inner_precise, seed, offset, numels, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, pse_type, q_start_idx, kv_start_idx);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_fusion_attention_grad_v2(query, key, value, dy, head_num, input_layout, pse, padding_mask, atten_mask, softmax_max, softmax_sum, softmax_in, attention_in, query_rope, key_rope, scale_value, keep_prob, pre_tokens, next_tokens, inner_precise, seed, offset, numels, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, pse_type, q_start_idx, kv_start_idx);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::vector<at::Tensor> wrapper__npu_fused_attention_layernorm_qkv_fwd(const at::Tensor & x, const at::Tensor & kernel_query, const at::Tensor & kernel_key, const at::Tensor & kernel_value, const at::Tensor & gamma, const at::Tensor & beta, const ::std::optional<at::Tensor> & bias_query, const ::std::optional<at::Tensor> & bias_key, const ::std::optional<at::Tensor> & bias_value, int64_t seq_len, int64_t num_heads, double eps) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_attention_layernorm_qkv_fwd", x, kernel_query, kernel_key, kernel_value, gamma, beta, bias_query, bias_key, bias_value, seq_len, num_heads, eps);
      ::std::vector<at::Tensor> res = op_plugin::npu_fused_attention_layernorm_qkv_fwd(x, kernel_query, kernel_key, kernel_value, gamma, beta, bias_query, bias_key, bias_value, seq_len, num_heads, eps);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::vector<at::Tensor> wrapper__npu_fused_attention_qkv_grad(const at::Tensor & grad_output_query, const at::Tensor & grad_output_key, const at::Tensor & grad_output_value, const at::Tensor & query_kernel, const at::Tensor & key_kernel, const at::Tensor & value_kernel, const at::Tensor & hidden_states, const at::Tensor & grad_output_ln) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_attention_qkv_grad", grad_output_query, grad_output_key, grad_output_value, query_kernel, key_kernel, value_kernel, hidden_states, grad_output_ln);
      ::std::vector<at::Tensor> res = op_plugin::npu_fused_attention_qkv_grad(grad_output_query, grad_output_key, grad_output_value, query_kernel, key_kernel, value_kernel, hidden_states, grad_output_ln);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_geglu(const at::Tensor & self, int64_t dim, int64_t approximate, bool activate_left) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_geglu", self, dim, approximate, activate_left);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_geglu(self, dim, approximate, activate_left);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_geglu_grad(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & gelu, int64_t dim, int64_t approximate, bool activate_left) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_geglu_grad", grad_output, self, gelu, dim, approximate, activate_left);
      at::Tensor res = op_plugin::npu_geglu_grad(grad_output, self, gelu, dim, approximate, activate_left);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_get_float_status(const at::Tensor & self, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_get_float_status", self, mode);
      at::Tensor res = op_plugin::npu_get_float_status(self, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_giou(const at::Tensor & self, const at::Tensor & gtboxes, bool trans, bool is_cross, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_giou", self, gtboxes, trans, is_cross, mode);
      at::Tensor res = op_plugin::npu_giou(self, gtboxes, trans, is_cross, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_giou_backward(const at::Tensor & grad, const at::Tensor & bboxes, const at::Tensor & gtboxes, bool trans, bool is_cross, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_giou_backward", grad, bboxes, gtboxes, trans, is_cross, mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_giou_backward(grad, bboxes, gtboxes, trans, is_cross, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_grid_assign_positive(const at::Tensor & self, const at::Tensor & overlaps, const at::Tensor & box_responsible_flags, const at::Tensor & max_overlaps, const at::Tensor & argmax_overlaps, const at::Tensor & gt_max_overlaps, const at::Tensor & gt_argmax_overlaps, int64_t num_gts, double pos_iou_thr, double min_pos_iou, bool gt_max_assign_all) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_grid_assign_positive", self, overlaps, box_responsible_flags, max_overlaps, argmax_overlaps, gt_max_overlaps, gt_argmax_overlaps, num_gts, pos_iou_thr, min_pos_iou, gt_max_assign_all);
      at::Tensor res = op_plugin::npu_grid_assign_positive(self, overlaps, box_responsible_flags, max_overlaps, argmax_overlaps, gt_max_overlaps, gt_argmax_overlaps, num_gts, pos_iou_thr, min_pos_iou, gt_max_assign_all);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_group_norm_silu(const at::Tensor & input, const ::std::optional<at::Tensor> & weight, const ::std::optional<at::Tensor> & bias, int64_t group, double eps) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_group_norm_silu", input, weight, bias, group, eps);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_group_norm_silu(input, weight, bias, group, eps);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::vector<at::Tensor> wrapper__npu_grouped_matmul(at::TensorList x, at::TensorList weight, ::std::optional<at::TensorList> bias, ::std::optional<at::TensorList> scale, ::std::optional<at::TensorList> offset, ::std::optional<at::TensorList> antiquant_scale, ::std::optional<at::TensorList> antiquant_offset, ::std::optional<at::TensorList> per_token_scale, const ::std::optional<at::Tensor> & group_list, ::std::optional<at::TensorList> activation_input, ::std::optional<at::TensorList> activation_quant_scale, ::std::optional<at::TensorList> activation_quant_offset, ::std::optional<int64_t> split_item, ::std::optional<int64_t> group_type, ::std::optional<int64_t> group_list_type, ::std::optional<int64_t> act_type, at::OptionalIntArrayRef tuning_config, ::std::optional<at::ScalarType> output_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_grouped_matmul", x, weight, bias, scale, offset, antiquant_scale, antiquant_offset, per_token_scale, group_list, activation_input, activation_quant_scale, activation_quant_offset, split_item, group_type, group_list_type, act_type, tuning_config, output_dtype);
      ::std::vector<at::Tensor> res = op_plugin::npu_grouped_matmul(x, weight, bias, scale, offset, antiquant_scale, antiquant_offset, per_token_scale, group_list, activation_input, activation_quant_scale, activation_quant_offset, split_item, group_type, group_list_type, act_type, tuning_config, output_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::vector<at::Tensor> wrapper_List_npu_grouped_matmul(at::TensorList x, at::TensorList weight, ::std::optional<at::TensorList> bias, ::std::optional<at::TensorList> scale, ::std::optional<at::TensorList> offset, ::std::optional<at::TensorList> antiquant_scale, ::std::optional<at::TensorList> antiquant_offset, ::std::optional<at::TensorList> per_token_scale, at::OptionalIntArrayRef group_list, ::std::optional<at::TensorList> activation_input, ::std::optional<at::TensorList> activation_quant_scale, ::std::optional<at::TensorList> activation_quant_offset, ::std::optional<int64_t> split_item, ::std::optional<int64_t> group_type, ::std::optional<int64_t> group_list_type, ::std::optional<int64_t> act_type, ::std::optional<at::ScalarType> output_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_grouped_matmul.List", x, weight, bias, scale, offset, antiquant_scale, antiquant_offset, per_token_scale, group_list, activation_input, activation_quant_scale, activation_quant_offset, split_item, group_type, group_list_type, act_type, output_dtype);
      ::std::vector<at::Tensor> res = op_plugin::npu_grouped_matmul(x, weight, bias, scale, offset, antiquant_scale, antiquant_offset, per_token_scale, group_list, activation_input, activation_quant_scale, activation_quant_offset, split_item, group_type, group_list_type, act_type, output_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_grouped_matmul_finalize_routing(const at::Tensor & x, const at::Tensor & w, const at::Tensor & group_list, const ::std::optional<at::Tensor> & scale, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & offset, const ::std::optional<at::Tensor> & pertoken_scale, const ::std::optional<at::Tensor> & shared_input, const ::std::optional<at::Tensor> & logit, const ::std::optional<at::Tensor> & row_index, ::std::optional<at::ScalarType> dtype, ::std::optional<double> shared_input_weight, ::std::optional<int64_t> shared_input_offset, ::std::optional<int64_t> output_bs, ::std::optional<int64_t> group_list_type, at::OptionalIntArrayRef tuning_config) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_grouped_matmul_finalize_routing", x, w, group_list, scale, bias, offset, pertoken_scale, shared_input, logit, row_index, dtype, shared_input_weight, shared_input_offset, output_bs, group_list_type, tuning_config);
      at::Tensor res = op_plugin::npu_grouped_matmul_finalize_routing(x, w, group_list, scale, bias, offset, pertoken_scale, shared_input, logit, row_index, dtype, shared_input_weight, shared_input_offset, output_bs, group_list_type, tuning_config);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_grouped_matmul_finalize_routing(x, w, group_list, scale, bias, offset, pertoken_scale, shared_input, logit, row_index, dtype, shared_input_weight, shared_input_offset, output_bs, group_list_type, tuning_config);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_gru(const at::Tensor & input, const at::Tensor & hx, const at::Tensor & weight_input, const at::Tensor & weight_hidden, const at::Tensor & bias_input, const at::Tensor & bias_hidden, const at::Tensor & seq_length, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gru", input, hx, weight_input, weight_hidden, bias_input, bias_hidden, seq_length, has_biases, num_layers, dropout, train, bidirectional, batch_first);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_gru(input, hx, weight_input, weight_hidden, bias_input, bias_hidden, seq_length, has_biases, num_layers, dropout, train, bidirectional, batch_first);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_gru_backward(const ::std::optional<at::Tensor> & grady, const ::std::optional<at::Tensor> & gradh, const at::Tensor & input, const at::Tensor & weight_input, const at::Tensor & weight_hidden, const at::Tensor & bias_input, const at::Tensor & bias_hidden, const at::Tensor & seq_length, const at::Tensor & hx, const at::Tensor & y_output, const at::Tensor & h_output, const at::Tensor & output_updata, const at::Tensor & output_reset, const at::Tensor & output_new, const at::Tensor & hidden_new) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gru_backward", grady, gradh, input, weight_input, weight_hidden, bias_input, bias_hidden, seq_length, hx, y_output, h_output, output_updata, output_reset, output_new, hidden_new);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_gru_backward(grady, gradh, input, weight_input, weight_hidden, bias_input, bias_hidden, seq_length, hx, y_output, h_output, output_updata, output_reset, output_new, hidden_new);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> wrapper_out_npu_hans_encode_out(const at::Tensor & input,bool statistic,bool reshuff, at::TensorList out) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_hans_encode.out", input, statistic, reshuff, pdf, mantissa, fixed, var);
      ::std::tuple<at::Tensor &,at::Tensor &,at::Tensor &,at::Tensor &> res = op_plugin::npu_hans_encode_out(input, statistic, reshuff, pdf, mantissa, fixed, var);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_hans_decode_out(const at::Tensor & mantissa, const at::Tensor & fixed, const at::Tensor & var, const at::Tensor & pdf, bool reshuff, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(out));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_hans_decode.out", mantissa, fixed, var, pdf, reshuff, out);
      at::Tensor & res = op_plugin::npu_hans_decode_out(mantissa, fixed, var, pdf, reshuff, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_ifmr(const at::Tensor & data, const at::Tensor & data_min, const at::Tensor & data_max, const at::Tensor & cumsum, double min_percentile, double max_percentile, double search_start, double search_end, double search_step, bool with_offset) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ifmr", data, data_min, data_max, cumsum, min_percentile, max_percentile, search_start, search_end, search_step, with_offset);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_ifmr(data, data_min, data_max, cumsum, min_percentile, max_percentile, search_start, search_end, search_step, with_offset);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_incre_flash_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & padding_mask, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & pse_shift, at::OptionalSymIntArrayRef actual_seq_lengths, const ::std::optional<at::Tensor> & antiquant_scale, const ::std::optional<at::Tensor> & antiquant_offset, const ::std::optional<at::Tensor> & block_table, const ::std::optional<at::Tensor> & dequant_scale1, const ::std::optional<at::Tensor> & quant_scale1, const ::std::optional<at::Tensor> & dequant_scale2, const ::std::optional<at::Tensor> & quant_scale2, const ::std::optional<at::Tensor> & quant_offset2, const ::std::optional<at::Tensor> & kv_padding_size, int64_t num_heads, double scale_value, c10::string_view input_layout, int64_t num_key_value_heads, int64_t block_size, int64_t inner_precise) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, query, "wrapper__npu_incre_flash_attention", "query");
  c10::impl::check_and_update_common_device(common_device, key, "wrapper__npu_incre_flash_attention", "key");
  c10::impl::check_and_update_common_device(common_device, value, "wrapper__npu_incre_flash_attention", "value");
  c10::impl::check_and_update_common_device(common_device, padding_mask, "wrapper__npu_incre_flash_attention", "padding_mask");
  c10::impl::check_and_update_common_device(common_device, atten_mask, "wrapper__npu_incre_flash_attention", "atten_mask");
  c10::impl::check_and_update_common_device(common_device, pse_shift, "wrapper__npu_incre_flash_attention", "pse_shift");
  c10::impl::check_and_update_common_device(common_device, antiquant_scale, "wrapper__npu_incre_flash_attention", "antiquant_scale");
  c10::impl::check_and_update_common_device(common_device, antiquant_offset, "wrapper__npu_incre_flash_attention", "antiquant_offset");
  c10::impl::check_and_update_common_device(common_device, block_table, "wrapper__npu_incre_flash_attention", "block_table");
  c10::impl::check_and_update_common_device(common_device, dequant_scale1, "wrapper__npu_incre_flash_attention", "dequant_scale1");
  c10::impl::check_and_update_common_device(common_device, quant_scale1, "wrapper__npu_incre_flash_attention", "quant_scale1");
  c10::impl::check_and_update_common_device(common_device, dequant_scale2, "wrapper__npu_incre_flash_attention", "dequant_scale2");
  c10::impl::check_and_update_common_device(common_device, quant_scale2, "wrapper__npu_incre_flash_attention", "quant_scale2");
  c10::impl::check_and_update_common_device(common_device, quant_offset2, "wrapper__npu_incre_flash_attention", "quant_offset2");
  c10::impl::check_and_update_common_device(common_device, kv_padding_size, "wrapper__npu_incre_flash_attention", "kv_padding_size");
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_incre_flash_attention", query, key, value, padding_mask, atten_mask, pse_shift, actual_seq_lengths, antiquant_scale, antiquant_offset, block_table, dequant_scale1, quant_scale1, dequant_scale2, quant_scale2, quant_offset2, kv_padding_size, num_heads, scale_value, input_layout, num_key_value_heads, block_size, inner_precise);
      at::Tensor res = op_plugin::npu_incre_flash_attention_symint(query, key, value, padding_mask, atten_mask, pse_shift, actual_seq_lengths, antiquant_scale, antiquant_offset, block_table, dequant_scale1, quant_scale1, dequant_scale2, quant_scale2, quant_offset2, kv_padding_size, num_heads, scale_value, input_layout, num_key_value_heads, block_size, inner_precise);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_incre_flash_attention_symint(query, key, value, padding_mask, atten_mask, pse_shift, actual_seq_lengths, antiquant_scale, antiquant_offset, block_table, dequant_scale1, quant_scale1, dequant_scale2, quant_scale2, quant_offset2, kv_padding_size, num_heads, scale_value, input_layout, num_key_value_heads, block_size, inner_precise);
}
...
at::Tensor wrapper__npu_interleave_rope(const at::Tensor & x, const at::Tensor & cos, const at::Tensor & sin) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_interleave_rope", x, cos, sin);
      at::Tensor res = op_plugin::npu_interleave_rope(x, cos, sin);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_indexing(const at::Tensor & self, at::IntArrayRef begin, at::IntArrayRef end, at::IntArrayRef strides, int64_t begin_mask, int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask, int64_t shrink_axis_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_indexing", self, begin, end, strides, begin_mask, end_mask, ellipsis_mask, new_axis_mask, shrink_axis_mask);
      at::Tensor res = op_plugin::npu_indexing(self, begin, end, strides, begin_mask, end_mask, ellipsis_mask, new_axis_mask, shrink_axis_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_indexing_out(const at::Tensor & self, at::IntArrayRef begin, at::IntArrayRef end, at::IntArrayRef strides, int64_t begin_mask, int64_t end_mask, int64_t ellipsis_mask, int64_t new_axis_mask, int64_t shrink_axis_mask, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_indexing.out", self, begin, end, strides, begin_mask, end_mask, ellipsis_mask, new_axis_mask, shrink_axis_mask, out);
      at::Tensor & res = op_plugin::npu_indexing_out(self, begin, end, strides, begin_mask, end_mask, ellipsis_mask, new_axis_mask, shrink_axis_mask, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_iou(const at::Tensor & bboxes, const at::Tensor & gtboxes, int64_t mode) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_iou", bboxes, gtboxes, mode);
      at::Tensor res = op_plugin::npu_iou(bboxes, gtboxes, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_layer_norm_eval(const at::Tensor & input, at::IntArrayRef normalized_shape, const ::std::optional<at::Tensor> & weight, const ::std::optional<at::Tensor> & bias, double eps) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_layer_norm_eval", input, normalized_shape, weight, bias, eps);
      at::Tensor res = op_plugin::npu_layer_norm_eval(input, normalized_shape, weight, bias, eps);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_layernorm_grad(const at::Tensor & grad_out, const at::Tensor & input, at::IntArrayRef normalized_shape, const at::Tensor & mean, const at::Tensor & rstd, const ::std::optional<at::Tensor> & weight, const ::std::optional<at::Tensor> & bias) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_layernorm_grad", grad_out, input, normalized_shape, mean, rstd, weight, bias);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_layernorm_grad(grad_out, input, normalized_shape, mean, rstd, weight, bias);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_linear(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_linear", input, weight, bias);
      at::Tensor res = op_plugin::npu_linear(input, weight, bias);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_linear_backward(const at::Tensor & grad, const at::Tensor & input, const at::Tensor & weight) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_linear_backward", grad, input, weight);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_linear_backward(grad, input, weight);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_lstm(const at::Tensor & input, const at::Tensor & weight, const at::Tensor & bias, const at::Tensor & seq_mask, const at::Tensor & h, const at::Tensor & c, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first, bool flag_seq, bool direction) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_lstm", input, weight, bias, seq_mask, h, c, has_biases, num_layers, dropout, train, bidirectional, batch_first, flag_seq, direction);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_lstm(input, weight, bias, seq_mask, h, c, has_biases, num_layers, dropout, train, bidirectional, batch_first, flag_seq, direction);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_lstm_backward(const ::std::optional<at::Tensor> & grady, const ::std::optional<at::Tensor> & gradh, const ::std::optional<at::Tensor> & gradc, const at::Tensor & input, const at::Tensor & weight, const at::Tensor & bias, const at::Tensor & hx, const at::Tensor & cx, const at::Tensor & y_output, const at::Tensor & h_output, const at::Tensor & c_output, const at::Tensor & i, const at::Tensor & j, const at::Tensor & f, const at::Tensor & o, const at::Tensor & tanhc) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grady));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_lstm_backward", grady, gradh, gradc, input, weight, bias, hx, cx, y_output, h_output, c_output, i, j, f, o, tanhc);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_lstm_backward(grady, gradh, gradc, input, weight, bias, hx, cx, y_output, h_output, c_output, i, j, f, o, tanhc);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_lstm_cell(const at::Tensor & input, const at::Tensor & w_ih, const at::Tensor & w_hh, const at::Tensor & h, const at::Tensor & c, const ::std::optional<at::Tensor> & b_ih, const ::std::optional<at::Tensor> & b_hh) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_lstm_cell", input, w_ih, w_hh, h, c, b_ih, b_hh);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_lstm_cell(input, w_ih, w_hh, h, c, b_ih, b_hh);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_lstm_cell_backward(const ::std::optional<at::Tensor> & grady, const ::std::optional<at::Tensor> & gradh, const ::std::optional<at::Tensor> & gradc, const at::Tensor & input, const at::Tensor & w_ih, const at::Tensor & w_hh, const at::Tensor & h, const at::Tensor & c, const at::Tensor & y_output, const at::Tensor & h_output, const at::Tensor & c_output, const at::Tensor & i, const at::Tensor & j, const at::Tensor & f, const at::Tensor & o, const at::Tensor & tanhc) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grady));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_lstm_cell_backward", grady, gradh, gradc, input, w_ih, w_hh, h, c, y_output, h_output, c_output, i, j, f, o, tanhc);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_lstm_cell_backward(grady, gradh, gradc, input, w_ih, w_hh, h, c, y_output, h_output, c_output, i, j, f, o, tanhc);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_lstm_data(const at::Tensor & input, const at::Tensor & batch_sizes, const at::Tensor & weight, const at::Tensor & bias, const at::Tensor & seq_mask, const at::Tensor & h, const at::Tensor & c, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first, bool flag_seq, bool direction) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_lstm_data", input, batch_sizes, weight, bias, seq_mask, h, c, has_biases, num_layers, dropout, train, bidirectional, batch_first, flag_seq, direction);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_lstm_data(input, batch_sizes, weight, bias, seq_mask, h, c, has_biases, num_layers, dropout, train, bidirectional, batch_first, flag_seq, direction);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_lstm_data_backward(const ::std::optional<at::Tensor> & grady_opt, const ::std::optional<at::Tensor> & gradh_opt, const ::std::optional<at::Tensor> & gradc_opt, const at::Tensor & input, const at::Tensor & batch_sizes, const at::Tensor & weight, const at::Tensor & bias, const at::Tensor & init_h, const at::Tensor & init_c, const at::Tensor & y, const at::Tensor & h, const at::Tensor & c, const at::Tensor & i, const at::Tensor & j, const at::Tensor & f, const at::Tensor & o, const at::Tensor & tanhc, bool flag_direction) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_lstm_data_backward", grady_opt, gradh_opt, gradc_opt, input, batch_sizes, weight, bias, init_h, init_c, y, h, c, i, j, f, o, tanhc, flag_direction);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_lstm_data_backward(grady_opt, gradh_opt, gradc_opt, input, batch_sizes, weight, bias, init_h, init_c, y, h, c, i, j, f, o, tanhc, flag_direction);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_masked_fill_range(const at::Tensor & self, const at::Tensor & start, const at::Tensor & end, const at::Tensor & value, int64_t axis) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_masked_fill_range", self, start, end, value, axis);
      at::Tensor res = op_plugin::npu_masked_fill_range(self, start, end, value, axis);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_masked_softmax_with_rel_pos_bias(const at::Tensor & x, const ::std::optional<at::Tensor> & atten_mask, const at::Tensor & relative_pos_bias, double scale_value, int64_t inner_precision_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_masked_softmax_with_rel_pos_bias", x, atten_mask, relative_pos_bias, scale_value, inner_precision_mode);
      at::Tensor res = op_plugin::npu_masked_softmax_with_rel_pos_bias(x, atten_mask, relative_pos_bias, scale_value, inner_precision_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper_dim_npu_max(const at::Tensor & self, int64_t dim, bool keepdim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_max.dim", self, dim, keepdim);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_max(self, dim, keepdim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper_names_dim_npu_max(const at::Tensor & self, at::Dimname dim, bool keepdim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_max.names_dim", self, dim, keepdim);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_max(self, dim, keepdim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_max_backward(const at::Tensor & grad, int64_t dim, const at::Tensor & indices, c10::SymIntArrayRef sizes, bool keepdim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_max_backward", grad, dim, indices, sizes, keepdim);
      at::Tensor res = op_plugin::npu_max_backward_symint(grad, dim, indices, sizes, keepdim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper_dim_npu_min(const at::Tensor & self, int64_t dim, bool keepdim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_min.dim", self, dim, keepdim);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_min(self, dim, keepdim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper_names_dim_npu_min(const at::Tensor & self, at::Dimname dim, bool keepdim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_min.names_dim", self, dim, keepdim);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_min(self, dim, keepdim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_min_backward(const at::Tensor & grad, int64_t dim, const at::Tensor & indices, c10::SymIntArrayRef sizes, bool keepdim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_min_backward", grad, dim, indices, sizes, keepdim);
      at::Tensor res = op_plugin::npu_min_backward_symint(grad, dim, indices, sizes, keepdim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_mish(const at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_mish", self);
      at::Tensor res = op_plugin::npu_mish(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_mish_backward(const at::Tensor & grad, const at::Tensor & input) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_mish_backward", grad, input);
      at::Tensor res = op_plugin::npu_mish_backward(grad, input);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_mla_prolog(const at::Tensor & token_x, const at::Tensor & weight_dq, const at::Tensor & weight_uq_qr, const at::Tensor & weight_uk, const at::Tensor & weight_dkv_kr, const at::Tensor & rmsnorm_gamma_cq, const at::Tensor & rmsnorm_gamma_ckv, const at::Tensor & rope_sin, const at::Tensor & rope_cos, const at::Tensor & cache_index, const at::Tensor & kv_cache, const at::Tensor & kr_cache, const ::std::optional<at::Tensor> & dequant_scale_x, const ::std::optional<at::Tensor> & dequant_scale_w_dq, const ::std::optional<at::Tensor> & dequant_scale_w_uq_qr, const ::std::optional<at::Tensor> & dequant_scale_w_dkv_kr, const ::std::optional<at::Tensor> & quant_scale_ckv, const ::std::optional<at::Tensor> & quant_scale_ckr, const ::std::optional<at::Tensor> & smooth_scales_cq, double rmsnorm_epsilon_cq, double rmsnorm_epsilon_ckv, c10::string_view cache_mode) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_mla_prolog", token_x, weight_dq, weight_uq_qr, weight_uk, weight_dkv_kr, rmsnorm_gamma_cq, rmsnorm_gamma_ckv, rope_sin, rope_cos, cache_index, kv_cache, kr_cache, dequant_scale_x, dequant_scale_w_dq, dequant_scale_w_uq_qr, dequant_scale_w_dkv_kr, quant_scale_ckv, quant_scale_ckr, smooth_scales_cq, rmsnorm_epsilon_cq, rmsnorm_epsilon_ckv, cache_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_mla_prolog(token_x, weight_dq, weight_uq_qr, weight_uk, weight_dkv_kr, rmsnorm_gamma_cq, rmsnorm_gamma_ckv, rope_sin, rope_cos, cache_index, kv_cache, kr_cache, dequant_scale_x, dequant_scale_w_dq, dequant_scale_w_uq_qr, dequant_scale_w_dkv_kr, quant_scale_ckv, quant_scale_ckr, smooth_scales_cq, rmsnorm_epsilon_cq, rmsnorm_epsilon_ckv, cache_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_mla_prolog_v2(const at::Tensor & token_x, const at::Tensor & weight_dq, const at::Tensor & weight_uq_qr, const at::Tensor & weight_uk, const at::Tensor & weight_dkv_kr, const at::Tensor & rmsnorm_gamma_cq, const at::Tensor & rmsnorm_gamma_ckv, const at::Tensor & rope_sin, const at::Tensor & rope_cos, const at::Tensor & cache_index, const at::Tensor & kv_cache, const at::Tensor & kr_cache, const ::std::optional<at::Tensor> & dequant_scale_x, const ::std::optional<at::Tensor> & dequant_scale_w_dq, const ::std::optional<at::Tensor> & dequant_scale_w_uq_qr, const ::std::optional<at::Tensor> & dequant_scale_w_dkv_kr, const ::std::optional<at::Tensor> & quant_scale_ckv, const ::std::optional<at::Tensor> & quant_scale_ckr, const ::std::optional<at::Tensor> & smooth_scales_cq, double rmsnorm_epsilon_cq, double rmsnorm_epsilon_ckv, c10::string_view cache_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(token_x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_mla_prolog_v2", token_x, weight_dq, weight_uq_qr, weight_uk, weight_dkv_kr, rmsnorm_gamma_cq, rmsnorm_gamma_ckv, rope_sin, rope_cos, cache_index, kv_cache, kr_cache, dequant_scale_x, dequant_scale_w_dq, dequant_scale_w_uq_qr, dequant_scale_w_dkv_kr, quant_scale_ckv, quant_scale_ckr, smooth_scales_cq, rmsnorm_epsilon_cq, rmsnorm_epsilon_ckv, cache_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_mla_prolog_v2(token_x, weight_dq, weight_uq_qr, weight_uk, weight_dkv_kr, rmsnorm_gamma_cq, rmsnorm_gamma_ckv, rope_sin, rope_cos, cache_index, kv_cache, kr_cache, dequant_scale_x, dequant_scale_w_dq, dequant_scale_w_uq_qr, dequant_scale_w_dkv_kr, quant_scale_ckv, quant_scale_ckr, smooth_scales_cq, rmsnorm_epsilon_cq, rmsnorm_epsilon_ckv, cache_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_mm_all_reduce_base(const at::Tensor & x1, const at::Tensor & x2, c10::string_view hcom, c10::string_view reduce_op, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & antiquant_scale, const ::std::optional<at::Tensor> & antiquant_offset, const ::std::optional<at::Tensor> & x3, const ::std::optional<at::Tensor> & dequant_scale, const ::std::optional<at::Tensor> & pertoken_scale, const ::std::optional<at::Tensor> & comm_quant_scale_1, const ::std::optional<at::Tensor> & comm_quant_scale_2, int64_t antiquant_group_size, int64_t comm_turn) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x1));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_mm_all_reduce_base", x1, x2, hcom, reduce_op, bias, antiquant_scale, antiquant_offset, x3, dequant_scale, pertoken_scale, comm_quant_scale_1, comm_quant_scale_2, antiquant_group_size, comm_turn);
      at::Tensor res = op_plugin::npu_mm_all_reduce_base(x1, x2, hcom, reduce_op, bias, antiquant_scale, antiquant_offset, x3, dequant_scale, pertoken_scale, comm_quant_scale_1, comm_quant_scale_2, antiquant_group_size, comm_turn);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_mm_reduce_scatter_base(const at::Tensor & self, const at::Tensor & x2, c10::string_view hcom, int64_t world_size, c10::string_view reduce_op, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & x1_scale, const ::std::optional<at::Tensor> & x2_scale, int64_t comm_turn, ::std::optional<at::ScalarType> output_dtype, ::std::optional<c10::string_view> comm_mode) {
  ...
  c10::impl::check_and_update_common_device(common_device, x1_scale, "wrapper__npu_mm_reduce_scatter_base", "x1_scale");
  c10::impl::check_and_update_common_device(common_device, x2_scale, "wrapper__npu_mm_reduce_scatter_base", "x2_scale");
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_mm_reduce_scatter_base", self, x2, hcom, world_size, reduce_op, bias, x1_scale, x2_scale, comm_turn, output_dtype, comm_mode);
      at::Tensor res = op_plugin::npu_mm_reduce_scatter_base(self, x2, hcom, world_size, reduce_op, bias, x1_scale, x2_scale, comm_turn, output_dtype, comm_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_mm_reduce_scatter_base(self, x2, hcom, world_size, reduce_op, bias, x1_scale, x2_scale, comm_turn, output_dtype, comm_mode);
}
...
at::Tensor wrapper__npu_moe_compute_expert_tokens(const at::Tensor & sorted_expert_for_source_row, int64_t num_expert) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_compute_expert_tokens", sorted_expert_for_source_row, num_expert);
      at::Tensor res = op_plugin::npu_moe_compute_expert_tokens(sorted_expert_for_source_row, num_expert);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_moe_finalize_routing(const at::Tensor & expanded_permuted_rows, const ::std::optional<at::Tensor> & skip1, const ::std::optional<at::Tensor> & skip2, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & scales, const at::Tensor & expanded_src_to_dst_row, const ::std::optional<at::Tensor> & export_for_source_row, ::std::optional<int64_t> drop_pad_mode) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_finalize_routing", expanded_permuted_rows, skip1, skip2, bias, scales, expanded_src_to_dst_row, export_for_source_row, drop_pad_mode);
      at::Tensor res = op_plugin::npu_moe_finalize_routing(expanded_permuted_rows, skip1, skip2, bias, scales, expanded_src_to_dst_row, export_for_source_row, drop_pad_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_gating_top_k_softmax(const at::Tensor & x, const ::std::optional<at::Tensor> & finished, int64_t k) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_gating_top_k_softmax", x, finished, k);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_gating_top_k_softmax(x, finished, k);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_gating_top_k(const at::Tensor & x, int64_t k, const ::std::optional<at::Tensor> & bias, int64_t k_group, int64_t group_count, int64_t group_select_mode, int64_t renorm, int64_t norm_type, bool out_flag, double routed_scaling_factor, double eps) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_gating_top_k", x, k, bias, k_group, group_count, group_select_mode, renorm, norm_type, out_flag, routed_scaling_factor, eps);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_gating_top_k(x, k, bias, k_group, group_count, group_select_mode, renorm, norm_type, out_flag, routed_scaling_factor, eps);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_init_routing(const at::Tensor & x, const at::Tensor & row_idx, const at::Tensor & expert_idx, int64_t active_num) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_init_routing", x, row_idx, expert_idx, active_num);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_init_routing(x, row_idx, expert_idx, active_num);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_init_routing_v2(const at::Tensor & x, const at::Tensor & expert_idx, const ::std::optional<at::Tensor> & scale, const ::std::optional<at::Tensor> & offset, int64_t active_num, int64_t expert_capacity, int64_t expert_num, int64_t drop_pad_mode, int64_t expert_tokens_num_type, bool expert_tokens_num_flag, int64_t quant_mode, at::IntArrayRef active_expert_range, int64_t row_idx_type) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_init_routing_v2", x, expert_idx, scale, offset, active_num, expert_capacity, expert_num, drop_pad_mode, expert_tokens_num_type, expert_tokens_num_flag, quant_mode, active_expert_range, row_idx_type);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_init_routing_v2(x, expert_idx, scale, offset, active_num, expert_capacity, expert_num, drop_pad_mode, expert_tokens_num_type, expert_tokens_num_flag, quant_mode, active_expert_range, row_idx_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_init_routing_quant(const at::Tensor & x, const at::Tensor & expert_idx, const ::std::optional<at::Tensor> & scale, const ::std::optional<at::Tensor> & offset, int64_t active_num, int64_t expert_capacity, int64_t expert_num, int64_t drop_pad_mode, int64_t expert_tokens_num_mode, bool expert_tokens_before_capacity_flag, int64_t quant_mode) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, x, "wrapper__npu_moe_init_routing_quant", "x");
  c10::impl::check_and_update_common_device(common_device, expert_idx, "wrapper__npu_moe_init_routing_quant", "expert_idx");
  c10::impl::check_and_update_common_device(common_device, scale, "wrapper__npu_moe_init_routing_quant", "scale");
  c10::impl::check_and_update_common_device(common_device, offset, "wrapper__npu_moe_init_routing_quant", "offset");
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_init_routing_quant", x, expert_idx, scale, offset, active_num, expert_capacity, expert_num, drop_pad_mode, expert_tokens_num_mode, expert_tokens_before_capacity_flag, quant_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_init_routing_quant(x, expert_idx, scale, offset, active_num, expert_capacity, expert_num, drop_pad_mode, expert_tokens_num_mode, expert_tokens_before_capacity_flag, quant_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_init_routing_quant(x, expert_idx, scale, offset, active_num, expert_capacity, expert_num, drop_pad_mode, expert_tokens_num_mode, expert_tokens_before_capacity_flag, quant_mode);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_grouped_matmul_swiglu_quant(const at::Tensor & x, const at::Tensor & weight, const at::Tensor & group_list, const at::Tensor & weight_scale, const at::Tensor & x_scale, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & offset) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_grouped_matmul_swiglu_quant", x, weight, group_list, weight_scale, x_scale, bias, offset);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_grouped_matmul_swiglu_quant(x, weight, group_list, weight_scale, x_scale, bias, offset);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_ffn_worker_batching(const at::Tensor & schedule_context, int64_t expert_num, at::IntArrayRef max_out_shape, int64_t token_dtype, int64_t need_schedule, int64_t layer_num) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(schedule_context);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, schedule_context, "wrapper__npu_ffn_worker_batching", "schedule_context");
  const c10::OptionalDeviceGuard device_guard(device_of(schedule_context));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ffn_worker_batching", schedule_context, expert_num, max_out_shape, token_dtype, need_schedule, layer_num);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_ffn_worker_batching(schedule_context, expert_num, max_out_shape, token_dtype, need_schedule, layer_num);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_ffn_worker_batching(schedule_context, expert_num, max_out_shape, token_dtype, need_schedule, layer_num);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_distribute_dispatch(const at::Tensor & x, const at::Tensor & expert_ids, c10::string_view group_ep, int64_t ep_world_size, int64_t ep_rank_id, int64_t moe_expert_num, const ::std::optional<at::Tensor> & scales, const ::std::optional<at::Tensor> & x_active_mask, const ::std::optional<at::Tensor> & expert_scales, c10::string_view group_tp, int64_t tp_world_size, int64_t tp_rank_id, int64_t expert_shard_type, int64_t shared_expert_num, int64_t shared_expert_rank_num, int64_t quant_mode, int64_t global_bs, int64_t expert_token_nums_type) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_distribute_dispatch", x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num, scales, x_active_mask, expert_scales, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, quant_mode, global_bs, expert_token_nums_type);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_distribute_dispatch(x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num, scales, x_active_mask, expert_scales, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, quant_mode, global_bs, expert_token_nums_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_distribute_dispatch_v2(const at::Tensor & x, const at::Tensor & expert_ids, c10::string_view group_ep, int64_t ep_world_size, int64_t ep_rank_id, int64_t moe_expert_num, const ::std::optional<at::Tensor> & scales, const ::std::optional<at::Tensor> & x_active_mask, const ::std::optional<at::Tensor> & expert_scales, const ::std::optional<at::Tensor> & elastic_info, c10::string_view group_tp, int64_t tp_world_size, int64_t tp_rank_id, int64_t expert_shard_type, int64_t shared_expert_num, int64_t shared_expert_rank_num, int64_t quant_mode, int64_t global_bs, int64_t expert_token_nums_type, c10::string_view comm_alg, int64_t zero_expert_num, int64_t copy_expert_num, int64_t const_expert_num) {
  ...
  c10::impl::check_and_update_common_device(common_device, elastic_info, "wrapper__npu_moe_distribute_dispatch_v2", "elastic_info");
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_distribute_dispatch_v2", x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num, scales, x_active_mask, expert_scales, elastic_info, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, quant_mode, global_bs, expert_token_nums_type, comm_alg, zero_expert_num, copy_expert_num, const_expert_num);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_distribute_dispatch_v2(x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num, scales, x_active_mask, expert_scales, elastic_info, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, quant_mode, global_bs, expert_token_nums_type, comm_alg, zero_expert_num, copy_expert_num, const_expert_num);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_distribute_dispatch_v2(x, expert_ids, group_ep, ep_world_size, ep_rank_id, moe_expert_num, scales, x_active_mask, expert_scales, elastic_info, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, quant_mode, global_bs, expert_token_nums_type, comm_alg, zero_expert_num, copy_expert_num, const_expert_num);
}
...
at::Tensor wrapper__npu_moe_distribute_combine_v2(const at::Tensor & expand_x, const at::Tensor & expert_ids, const at::Tensor & assist_info_for_combine, const at::Tensor & ep_send_counts, const at::Tensor & expert_scales, c10::string_view group_ep, int64_t ep_world_size, int64_t ep_rank_id, int64_t moe_expert_num, const ::std::optional<at::Tensor> & tp_send_counts, const ::std::optional<at::Tensor> & x_active_mask, const ::std::optional<at::Tensor> & expand_scales, const ::std::optional<at::Tensor> & shared_expert_x, const ::std::optional<at::Tensor> & elastic_info, const ::std::optional<at::Tensor> & ori_x, const ::std::optional<at::Tensor> & const_expert_alpha_1, const ::std::optional<at::Tensor> & const_expert_alpha_2, const ::std::optional<at::Tensor> & const_expert_v, c10::string_view group_tp, int64_t tp_world_size, int64_t tp_rank_id, int64_t expert_shard_type, int64_t shared_expert_num, int64_t shared_expert_rank_num, int64_t global_bs, int64_t comm_quant_mode, c10::string_view comm_alg, int64_t zero_expert_num, int64_t copy_expert_num, int64_t const_expert_num) {
  ...
  c10::impl::check_and_update_common_device(common_device, elastic_info, "wrapper__npu_moe_distribute_combine_v2", "elastic_info");
  c10::impl::check_and_update_common_device(common_device, ori_x, "wrapper__npu_moe_distribute_combine_v2", "ori_x");
  c10::impl::check_and_update_common_device(common_device, const_expert_alpha_1, "wrapper__npu_moe_distribute_combine_v2", "const_expert_alpha_1");
  c10::impl::check_and_update_common_device(common_device, const_expert_alpha_2, "wrapper__npu_moe_distribute_combine_v2", "const_expert_alpha_2");
  c10::impl::check_and_update_common_device(common_device, const_expert_v, "wrapper__npu_moe_distribute_combine_v2", "const_expert_v");
  const c10::OptionalDeviceGuard device_guard(device_of(expand_x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_distribute_combine_v2", expand_x, expert_ids, assist_info_for_combine, ep_send_counts, expert_scales, group_ep, ep_world_size, ep_rank_id, moe_expert_num, tp_send_counts, x_active_mask, expand_scales, shared_expert_x, elastic_info, ori_x, const_expert_alpha_1, const_expert_alpha_2, const_expert_v, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, global_bs, comm_quant_mode, comm_alg, zero_expert_num, copy_expert_num, const_expert_num);
      at::Tensor res = op_plugin::npu_moe_distribute_combine_v2(expand_x, expert_ids, assist_info_for_combine, ep_send_counts, expert_scales, group_ep, ep_world_size, ep_rank_id, moe_expert_num, tp_send_counts, x_active_mask, expand_scales, shared_expert_x, elastic_info, ori_x, const_expert_alpha_1, const_expert_alpha_2, const_expert_v, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, global_bs, comm_quant_mode, comm_alg, zero_expert_num, copy_expert_num, const_expert_num);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper___npu_distribute_barrier(const at::Tensor & x_ref, c10::string_view group, int64_t world_size) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_distribute_barrier", x_ref, group, world_size);
      at::Tensor res = op_plugin::_npu_distribute_barrier(x_ref, group, world_size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_moe_update_expert(const at::Tensor & expert_ids, const at::Tensor & eplb_table, const ::std::optional<at::Tensor> & expert_scales, const ::std::optional<at::Tensor> & pruning_threshold, const ::std::optional<at::Tensor> & active_mask, int64_t local_rank_id, int64_t world_size, int64_t balance_mode) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, expert_ids, "wrapper__npu_moe_update_expert", "expert_ids");
  c10::impl::check_and_update_common_device(common_device, eplb_table, "wrapper__npu_moe_update_expert", "eplb_table");
  c10::impl::check_and_update_common_device(common_device, expert_scales, "wrapper__npu_moe_update_expert", "expert_scales");
  c10::impl::check_and_update_common_device(common_device, pruning_threshold, "wrapper__npu_moe_update_expert", "pruning_threshold");
  c10::impl::check_and_update_common_device(common_device, active_mask, "wrapper__npu_moe_update_expert", "active_mask");
  const c10::OptionalDeviceGuard device_guard(device_of(expert_ids));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_update_expert", expert_ids, eplb_table, expert_scales, pruning_threshold, active_mask, local_rank_id, world_size, balance_mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_moe_update_expert(expert_ids, eplb_table, expert_scales, pruning_threshold, active_mask, local_rank_id, world_size, balance_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_update_expert(expert_ids, eplb_table, expert_scales, pruning_threshold, active_mask, local_rank_id, world_size, balance_mode);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_re_routing(const at::Tensor & tokens, const at::Tensor & expert_token_num_per_rank, const ::std::optional<at::Tensor> & per_token_scales, int64_t expert_token_num_type, int64_t idx_type) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_re_routing", tokens, expert_token_num_per_rank, per_token_scales, expert_token_num_type, idx_type);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_re_routing(tokens, expert_token_num_per_rank, per_token_scales, expert_token_num_type, idx_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_moe_distribute_combine_add_rms_norm(const at::Tensor & expand_x, const at::Tensor & expert_ids, const at::Tensor & expand_idx, const at::Tensor & ep_send_counts, const at::Tensor & expert_scales, const at::Tensor & residual_x, const at::Tensor & gamma, c10::string_view group_ep, int64_t ep_world_size, int64_t ep_rank_id, int64_t moe_expert_num, const ::std::optional<at::Tensor> & tp_send_counts, const ::std::optional<at::Tensor> & x_active_mask, const ::std::optional<at::Tensor> & activation_scale, const ::std::optional<at::Tensor> & weight_scale, const ::std::optional<at::Tensor> & group_list, const ::std::optional<at::Tensor> & expand_scales, const ::std::optional<at::Tensor> & shared_expert_x, const ::std::optional<at::Tensor> & elastic_info, const ::std::optional<at::Tensor> & ori_x, const ::std::optional<at::Tensor> & const_expert_alpha_1, const ::std::optional<at::Tensor> & const_expert_alpha_2, const ::std::optional<at::Tensor> & const_expert_v, c10::string_view group_tp, int64_t tp_world_size, int64_t tp_rank_id, int64_t expert_shard_type, int64_t shared_expert_num, int64_t shared_expert_rank_num, int64_t global_bs, int64_t out_dtype, int64_t comm_quant_mode, int64_t group_list_type, c10::string_view comm_alg, double norm_eps, int64_t zero_expert_num, int64_t copy_expert_num, int64_t const_expert_num) {
  ...
  c10::impl::check_and_update_common_device(common_device, elastic_info, "wrapper__npu_moe_distribute_combine_add_rms_norm", "elastic_info");
  c10::impl::check_and_update_common_device(common_device, ori_x, "wrapper__npu_moe_distribute_combine_add_rms_norm", "ori_x");
  c10::impl::check_and_update_common_device(common_device, const_expert_alpha_1, "wrapper__npu_moe_distribute_combine_add_rms_norm", "const_expert_alpha_1");
  c10::impl::check_and_update_common_device(common_device, const_expert_alpha_2, "wrapper__npu_moe_distribute_combine_add_rms_norm", "const_expert_alpha_2");
  c10::impl::check_and_update_common_device(common_device, const_expert_v, "wrapper__npu_moe_distribute_combine_add_rms_norm", "const_expert_v");
  const c10::OptionalDeviceGuard device_guard(device_of(expand_x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_distribute_combine_add_rms_norm", expand_x, expert_ids, expand_idx, ep_send_counts, expert_scales, residual_x, gamma, group_ep, ep_world_size, ep_rank_id, moe_expert_num, tp_send_counts, x_active_mask, activation_scale, weight_scale, group_list, expand_scales, shared_expert_x, elastic_info, ori_x, const_expert_alpha_1, const_expert_alpha_2, const_expert_v, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, global_bs, out_dtype, comm_quant_mode, group_list_type, comm_alg, norm_eps, zero_expert_num, copy_expert_num, const_expert_num);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_moe_distribute_combine_add_rms_norm(expand_x, expert_ids, expand_idx, ep_send_counts, expert_scales, residual_x, gamma, group_ep, ep_world_size, ep_rank_id, moe_expert_num, tp_send_counts, x_active_mask, activation_scale, weight_scale, group_list, expand_scales, shared_expert_x, elastic_info, ori_x, const_expert_alpha_1, const_expert_alpha_2, const_expert_v, group_tp, tp_world_size, tp_rank_id, expert_shard_type, shared_expert_num, shared_expert_rank_num, global_bs, out_dtype, comm_quant_mode, group_list_type, comm_alg, norm_eps, zero_expert_num, copy_expert_num, const_expert_num);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_add_rms_norm_dynamic_quant(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & gamma, const ::std::optional<at::Tensor> & smooth_scale1, const ::std::optional<at::Tensor> & smooth_scale2, const ::std::optional<at::Tensor> & beta, double epsilon, ::std::array<bool,2> output_mask) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, x1, "wrapper__npu_add_rms_norm_dynamic_quant", "x1");
  c10::impl::check_and_update_common_device(common_device, x2, "wrapper__npu_add_rms_norm_dynamic_quant", "x2");
  c10::impl::check_and_update_common_device(common_device, gamma, "wrapper__npu_add_rms_norm_dynamic_quant", "gamma");
  c10::impl::check_and_update_common_device(common_device, smooth_scale1, "wrapper__npu_add_rms_norm_dynamic_quant", "smooth_scale1");
  c10::impl::check_and_update_common_device(common_device, smooth_scale2, "wrapper__npu_add_rms_norm_dynamic_quant", "smooth_scale2");
  c10::impl::check_and_update_common_device(common_device, beta, "wrapper__npu_add_rms_norm_dynamic_quant", "beta");
  const c10::OptionalDeviceGuard device_guard(device_of(x1));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_add_rms_norm_dynamic_quant", x1, x2, gamma, smooth_scale1, smooth_scale2, beta, epsilon, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_add_rms_norm_dynamic_quant(x1, x2, gamma, smooth_scale1, smooth_scale2, beta, epsilon, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_add_rms_norm_dynamic_quant(x1, x2, gamma, smooth_scale1, smooth_scale2, beta, epsilon, output_mask);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_attention_worker_combine(const at::Tensor & schedule_context, const at::Tensor & expert_scales, const at::Tensor & layer_id, int64_t hidden_size, int64_t token_dtype, int64_t need_schedule) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(schedule_context);
      c10_npu::check_npu_tensor_is_safe(expert_scales);
      c10_npu::check_npu_tensor_is_safe(layer_id);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, schedule_context, "wrapper__npu_attention_worker_combine", "schedule_context");
  c10::impl::check_and_update_common_device(common_device, expert_scales, "wrapper__npu_attention_worker_combine", "expert_scales");
  c10::impl::check_and_update_common_device(common_device, layer_id, "wrapper__npu_attention_worker_combine", "layer_id");
  const c10::OptionalDeviceGuard device_guard(device_of(schedule_context));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_attention_worker_combine", schedule_context, expert_scales, layer_id, hidden_size, token_dtype, need_schedule);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_attention_worker_combine(schedule_context, expert_scales, layer_id, hidden_size, token_dtype, need_schedule);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_attention_worker_combine(schedule_context, expert_scales, layer_id, hidden_size, token_dtype, need_schedule);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_multi_head_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & query_weight, const at::Tensor & key_weight, const at::Tensor & value_weight, const at::Tensor & attn_mask, const at::Tensor & out_proj_weight, const ::std::optional<at::Tensor> & query_bias, const ::std::optional<at::Tensor> & key_bias, const ::std::optional<at::Tensor> & value_bias, const ::std::optional<at::Tensor> & out_proj_bias, const ::std::optional<at::Tensor> & dropout_mask, int64_t attn_head_num, int64_t attn_dim_per_head, int64_t src_len, int64_t tgt_len, double dropout_prob, bool softmax_use_float) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_multi_head_attention", query, key, value, query_weight, key_weight, value_weight, attn_mask, out_proj_weight, query_bias, key_bias, value_bias, out_proj_bias, dropout_mask, attn_head_num, attn_dim_per_head, src_len, tgt_len, dropout_prob, softmax_use_float);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_multi_head_attention(query, key, value, query_weight, key_weight, value_weight, attn_mask, out_proj_weight, query_bias, key_bias, value_bias, out_proj_bias, dropout_mask, attn_head_num, attn_dim_per_head, src_len, tgt_len, dropout_prob, softmax_use_float);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_multi_head_attention_backward(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & query_weight, const at::Tensor & key_weight, const at::Tensor & value_weight, const at::Tensor & out_proj_weight, const ::std::optional<at::Tensor> & query_bias, const ::std::optional<at::Tensor> & key_bias, const ::std::optional<at::Tensor> & value_bias, const ::std::optional<at::Tensor> & out_proj_bias, const at::Tensor & query_res, const at::Tensor & key_res, const at::Tensor & value_res, const at::Tensor & attn_scores, const at::Tensor & attn_res, const at::Tensor & context, const at::Tensor & y_grad, const at::Tensor & dropout_mask, int64_t attn_head_num, int64_t attn_dim_per_head, int64_t src_len, int64_t tgt_len, double dropout_prob, bool softmax_use_float) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_multi_head_attention_backward", query, key, value, query_weight, key_weight, value_weight, out_proj_weight, query_bias, key_bias, value_bias, out_proj_bias, query_res, key_res, value_res, attn_scores, attn_res, context, y_grad, dropout_mask, attn_head_num, attn_dim_per_head, src_len, tgt_len, dropout_prob, softmax_use_float);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_multi_head_attention_backward(query, key, value, query_weight, key_weight, value_weight, out_proj_weight, query_bias, key_bias, value_bias, out_proj_bias, query_res, key_res, value_res, attn_scores, attn_res, context, y_grad, dropout_mask, attn_head_num, attn_dim_per_head, src_len, tgt_len, dropout_prob, softmax_use_float);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_nms_rotated(const at::Tensor & self, const at::Tensor & scores, double iou_threshold, double scores_threshold, int64_t max_output_size, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nms_rotated", self, scores, iou_threshold, scores_threshold, max_output_size, mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_nms_rotated(self, scores, iou_threshold, scores_threshold, max_output_size, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_nms_v4(const at::Tensor & self, const at::Tensor & scores, const at::Scalar & max_output_size, const at::Tensor & iou_threshold, const at::Tensor & scores_threshold, bool pad_to_max_output_size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nms_v4", self, scores, max_output_size, iou_threshold, scores_threshold, pad_to_max_output_size);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_nms_v4(self, scores, max_output_size, iou_threshold, scores_threshold, pad_to_max_output_size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_nms_with_mask(const at::Tensor & input, const at::Scalar & iou_threshold) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nms_with_mask", input, iou_threshold);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_nms_with_mask(input, iou_threshold);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_normalize_batch(const at::Tensor & self, const at::Tensor & seq_len, int64_t normalize_type) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_normalize_batch", self, seq_len, normalize_type);
      at::Tensor res = op_plugin::npu_normalize_batch(self, seq_len, normalize_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_one_hot(const at::Tensor & self, int64_t num_classes, int64_t depth, const at::Scalar & on_value, const at::Scalar & off_value) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_one_hot", self, num_classes, depth, on_value, off_value);
      at::Tensor res = op_plugin::npu_one_hot(self, num_classes, depth, on_value, off_value);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_pad(const at::Tensor & input, at::IntArrayRef paddings) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_pad", input, paddings);
      at::Tensor res = op_plugin::npu_pad(input, paddings);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_prompt_flash_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & padding_mask, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & pse_shift, at::OptionalIntArrayRef actual_seq_lengths, const ::std::optional<at::Tensor> & deq_scale1, const ::std::optional<at::Tensor> & quant_scale1, const ::std::optional<at::Tensor> & deq_scale2, const ::std::optional<at::Tensor> & quant_scale2, const ::std::optional<at::Tensor> & quant_offset2, int64_t num_heads, double scale_value, int64_t pre_tokens, int64_t next_tokens, c10::string_view input_layout, int64_t num_key_value_heads, at::OptionalIntArrayRef actual_seq_lengths_kv, int64_t sparse_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_prompt_flash_attention", query, key, value, padding_mask, atten_mask, pse_shift, actual_seq_lengths, deq_scale1, quant_scale1, deq_scale2, quant_scale2, quant_offset2, num_heads, scale_value, pre_tokens, next_tokens, input_layout, num_key_value_heads, actual_seq_lengths_kv, sparse_mode);
      at::Tensor res = op_plugin::npu_prompt_flash_attention(query, key, value, padding_mask, atten_mask, pse_shift, actual_seq_lengths, deq_scale1, quant_scale1, deq_scale2, quant_scale2, quant_offset2, num_heads, scale_value, pre_tokens, next_tokens, input_layout, num_key_value_heads, actual_seq_lengths_kv, sparse_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_ps_roi_pooling(const at::Tensor & self, const at::Tensor & rois, double spatial_scale, int64_t group_size, int64_t output_dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ps_roi_pooling", self, rois, spatial_scale, group_size, output_dim);
      at::Tensor res = op_plugin::npu_ps_roi_pooling(self, rois, spatial_scale, group_size, output_dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_ps_roi_pooling_backward(const at::Tensor & output_grad, const at::Tensor & rois, double spatial_scale, int64_t group_size, int64_t output_dim, c10::SymIntArrayRef input_size) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ps_roi_pooling_backward", output_grad, rois, spatial_scale, group_size, output_dim, input_size);
      at::Tensor res = op_plugin::npu_ps_roi_pooling_backward_symint(output_grad, rois, spatial_scale, group_size, output_dim, input_size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_ptiou(const at::Tensor & bboxes, const at::Tensor & gtboxes, int64_t mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(bboxes));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_ptiou", bboxes, gtboxes, mode);
      at::Tensor res = op_plugin::npu_ptiou(bboxes, gtboxes, mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
void wrapper__npu_prefetch(const at::Tensor & self, const ::std::optional<at::Tensor> & dependency, int64_t max_size, int64_t offset) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_prefetch", self, dependency, max_size, offset);
      op_plugin::npu_prefetch(self, dependency, max_size, offset);
...
at::Tensor wrapper__npu_quant_matmul_reduce_sum(const at::Tensor & x1, const at::Tensor & x2, const ::std::optional<at::Tensor> & x1_scale, const ::std::optional<at::Tensor> & x2_scale) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, x1, "wrapper__npu_quant_matmul_reduce_sum", "x1");
  c10::impl::check_and_update_common_device(common_device, x2, "wrapper__npu_quant_matmul_reduce_sum", "x2");
  c10::impl::check_and_update_common_device(common_device, x1_scale, "wrapper__npu_quant_matmul_reduce_sum", "x1_scale");
  c10::impl::check_and_update_common_device(common_device, x2_scale, "wrapper__npu_quant_matmul_reduce_sum", "x2_scale");
  const c10::OptionalDeviceGuard device_guard(device_of(x1));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quant_matmul_reduce_sum", x1, x2, x1_scale, x2_scale);
      at::Tensor res = op_plugin::npu_quant_matmul_reduce_sum(x1, x2, x1_scale, x2_scale);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_quant_matmul_reduce_sum(x1, x2, x1_scale, x2_scale);
}
...
at::Tensor wrapper__npu_quant_conv2d(const at::Tensor & input, const at::Tensor & weight, const at::Tensor & scale, at::IntArrayRef strides, at::IntArrayRef pads, at::IntArrayRef dilations, int64_t groups, int64_t offset_x, c10::string_view round_mode, ::std::optional<at::ScalarType> output_dtype, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & offset) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quant_conv2d", input, weight, scale, strides, pads, dilations, groups, offset_x, round_mode, output_dtype, bias, offset);
      at::Tensor res = op_plugin::npu_quant_conv2d(input, weight, scale, strides, pads, dilations, groups, offset_x, round_mode, output_dtype, bias, offset);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_quant_matmul(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & scale, const ::std::optional<at::Tensor> & offset, const ::std::optional<at::Tensor> & pertoken_scale, const ::std::optional<at::Tensor> & bias, ::std::optional<at::ScalarType> output_dtype, at::OptionalSymIntArrayRef group_sizes) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x1));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quant_matmul", x1, x2, scale, offset, pertoken_scale, bias, output_dtype, group_sizes);
      at::Tensor res = op_plugin::npu_quant_matmul_symint(x1, x2, scale, offset, pertoken_scale, bias, output_dtype, group_sizes);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_quant_matmul_dequant(const at::Tensor & x, const at::Tensor & quantized_weight, const at::Tensor & weight_scale, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & x_scale, const ::std::optional<at::Tensor> & x_offset, const ::std::optional<at::Tensor> & smooth_scale, ::std::optional<c10::string_view> quant_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quant_matmul_dequant", x, quantized_weight, weight_scale, bias, x_scale, x_offset, smooth_scale, quant_mode);
      at::Tensor res = op_plugin::npu_quant_matmul_dequant(x, quantized_weight, weight_scale, bias, x_scale, x_offset, smooth_scale, quant_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_quant_grouped_matmul_dequant(const at::Tensor & x, const at::Tensor & quantized_weight, const at::Tensor & weight_scale, const at::Tensor & group_list, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & x_scale, const ::std::optional<at::Tensor> & x_offset, const ::std::optional<at::Tensor> & smooth_scale, ::std::optional<c10::string_view> quant_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quant_grouped_matmul_dequant", x, quantized_weight, weight_scale, group_list, bias, x_scale, x_offset, smooth_scale, quant_mode);
      at::Tensor res = op_plugin::npu_quant_grouped_matmul_dequant(x, quantized_weight, weight_scale, group_list, bias, x_scale, x_offset, smooth_scale, quant_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_quant_scatter(const at::Tensor & self, const at::Tensor & indices, const at::Tensor & updates, const at::Tensor & quant_scales, const ::std::optional<at::Tensor> & quant_zero_points, int64_t axis, int64_t quant_axis, c10::string_view reduce) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quant_scatter", self, indices, updates, quant_scales, quant_zero_points, axis, quant_axis, reduce);
      at::Tensor res = op_plugin::npu_quant_scatter(self, indices, updates, quant_scales, quant_zero_points, axis, quant_axis, reduce);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__npu_quant_scatter_(at::Tensor & self, const at::Tensor & indices, const at::Tensor & updates, const at::Tensor & quant_scales, const ::std::optional<at::Tensor> & quant_zero_points, int64_t axis, int64_t quant_axis, c10::string_view reduce) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quant_scatter_", self, indices, updates, quant_scales, quant_zero_points, axis, quant_axis, reduce);
      at::Tensor & res = op_plugin::npu_quant_scatter_(self, indices, updates, quant_scales, quant_zero_points, axis, quant_axis, reduce);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_quantize(const at::Tensor & self, const at::Tensor & scales, const ::std::optional<at::Tensor> & zero_points, at::ScalarType dtype, int64_t axis, bool div_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_quantize", self, scales, zero_points, dtype, axis, div_mode);
      at::Tensor res = op_plugin::npu_quantize(self, scales, zero_points, dtype, axis, div_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_kronecker_quant(const at::Tensor & x, const at::Tensor & kronecker_p1, const at::Tensor & kronecker_p2, ::std::optional<double> clip_ratio, ::std::optional<at::ScalarType> dst_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_kronecker_quant", x, kronecker_p1, kronecker_p2, clip_ratio, dst_dtype);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_kronecker_quant(x, kronecker_p1, kronecker_p2, clip_ratio, dst_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_group_quant(const at::Tensor & x, const at::Tensor & scale, const at::Tensor & group_index, const ::std::optional<at::Tensor> & offset, ::std::optional<at::ScalarType> dst_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_group_quant", x, scale, group_index, offset, dst_dtype);
      at::Tensor res = op_plugin::npu_group_quant(x, scale, group_index, offset, dst_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_random_choice_with_mask(const at::Tensor & x, int64_t count, int64_t seed, int64_t seed2) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_random_choice_with_mask", x, count, seed, seed2);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_random_choice_with_mask(x, count, seed, seed2);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_reshape(const at::Tensor & self, at::IntArrayRef shape, bool can_refresh) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_reshape", self, shape, can_refresh);
      at::Tensor res = op_plugin::npu_reshape(self, shape, can_refresh);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_reshape_out(const at::Tensor & self, at::IntArrayRef shape, bool can_refresh, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_reshape.out", self, shape, can_refresh, out);
      at::Tensor & res = op_plugin::npu_reshape_out(self, shape, can_refresh, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_rms_norm(const at::Tensor & self, const at::Tensor & gamma, double epsilon) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rms_norm", self, gamma, epsilon);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_rms_norm(self, gamma, epsilon);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_gemma_rms_norm(const at::Tensor & self, const at::Tensor & gamma, double epsilon) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gemma_rms_norm", self, gamma, epsilon);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_gemma_rms_norm(self, gamma, epsilon);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_rms_norm_backward(const at::Tensor & dy, const at::Tensor & self, const at::Tensor & gamma, const at::Tensor & rstd) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rms_norm_backward", dy, self, gamma, rstd);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_rms_norm_backward(dy, self, gamma, rstd);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_roi_align(const at::Tensor & self, const at::Tensor & rois, double spatial_scale, int64_t pooled_height, int64_t pooled_width, int64_t sample_num, int64_t roi_end_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_roi_align", self, rois, spatial_scale, pooled_height, pooled_width, sample_num, roi_end_mode);
      at::Tensor res = op_plugin::npu_roi_align(self, rois, spatial_scale, pooled_height, pooled_width, sample_num, roi_end_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_roi_alignbk(const at::Tensor & self, const at::Tensor & rois, at::IntArrayRef xdiff_shape, int64_t pooled_width, int64_t pooled_height, double spatial_scale, int64_t sample_num, ::std::optional<int64_t> roi_end_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_roi_alignbk", self, rois, xdiff_shape, pooled_width, pooled_height, spatial_scale, sample_num, roi_end_mode);
      at::Tensor res = op_plugin::npu_roi_alignbk(self, rois, xdiff_shape, pooled_width, pooled_height, spatial_scale, sample_num, roi_end_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_rotary_mul(const at::Tensor & self, const at::Tensor & r1, const at::Tensor & r2, c10::string_view rotary_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rotary_mul", self, r1, r2, rotary_mode);
      at::Tensor res = op_plugin::npu_rotary_mul(self, r1, r2, rotary_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_rotary_mul_backward(const at::Tensor & grad, const at::Tensor & self, const at::Tensor & r1, const at::Tensor & r2, c10::string_view rotary_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rotary_mul_backward", grad, self, r1, r2, rotary_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_rotary_mul_backward(grad, self, r1, r2, rotary_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_mrope(const at::Tensor & positions, const at::Tensor & query, const at::Tensor & key, const at::Tensor & cos_sin_cache, int64_t head_size, at::OptionalIntArrayRef mrope_section, ::std::optional<c10::string_view> rotary_mode) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_mrope", positions, query, key, cos_sin_cache, head_size, mrope_section, rotary_mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_mrope(positions, query, key, cos_sin_cache, head_size, mrope_section, rotary_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_rotated_box_decode(const at::Tensor & self, const at::Tensor & deltas, const at::Tensor & weight) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rotated_box_decode", self, deltas, weight);
      at::Tensor res = op_plugin::npu_rotated_box_decode(self, deltas, weight);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_rotated_box_encode(const at::Tensor & self, const at::Tensor & gt_bboxes, const at::Tensor & weight) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rotated_box_encode", self, gt_bboxes, weight);
      at::Tensor res = op_plugin::npu_rotated_box_encode(self, gt_bboxes, weight);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_rotated_iou(const at::Tensor & self, const at::Tensor & query_boxes, bool trans, int64_t mode, bool is_cross, double v_threshold, double e_threshold) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rotated_iou", self, query_boxes, trans, mode, is_cross, v_threshold, e_threshold);
      at::Tensor res = op_plugin::npu_rotated_iou(self, query_boxes, trans, mode, is_cross, v_threshold, e_threshold);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_rotated_overlaps(const at::Tensor & self, const at::Tensor & query_boxes, bool trans) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rotated_overlaps", self, query_boxes, trans);
      at::Tensor res = op_plugin::npu_rotated_overlaps(self, query_boxes, trans);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_scaled_masked_softmax(const at::Tensor & x, const at::Tensor & mask, const at::Scalar & scale, bool fixed_triu_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scaled_masked_softmax", x, mask, scale, fixed_triu_mask);
      at::Tensor res = op_plugin::npu_scaled_masked_softmax(x, mask, scale, fixed_triu_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_scaled_masked_softmax_backward(const at::Tensor & y_grad, const at::Tensor & y, const at::Tensor & mask, const at::Scalar & scale, bool fixed_triu_mask) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scaled_masked_softmax_backward", y_grad, y, mask, scale, fixed_triu_mask);
      at::Tensor res = op_plugin::npu_scaled_masked_softmax_backward(y_grad, y, mask, scale, fixed_triu_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_scatter(const at::Tensor & self, const at::Tensor & indices, const at::Tensor & updates, int64_t dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scatter", self, indices, updates, dim);
      at::Tensor res = op_plugin::npu_scatter(self, indices, updates, dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::vector<at::Tensor> wrapper__npu_scatter_list(at::TensorList self, const at::Tensor & indices, const at::Tensor & updates, const ::std::optional<at::Tensor> & mask, c10::string_view reduce, int64_t axis) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scatter_list", self, indices, updates, mask, reduce, axis);
      ::std::vector<at::Tensor> res = op_plugin::npu_scatter_list(self, indices, updates, mask, reduce, axis);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
void wrapper__npu_scatter_list_(at::TensorList self, const at::Tensor & indices, const at::Tensor & updates, const ::std::optional<at::Tensor> & mask, c10::string_view reduce, int64_t axis) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scatter_list_", self, indices, updates, mask, reduce, axis);
      op_plugin::npu_scatter_list_(self, indices, updates, mask, reduce, axis);
      at_npu::native::OpHook::GetInstance().PostHook();
      return;
  }
...
at::Tensor wrapper__npu_scatter_nd_update(const at::Tensor & self, const at::Tensor & indices, const at::Tensor & updates) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scatter_nd_update", self, indices, updates);
      at::Tensor res = op_plugin::npu_scatter_nd_update(self, indices, updates);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__npu_scatter_nd_update_(at::Tensor & self, const at::Tensor & indices, const at::Tensor & updates) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scatter_nd_update_", self, indices, updates);
      at::Tensor & res = op_plugin::npu_scatter_nd_update_(self, indices, updates);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_scatter_pa_kv_cache_functional(const at::Tensor & key, const at::Tensor & value, const at::Tensor & key_cache, const at::Tensor & value_cache, const at::Tensor & slot_mapping, const ::std::optional<at::Tensor> & compress_lens, const ::std::optional<at::Tensor> & compress_seq_offsets, const ::std::optional<at::Tensor> & seq_lens) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(key);
      c10_npu::check_npu_tensor_is_safe(value);
      c10_npu::check_npu_tensor_is_safe(key_cache);
      c10_npu::check_npu_tensor_is_safe(value_cache);
      c10_npu::check_npu_tensor_is_safe(slot_mapping);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, key, "wrapper__npu_scatter_pa_kv_cache_functional", "key");
  c10::impl::check_and_update_common_device(common_device, value, "wrapper__npu_scatter_pa_kv_cache_functional", "value");
  c10::impl::check_and_update_common_device(common_device, key_cache, "wrapper__npu_scatter_pa_kv_cache_functional", "key_cache");
  c10::impl::check_and_update_common_device(common_device, value_cache, "wrapper__npu_scatter_pa_kv_cache_functional", "value_cache");
  c10::impl::check_and_update_common_device(common_device, slot_mapping, "wrapper__npu_scatter_pa_kv_cache_functional", "slot_mapping");
  c10::impl::check_and_update_common_device(common_device, compress_lens, "wrapper__npu_scatter_pa_kv_cache_functional", "compress_lens");
  c10::impl::check_and_update_common_device(common_device, compress_seq_offsets, "wrapper__npu_scatter_pa_kv_cache_functional", "compress_seq_offsets");
  c10::impl::check_and_update_common_device(common_device, seq_lens, "wrapper__npu_scatter_pa_kv_cache_functional", "seq_lens");
  const c10::OptionalDeviceGuard device_guard(device_of(key));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scatter_pa_kv_cache_functional", key, value, key_cache, value_cache, slot_mapping, compress_lens, compress_seq_offsets, seq_lens);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_scatter_pa_kv_cache_functional(key, value, key_cache, value_cache, slot_mapping, compress_lens, compress_seq_offsets, seq_lens);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_scatter_pa_kv_cache_functional(key, value, key_cache, value_cache, slot_mapping, compress_lens, compress_seq_offsets, seq_lens);
}

void wrapper__npu_scatter_pa_kv_cache(const at::Tensor & key, const at::Tensor & value, at::Tensor & key_cache, at::Tensor & value_cache, const at::Tensor & slot_mapping, const ::std::optional<at::Tensor> & compress_lens, const ::std::optional<at::Tensor> & compress_seq_offsets, const ::std::optional<at::Tensor> & seq_lens) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, key, "wrapper__npu_scatter_pa_kv_cache", "key");
  c10::impl::check_and_update_common_device(common_device, value, "wrapper__npu_scatter_pa_kv_cache", "value");
  c10::impl::check_and_update_common_device(common_device, key_cache, "wrapper__npu_scatter_pa_kv_cache", "key_cache");
  c10::impl::check_and_update_common_device(common_device, value_cache, "wrapper__npu_scatter_pa_kv_cache", "value_cache");
  c10::impl::check_and_update_common_device(common_device, slot_mapping, "wrapper__npu_scatter_pa_kv_cache", "slot_mapping");
  c10::impl::check_and_update_common_device(common_device, compress_lens, "wrapper__npu_scatter_pa_kv_cache", "compress_lens");
  c10::impl::check_and_update_common_device(common_device, compress_seq_offsets, "wrapper__npu_scatter_pa_kv_cache", "compress_seq_offsets");
  c10::impl::check_and_update_common_device(common_device, seq_lens, "wrapper__npu_scatter_pa_kv_cache", "seq_lens");
  const c10::OptionalDeviceGuard device_guard(device_of(key));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_scatter_pa_kv_cache", key, value, key_cache, value_cache, slot_mapping, compress_lens, compress_seq_offsets, seq_lens);
      op_plugin::npu_scatter_pa_kv_cache(key, value, key_cache, value_cache, slot_mapping, compress_lens, compress_seq_offsets, seq_lens);
      at_npu::native::OpHook::GetInstance().PostHook();
      return;
  }
  return op_plugin::npu_scatter_pa_kv_cache(key, value, key_cache, value_cache, slot_mapping, compress_lens, compress_seq_offsets, seq_lens);
}
...
at::Tensor wrapper__npu_sign_bits_pack(const at::Tensor & self, int64_t size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_sign_bits_pack", self, size);
      at::Tensor res = op_plugin::npu_sign_bits_pack(self, size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_sign_bits_unpack(const at::Tensor & input, int64_t size, at::ScalarType dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_sign_bits_unpack", input, size, dtype);
      at::Tensor res = op_plugin::npu_sign_bits_unpack(input, size, dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_silu(const at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_silu", self);
      at::Tensor res = op_plugin::npu_silu(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__npu_silu_(at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_silu_", self);
      at::Tensor & res = op_plugin::npu_silu_(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_silu_backward(const at::Tensor & grad_output, const at::Tensor & x0, const at::Tensor & x1) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad_output));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_silu_backward", grad_output, x0, x1);
      at::Tensor res = op_plugin::npu_silu_backward(grad_output, x0, x1);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_slice(const at::Tensor & self, at::IntArrayRef offsets, at::IntArrayRef size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_slice", self, offsets, size);
      at::Tensor res = op_plugin::npu_slice(self, offsets, size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_slice_out(const at::Tensor & self, at::IntArrayRef offsets, at::IntArrayRef size, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_slice.out", self, offsets, size, out);
      at::Tensor & res = op_plugin::npu_slice_out(self, offsets, size, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_softmax_cross_entropy_with_logits(const at::Tensor & self, const at::Tensor & labels) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_softmax_cross_entropy_with_logits", self, labels);
      at::Tensor res = op_plugin::npu_softmax_cross_entropy_with_logits(self, labels);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_softmax_cross_entropy_with_logits_backward(const at::Tensor & grad, const at::Tensor & self, const at::Tensor & labels) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_softmax_cross_entropy_with_logits_backward", grad, self, labels);
      at::Tensor res = op_plugin::npu_softmax_cross_entropy_with_logits_backward(grad, self, labels);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_sort_v2(const at::Tensor & self, int64_t dim, bool descending) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_sort_v2", self, dim, descending);
      at::Tensor res = op_plugin::npu_sort_v2(self, dim, descending);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_sort_v2_out(const at::Tensor & self, int64_t dim, bool descending, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_sort_v2.out", self, dim, descending, out);
      at::Tensor & res = op_plugin::npu_sort_v2_out(self, dim, descending, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_stride_add(const at::Tensor & self, const at::Tensor & other, const at::Scalar & offset1, const at::Scalar & offset2, const at::Scalar & c1_len) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_stride_add", self, other, offset1, offset2, c1_len);
      at::Tensor res = op_plugin::npu_stride_add(self, other, offset1, offset2, c1_len);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_stride_copy(const at::Tensor & self, at::IntArrayRef shape, at::IntArrayRef stride, const at::Scalar & storage_offset) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_stride_copy", self, shape, stride, storage_offset);
      at::Tensor res = op_plugin::npu_stride_copy(self, shape, stride, storage_offset);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_stride_copy_out(const at::Tensor & self, at::IntArrayRef shape, at::IntArrayRef stride, const at::Scalar & storage_offset, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_stride_copy.out", self, shape, stride, storage_offset, out);
      at::Tensor & res = op_plugin::npu_stride_copy_out(self, shape, stride, storage_offset, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_sub_sample(const at::Tensor & self, int64_t per_images, double positive_fraction) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_sub_sample", self, per_images, positive_fraction);
      at::Tensor res = op_plugin::npu_sub_sample(self, per_images, positive_fraction);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_swiglu(const at::Tensor & self, int64_t dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_swiglu", self, dim);
      at::Tensor res = op_plugin::npu_swiglu(self, dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_swiglu_backward(const at::Tensor & grad_output, const at::Tensor & self, int64_t dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_swiglu_backward", grad_output, self, dim);
      at::Tensor res = op_plugin::npu_swiglu_backward(grad_output, self, dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_swiglu_quant(const at::Tensor & x, const ::std::optional<at::Tensor> & smooth_scales, const ::std::optional<at::Tensor> & offsets, const ::std::optional<at::Tensor> & group_index, bool activate_left, int64_t quant_mode, int64_t group_list_type, ::std::optional<at::ScalarType> dst_type) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, x, "wrapper__npu_swiglu_quant", "x");
  c10::impl::check_and_update_common_device(common_device, smooth_scales, "wrapper__npu_swiglu_quant", "smooth_scales");
  c10::impl::check_and_update_common_device(common_device, offsets, "wrapper__npu_swiglu_quant", "offsets");
  c10::impl::check_and_update_common_device(common_device, group_index, "wrapper__npu_swiglu_quant", "group_index");
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_swiglu_quant", x, smooth_scales, offsets, group_index, activate_left, quant_mode, group_list_type, dst_type);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_swiglu_quant(x, smooth_scales, offsets, group_index, activate_left, quant_mode, group_list_type, dst_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_swiglu_quant(x, smooth_scales, offsets, group_index, activate_left, quant_mode, group_list_type, dst_type);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_dequant_swiglu_quant(const at::Tensor & x, const ::std::optional<at::Tensor> & weight_scale, const ::std::optional<at::Tensor> & activation_scale, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & quant_scale, const ::std::optional<at::Tensor> & quant_offset, const ::std::optional<at::Tensor> & group_index, bool activate_left, int64_t quant_mode, int64_t swiglu_mode, double clamp_limit, double glu_alpha, double glu_bias) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dequant_swiglu_quant", x, weight_scale, activation_scale, bias, quant_scale, quant_offset, group_index, activate_left, quant_mode, swiglu_mode, clamp_limit, glu_alpha, glu_bias);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_dequant_swiglu_quant(x, weight_scale, activation_scale, bias, quant_scale, quant_offset, group_index, activate_left, quant_mode, swiglu_mode, clamp_limit, glu_alpha, glu_bias);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_dequant_swiglu_quant(x, weight_scale, activation_scale, bias, quant_scale, quant_offset, group_index, activate_left, quant_mode, swiglu_mode, clamp_limit, glu_alpha, glu_bias);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_dequant_rope_quant_kvcache(const at::Tensor & x, const at::Tensor & cos, const at::Tensor & sin, const at::Tensor & k_cache, const at::Tensor & v_cache, const at::Tensor & indices, const at::Tensor & scale_k, const at::Tensor & scale_v, at::IntArrayRef size_splits, const ::std::optional<at::Tensor> & offset_k, const ::std::optional<at::Tensor> & offset_v, const ::std::optional<at::Tensor> & weight_scale, const ::std::optional<at::Tensor> & activation_scale, const ::std::optional<at::Tensor> & bias, int64_t quant_mode, c10::string_view input_layout, bool kv_output, c10::string_view cache_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dequant_rope_quant_kvcache", x, cos, sin, k_cache, v_cache, indices, scale_k, scale_v, size_splits, offset_k, offset_v, weight_scale, activation_scale, bias, quant_mode, input_layout, kv_output, cache_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_dequant_rope_quant_kvcache(x, cos, sin, k_cache, v_cache, indices, scale_k, scale_v, size_splits, offset_k, offset_v, weight_scale, activation_scale, bias, quant_mode, input_layout, kv_output, cache_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_rope_quant_kvcache(const at::Tensor & x, const at::Tensor & cos, const at::Tensor & sin, const at::Tensor & k_cache, const at::Tensor & v_cache, const at::Tensor & indices, const at::Tensor & scale_k, const at::Tensor & scale_v, at::IntArrayRef size_splits, const ::std::optional<at::Tensor> & offset_k, const ::std::optional<at::Tensor> & offset_v, int64_t quant_mode, c10::string_view input_layout, bool kv_output, c10::string_view cache_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_rope_quant_kvcache", x, cos, sin, k_cache, v_cache, indices, scale_k, scale_v, size_splits, offset_k, offset_v, quant_mode, input_layout, kv_output, cache_mode);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_rope_quant_kvcache(x, cos, sin, k_cache, v_cache, indices, scale_k, scale_v, size_splits, offset_k, offset_v, quant_mode, input_layout, kv_output, cache_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_dequant_bias(const at::Tensor & x, const at::Tensor & weight_scale, const ::std::optional<at::Tensor> & activation_scale, const ::std::optional<at::Tensor> & bias, ::std::optional<at::ScalarType> output_dtype) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dequant_bias", x, weight_scale, activation_scale, bias, output_dtype);
      at::Tensor res = op_plugin::npu_dequant_bias(x, weight_scale, activation_scale, bias, output_dtype);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_trans_quant_param(const at::Tensor & scale, const ::std::optional<at::Tensor> & offset, ::std::optional<int64_t> round_mode) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_trans_quant_param", scale, offset, round_mode);
      at::Tensor res = op_plugin::npu_trans_quant_param(scale, offset, round_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_transpose(const at::Tensor & self, at::IntArrayRef perm, bool require_contiguous) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_transpose", self, perm, require_contiguous);
      at::Tensor res = op_plugin::npu_transpose(self, perm, require_contiguous);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_out_npu_transpose_out(const at::Tensor & self, at::IntArrayRef perm, bool require_contiguous, at::Tensor & out) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_transpose.out", self, perm, require_contiguous, out);
      at::Tensor & res = op_plugin::npu_transpose_out(self, perm, require_contiguous, out);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__npu_view_copy(at::Tensor & self, const at::Tensor & other, bool non_blocking) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_view_copy", self, other, non_blocking);
      at::Tensor & res = op_plugin::npu_view_copy(self, other, non_blocking);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_weight_quant_batchmatmul(const at::Tensor & x, const at::Tensor & weight, const at::Tensor & antiquant_scale, const ::std::optional<at::Tensor> & antiquant_offset, const ::std::optional<at::Tensor> & quant_scale, const ::std::optional<at::Tensor> & quant_offset, const ::std::optional<at::Tensor> & bias, int64_t antiquant_group_size, int64_t inner_precise) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_weight_quant_batchmatmul", x, weight, antiquant_scale, antiquant_offset, quant_scale, quant_offset, bias, antiquant_group_size, inner_precise);
      at::Tensor res = op_plugin::npu_weight_quant_batchmatmul(x, weight, antiquant_scale, antiquant_offset, quant_scale, quant_offset, bias, antiquant_group_size, inner_precise);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_transpose_batchmatmul(const at::Tensor & input, const at::Tensor & weight, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & scale, at::OptionalIntArrayRef perm_x1, at::OptionalIntArrayRef perm_x2, at::OptionalIntArrayRef perm_y, ::std::optional<int64_t> batch_split_factor) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_transpose_batchmatmul", input, weight, bias, scale, perm_x1, perm_x2, perm_y, batch_split_factor);
      at::Tensor res = op_plugin::npu_transpose_batchmatmul(input, weight, bias, scale, perm_x1, perm_x2, perm_y, batch_split_factor);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_yolo_boxes_encode(const at::Tensor & self, const at::Tensor & gt_bboxes, const at::Tensor & stride, bool performance_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_yolo_boxes_encode", self, gt_bboxes, stride, performance_mode);
      at::Tensor res = op_plugin::npu_yolo_boxes_encode(self, gt_bboxes, stride, performance_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__obfuscation_initialize(int64_t hidden_size, int64_t tp_rank, int64_t cmd, ::std::optional<at::ScalarType> data_type, ::std::optional<int64_t> model_obf_seed_id, ::std::optional<int64_t> data_obf_seed_id, ::std::optional<int64_t> thread_num, ::std::optional<double> obf_coefficient) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("obfuscation_initialize", hidden_size, tp_rank, cmd, data_type, model_obf_seed_id, data_obf_seed_id, thread_num, obf_coefficient);
      at::Tensor res = op_plugin::obfuscation_initialize(hidden_size, tp_rank, cmd, data_type, model_obf_seed_id, data_obf_seed_id, thread_num, obf_coefficient);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::obfuscation_initialize(hidden_size, tp_rank, cmd, data_type, model_obf_seed_id, data_obf_seed_id, thread_num, obf_coefficient);
}

at::Tensor wrapper__obfuscation_finalize(const at::Tensor & fd_to_close) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(fd_to_close);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, fd_to_close, "wrapper__obfuscation_finalize", "fd_to_close");
  const c10::OptionalDeviceGuard device_guard(device_of(fd_to_close));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("obfuscation_finalize", fd_to_close);
      at::Tensor res = op_plugin::obfuscation_finalize(fd_to_close);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::obfuscation_finalize(fd_to_close);
}

at::Tensor wrapper__obfuscation_calculate(const at::Tensor & fd, const at::Tensor & x, const at::Tensor & param, ::std::optional<double> obf_coefficient) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(fd);
      c10_npu::check_npu_tensor_is_safe(x);
      c10_npu::check_npu_tensor_is_safe(param);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, fd, "wrapper__obfuscation_calculate", "fd");
  c10::impl::check_and_update_common_device(common_device, x, "wrapper__obfuscation_calculate", "x");
  c10::impl::check_and_update_common_device(common_device, param, "wrapper__obfuscation_calculate", "param");
  const c10::OptionalDeviceGuard device_guard(device_of(fd));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("obfuscation_calculate", fd, x, param, obf_coefficient);
      at::Tensor res = op_plugin::obfuscation_calculate(fd, x, param, obf_coefficient);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::obfuscation_calculate(fd, x, param, obf_coefficient);
}
...
at::Tensor & wrapper__one_(at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("one_", self);
      at::Tensor & res = op_plugin::one_(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__repeat_interleave_backward_int(const at::Tensor & grad, const at::Tensor & self, c10::SymInt repeats, ::std::optional<int64_t> dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("repeat_interleave_backward_int", grad, self, repeats, dim);
      at::Tensor res = op_plugin::repeat_interleave_backward_int_symint(grad, self, repeats, dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__repeat_interleave_backward_tensor(const at::Tensor & grad, const at::Tensor & self, const at::Tensor & repeats, ::std::optional<int64_t> dim) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("repeat_interleave_backward_tensor", grad, self, repeats, dim);
      at::Tensor res = op_plugin::repeat_interleave_backward_tensor(grad, self, repeats, dim);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__scatter_update(const at::Tensor & self, const at::Tensor & indices, const at::Tensor & updates, int64_t axis) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("scatter_update", self, indices, updates, axis);
      at::Tensor res = op_plugin::scatter_update(self, indices, updates, axis);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__scatter_update_(at::Tensor & self, const at::Tensor & indices, const at::Tensor & updates, int64_t axis) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("scatter_update_", self, indices, updates, axis);
      at::Tensor & res = op_plugin::scatter_update_(self, indices, updates, axis);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__slow_conv_transpose2d_backward(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & weight, at::IntArrayRef kernel_size, at::IntArrayRef stride, at::IntArrayRef padding, at::IntArrayRef output_padding, at::IntArrayRef dilation, ::std::array<bool,3> output_mask) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("slow_conv_transpose2d_backward", grad_output, self, weight, kernel_size, stride, padding, output_padding, dilation, output_mask);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::slow_conv_transpose2d_backward(grad_output, self, weight, kernel_size, stride, padding, output_padding, dilation, output_mask);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__stft_backward(const at::Tensor & grad_output, const at::Tensor & self, int64_t n_fft, ::std::optional<int64_t> hop_length, ::std::optional<int64_t> win_length, const ::std::optional<at::Tensor> & window, bool normalized, ::std::optional<bool> onesided, ::std::optional<bool> return_complex) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("stft_backward", grad_output, self, n_fft, hop_length, win_length, window, normalized, onesided, return_complex);
      at::Tensor res = op_plugin::stft_backward(grad_output, self, n_fft, hop_length, win_length, window, normalized, onesided, return_complex);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__fft_r2c_backward(const at::Tensor & grad, at::IntArrayRef dim, int64_t normalization, bool onesided, int64_t last_dim_size) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("fft_r2c_backward", grad, dim, normalization, onesided, last_dim_size);
      at::Tensor res = op_plugin::fft_r2c_backward(grad, dim, normalization, onesided, last_dim_size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__fft_c2r_backward(const at::Tensor & grad, at::IntArrayRef dim, int64_t normalization) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("fft_c2r_backward", grad, dim, normalization);
      at::Tensor res = op_plugin::fft_c2r_backward(grad, dim, normalization);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_cross_entropy_loss(const at::Tensor & input, const at::Tensor & target, const ::std::optional<at::Tensor> & weight, c10::string_view reduction, int64_t ignore_index, double label_smoothing, double lse_square_scale_for_zloss, bool return_zloss) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_cross_entropy_loss", input, target, weight, reduction, ignore_index, label_smoothing, lse_square_scale_for_zloss, return_zloss);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_cross_entropy_loss(input, target, weight, reduction, ignore_index, label_smoothing, lse_square_scale_for_zloss, return_zloss);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_cross_entropy_loss_backward(const at::Tensor & grad_loss, const at::Tensor & log_prob, const at::Tensor & target, const ::std::optional<at::Tensor> & weight, const ::std::optional<at::Tensor> & grad_zloss, const ::std::optional<at::Tensor> & lse_for_zloss, c10::string_view reduction, int64_t ignore_index, double label_smoothing, double lse_square_scale_for_zloss) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_cross_entropy_loss_backward", grad_loss, log_prob, target, weight, grad_zloss, lse_for_zloss, reduction, ignore_index, label_smoothing, lse_square_scale_for_zloss);
      at::Tensor res = op_plugin::npu_cross_entropy_loss_backward(grad_loss, log_prob, target, weight, grad_zloss, lse_for_zloss, reduction, ignore_index, label_smoothing, lse_square_scale_for_zloss);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_group_norm_swish(const at::Tensor & input, int64_t num_groups, const at::Tensor & weight, const at::Tensor & bias, ::std::optional<double> eps, ::std::optional<double> swish_scale) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_group_norm_swish", input, num_groups, weight, bias, eps, swish_scale);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_group_norm_swish(input, num_groups, weight, bias, eps, swish_scale);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_group_norm_swish_grad(const at::Tensor & grad, const at::Tensor & input, int64_t num_groups, const at::Tensor & weight, const at::Tensor & bias, const at::Tensor & mean, const at::Tensor & rstd, ::std::array<bool,3> grad_input_mask, ::std::optional<double> swish_scale) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_group_norm_swish_grad", grad, input, num_groups, weight, bias, mean, rstd, grad_input_mask, swish_scale);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_group_norm_swish_grad(grad, input, num_groups, weight, bias, mean, rstd, grad_input_mask, swish_scale);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
void wrapper__npu_advance_step_flashattn(at::Tensor & input_tokens, const at::Tensor & sampled_token_ids, at::Tensor & input_positions, at::Tensor & seq_lens, at::Tensor & slot_mapping, const at::Tensor & block_tables, int64_t num_seqs, int64_t num_queries, int64_t block_size, const ::std::optional<at::Tensor> & spec_token, const ::std::optional<at::Tensor> & accepted_num) {
  ...
  c10::impl::check_and_update_common_device(common_device, spec_token, "wrapper__npu_advance_step_flashattn", "spec_token");
  c10::impl::check_and_update_common_device(common_device, accepted_num, "wrapper__npu_advance_step_flashattn", "accepted_num");
  const c10::OptionalDeviceGuard device_guard(device_of(input_tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_advance_step_flashattn", input_tokens, sampled_token_ids, input_positions, seq_lens, slot_mapping, block_tables, num_seqs, num_queries, block_size, spec_token, accepted_num);
      op_plugin::npu_advance_step_flashattn(input_tokens, sampled_token_ids, input_positions, seq_lens, slot_mapping, block_tables, num_seqs, num_queries, block_size, spec_token, accepted_num);
      at_npu::native::OpHook::GetInstance().PostHook();
      return;
  }
  return op_plugin::npu_advance_step_flashattn(input_tokens, sampled_token_ids, input_positions, seq_lens, slot_mapping, block_tables, num_seqs, num_queries, block_size, spec_token, accepted_num);
}
...
at::Tensor & wrapper__npu_grouped_matmul_add_(at::Tensor & self, const at::Tensor & x, const at::Tensor & weight, const at::Tensor & group_list, bool transpose_x, bool transpose_weight, int64_t group_type) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_grouped_matmul_add_", self, x, weight, group_list, transpose_x, transpose_weight, group_type);
      at::Tensor & res = op_plugin::npu_grouped_matmul_add_(self, x, weight, group_list, transpose_x, transpose_weight, group_type);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__npu_attn_softmax_(at::Tensor & self) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_attn_softmax_", self);
      at::Tensor & res = op_plugin::npu_attn_softmax_(self);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper__npu_attn_softmax_backward_(at::Tensor & self, const at::Tensor & grad_output, const at::Tensor & values) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_attn_softmax_backward_", self, grad_output, values);
      at::Tensor & res = op_plugin::npu_attn_softmax_backward_(self, grad_output, values);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_gather_sparse_index(const at::Tensor & input, const at::Tensor & index) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gather_sparse_index", input, index);
      at::Tensor res = op_plugin::npu_gather_sparse_index(input, index);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_gather_sparse_index_backward(const at::Tensor & grad, c10::SymIntArrayRef self_sizes, const at::Tensor & index) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, grad, "wrapper__npu_gather_sparse_index_backward", "grad");
  c10::impl::check_and_update_common_device(common_device, index, "wrapper__npu_gather_sparse_index_backward", "index");
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_gather_sparse_index_backward", grad, self_sizes, index);
      at::Tensor res = op_plugin::npu_gather_sparse_index_backward_symint(grad, self_sizes, index);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_gather_sparse_index_backward_symint(grad, self_sizes, index);
}

at::Tensor wrapper___npu_index_add(const at::Tensor & self, const at::Tensor & index, const at::Tensor & source, const at::Scalar & alpha) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(self);
      c10_npu::check_npu_tensor_is_safe(self);
      c10_npu::check_npu_tensor_is_safe(index);
      c10_npu::check_npu_tensor_is_safe(source);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, self, "wrapper___npu_index_add", "self");
  c10::impl::check_and_update_common_device(common_device, index, "wrapper___npu_index_add", "index");
  c10::impl::check_and_update_common_device(common_device, source, "wrapper___npu_index_add", "source");
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_index_add", self, index, source, alpha);
      at::Tensor res = op_plugin::_npu_index_add(self, index, source, alpha);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_npu_index_add(self, index, source, alpha);
}

at::Tensor & wrapper___npu_index_add_(at::Tensor & self, const at::Tensor & index, const at::Tensor & source, const at::Scalar & alpha) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, self, "wrapper___npu_index_add_", "self");
  c10::impl::check_and_update_common_device(common_device, index, "wrapper___npu_index_add_", "index");
  c10::impl::check_and_update_common_device(common_device, source, "wrapper___npu_index_add_", "source");
  const c10::OptionalDeviceGuard device_guard(device_of(self));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_index_add_", self, index, source, alpha);
      at::Tensor & res = op_plugin::_npu_index_add_(self, index, source, alpha);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_npu_index_add_(self, index, source, alpha);
}
...
at::Tensor wrapper__npu_nsa_compress(const at::Tensor & input, const at::Tensor & weight, int64_t compress_block_size, int64_t compress_stride, at::OptionalIntArrayRef actual_seq_len) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_compress", input, weight, compress_block_size, compress_stride, actual_seq_len);
      at::Tensor res = op_plugin::npu_nsa_compress(input, weight, compress_block_size, compress_stride, actual_seq_len);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_nsa_compress_grad(const at::Tensor & grad, const at::Tensor & input, const at::Tensor & weight, int64_t compress_block_size, int64_t compress_stride, at::OptionalIntArrayRef actual_seq_len) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_compress_grad", grad, input, weight, compress_block_size, compress_stride, actual_seq_len);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_nsa_compress_grad(grad, input, weight, compress_block_size, compress_stride, actual_seq_len);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor & wrapper_cache_npu_nsa_compress_infer_out(const at::Tensor & input, const at::Tensor & weight, const at::Tensor & slot_mapping, int64_t compress_block_size, int64_t compress_stride, int64_t page_block_size, const ::std::optional<at::Tensor> & block_table, at::OptionalIntArrayRef actual_seq_len, at::Tensor & cache) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_compress_infer.cache", input, weight, slot_mapping, compress_block_size, compress_stride, page_block_size, block_table, actual_seq_len, cache);
      at::Tensor & res = op_plugin::npu_nsa_compress_infer_out(input, weight, slot_mapping, compress_block_size, compress_stride, page_block_size, block_table, actual_seq_len, cache);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_nsa_compress_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, double scale_value, int64_t head_num, int64_t compress_block_size, int64_t compress_stride, int64_t select_block_size, int64_t select_block_count, const ::std::optional<at::Tensor> & topk_mask, const ::std::optional<at::Tensor> & atten_mask, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_cmp_seq_kvlen, at::OptionalIntArrayRef actual_sel_seq_kvlen) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_compress_attention", query, key, value, scale_value, head_num, compress_block_size, compress_stride, select_block_size, select_block_count, topk_mask, atten_mask, actual_seq_qlen, actual_cmp_seq_kvlen, actual_sel_seq_kvlen);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_nsa_compress_attention(query, key, value, scale_value, head_num, compress_block_size, compress_stride, select_block_size, select_block_count, topk_mask, atten_mask, actual_seq_qlen, actual_cmp_seq_kvlen, actual_sel_seq_kvlen);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_nsa_compress_attention_infer(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, double scale_value, int64_t head_num, int64_t key_value_head_num, int64_t select_block_size, int64_t select_block_count, int64_t page_block_size, int64_t compress_block_size, int64_t compress_stride, c10::string_view layout, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & block_table, const ::std::optional<at::Tensor> & topk_mask, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_cmp_seq_kvlen, at::OptionalIntArrayRef actual_sel_seq_kvlen) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_compress_attention_infer", query, key, value, scale_value, head_num, key_value_head_num, select_block_size, select_block_count, page_block_size, compress_block_size, compress_stride, layout, atten_mask, block_table, topk_mask, actual_seq_qlen, actual_cmp_seq_kvlen, actual_sel_seq_kvlen);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_nsa_compress_attention_infer(query, key, value, scale_value, head_num, key_value_head_num, select_block_size, select_block_count, page_block_size, compress_block_size, compress_stride, layout, atten_mask, block_table, topk_mask, actual_seq_qlen, actual_cmp_seq_kvlen, actual_sel_seq_kvlen);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_nsa_compress_attention_infer(query, key, value, scale_value, head_num, key_value_head_num, select_block_size, select_block_count, page_block_size, compress_block_size, compress_stride, layout, atten_mask, block_table, topk_mask, actual_seq_qlen, actual_cmp_seq_kvlen, actual_sel_seq_kvlen);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_nsa_select_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & topk_indices, double scale_value, int64_t head_num, int64_t select_block_size, int64_t select_block_count, const ::std::optional<at::Tensor> & atten_mask, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_select_attention", query, key, value, topk_indices, scale_value, head_num, select_block_size, select_block_count, atten_mask, actual_seq_qlen, actual_seq_kvlen);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_nsa_select_attention(query, key, value, topk_indices, scale_value, head_num, select_block_size, select_block_count, atten_mask, actual_seq_qlen, actual_seq_kvlen);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> wrapper__npu_nsa_select_attention_grad(const at::Tensor & grad, const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & attention_out, const at::Tensor & softmax_max, const at::Tensor & softmax_sum, const at::Tensor & topk_indices, double scale_value, int64_t head_num, int64_t select_block_size, int64_t select_block_count, const ::std::optional<at::Tensor> & atten_mask, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_select_attention_grad", grad, query, key, value, attention_out, softmax_max, softmax_sum, topk_indices, scale_value, head_num, select_block_size, select_block_count, atten_mask, actual_seq_qlen, actual_seq_kvlen);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_nsa_select_attention_grad(grad, query, key, value, attention_out, softmax_max, softmax_sum, topk_indices, scale_value, head_num, select_block_size, select_block_count, atten_mask, actual_seq_qlen, actual_seq_kvlen);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_nsa_select_attention_infer(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const at::Tensor & topk_indices, double scale_value, int64_t head_num, int64_t key_value_head_num, int64_t select_block_size, int64_t select_block_count, int64_t page_block_size, c10::string_view layout, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & block_table, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(query));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_nsa_select_attention_infer", query, key, value, topk_indices, scale_value, head_num, key_value_head_num, select_block_size, select_block_count, page_block_size, layout, atten_mask, block_table, actual_seq_qlen, actual_seq_kvlen);
      at::Tensor res = op_plugin::npu_nsa_select_attention_infer(query, key, value, topk_indices, scale_value, head_num, key_value_head_num, select_block_size, select_block_count, page_block_size, layout, atten_mask, block_table, actual_seq_qlen, actual_seq_kvlen);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_top_k_top_p(const at::Tensor & logits, const ::std::optional<at::Tensor> & p, const ::std::optional<at::Tensor> & k) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(logits));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_top_k_top_p", logits, p, k);
      at::Tensor res = op_plugin::npu_top_k_top_p(logits, p, k);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_moe_token_permute(const at::Tensor & tokens, const at::Tensor & indices, ::std::optional<int64_t> num_out_tokens, bool padded_mode) {
  ...
  const c10::OptionalDeviceGuard device_guard(device_of(tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_permute", tokens, indices, num_out_tokens, padded_mode);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_moe_token_permute(tokens, indices, num_out_tokens, padded_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
at::Tensor wrapper__npu_moe_token_permute_grad(const at::Tensor & tokens, const at::Tensor & grad_permuted_tokens, const at::Tensor & indices, const at::Tensor & sorted_indices, bool padded_mode) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(tokens);
      c10_npu::check_npu_tensor_is_safe(grad_permuted_tokens);
      c10_npu::check_npu_tensor_is_safe(indices);
      c10_npu::check_npu_tensor_is_safe(sorted_indices);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, tokens, "wrapper__npu_moe_token_permute_grad", "tokens");
  c10::impl::check_and_update_common_device(common_device, grad_permuted_tokens, "wrapper__npu_moe_token_permute_grad", "grad_permuted_tokens");
  c10::impl::check_and_update_common_device(common_device, indices, "wrapper__npu_moe_token_permute_grad", "indices");
  c10::impl::check_and_update_common_device(common_device, sorted_indices, "wrapper__npu_moe_token_permute_grad", "sorted_indices");
  const c10::OptionalDeviceGuard device_guard(device_of(tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_permute_grad", tokens, grad_permuted_tokens, indices, sorted_indices, padded_mode);
      at::Tensor res = op_plugin::npu_moe_token_permute_grad(tokens, grad_permuted_tokens, indices, sorted_indices, padded_mode);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_token_permute_grad(tokens, grad_permuted_tokens, indices, sorted_indices, padded_mode);
}
...
at::Tensor wrapper__npu_moe_token_unpermute(const at::Tensor & permuted_tokens, const at::Tensor & sorted_indices, const ::std::optional<at::Tensor> & probs, bool padded_mode, at::OptionalIntArrayRef restore_shape) {
  ...
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_unpermute", permuted_tokens, sorted_indices, probs, padded_mode, restore_shape);
      at::Tensor res = op_plugin::npu_moe_token_unpermute(permuted_tokens, sorted_indices, probs, padded_mode, restore_shape);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
...
::std::tuple<at::Tensor,at::Tensor> wrapper__npu_moe_token_unpermute_grad(const at::Tensor & permuted_tokens, const at::Tensor & grad_unpermuted_tokens, const at::Tensor & sorted_indices, const ::std::optional<at::Tensor> & probs, bool padded_mode, at::OptionalIntArrayRef restore_shape) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(permuted_tokens);
      c10_npu::check_npu_tensor_is_safe(grad_unpermuted_tokens);
      c10_npu::check_npu_tensor_is_safe(sorted_indices);
      c10_npu::check_npu_tensor_is_safe(probs);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, permuted_tokens, "wrapper__npu_moe_token_unpermute_grad", "permuted_tokens");
  c10::impl::check_and_update_common_device(common_device, grad_unpermuted_tokens, "wrapper__npu_moe_token_unpermute_grad", "grad_unpermuted_tokens");
  c10::impl::check_and_update_common_device(common_device, sorted_indices, "wrapper__npu_moe_token_unpermute_grad", "sorted_indices");
  c10::impl::check_and_update_common_device(common_device, probs, "wrapper__npu_moe_token_unpermute_grad", "probs");
  const c10::OptionalDeviceGuard device_guard(device_of(permuted_tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_unpermute_grad", permuted_tokens, grad_unpermuted_tokens, sorted_indices, probs, padded_mode, restore_shape);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_moe_token_unpermute_grad(permuted_tokens, grad_unpermuted_tokens, sorted_indices, probs, padded_mode, restore_shape);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_token_unpermute_grad(permuted_tokens, grad_unpermuted_tokens, sorted_indices, probs, padded_mode, restore_shape);
}

at::Tensor wrapper__npu_moe_token_unpermute_with_routing_map(const at::Tensor & permuted_tokens, const at::Tensor & sorted_indices, at::IntArrayRef restore_shape, const ::std::optional<at::Tensor> & probs, const ::std::optional<at::Tensor> & routing_map, bool drop_and_pad) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, permuted_tokens, "wrapper__npu_moe_token_unpermute_with_routing_map", "permuted_tokens");
  c10::impl::check_and_update_common_device(common_device, sorted_indices, "wrapper__npu_moe_token_unpermute_with_routing_map", "sorted_indices");
  c10::impl::check_and_update_common_device(common_device, probs, "wrapper__npu_moe_token_unpermute_with_routing_map", "probs");
  c10::impl::check_and_update_common_device(common_device, routing_map, "wrapper__npu_moe_token_unpermute_with_routing_map", "routing_map");
  const c10::OptionalDeviceGuard device_guard(device_of(permuted_tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_unpermute_with_routing_map", permuted_tokens, sorted_indices, restore_shape, probs, routing_map, drop_and_pad);
      at::Tensor res = op_plugin::npu_moe_token_unpermute_with_routing_map(permuted_tokens, sorted_indices, restore_shape, probs, routing_map, drop_and_pad);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_token_unpermute_with_routing_map(permuted_tokens, sorted_indices, restore_shape, probs, routing_map, drop_and_pad);
}

::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper___npu_moe_token_unpermute_with_routing_map(const at::Tensor & permuted_tokens, const at::Tensor & sorted_indices, at::IntArrayRef restore_shape, const ::std::optional<at::Tensor> & probs, const ::std::optional<at::Tensor> & routing_map, bool drop_and_pad) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, permuted_tokens, "wrapper___npu_moe_token_unpermute_with_routing_map", "permuted_tokens");
  c10::impl::check_and_update_common_device(common_device, sorted_indices, "wrapper___npu_moe_token_unpermute_with_routing_map", "sorted_indices");
  c10::impl::check_and_update_common_device(common_device, probs, "wrapper___npu_moe_token_unpermute_with_routing_map", "probs");
  c10::impl::check_and_update_common_device(common_device, routing_map, "wrapper___npu_moe_token_unpermute_with_routing_map", "routing_map");
  const c10::OptionalDeviceGuard device_guard(device_of(permuted_tokens));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_npu_moe_token_unpermute_with_routing_map", permuted_tokens, sorted_indices, restore_shape, probs, routing_map, drop_and_pad);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::_npu_moe_token_unpermute_with_routing_map(permuted_tokens, sorted_indices, restore_shape, probs, routing_map, drop_and_pad);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_npu_moe_token_unpermute_with_routing_map(permuted_tokens, sorted_indices, restore_shape, probs, routing_map, drop_and_pad);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_moe_token_unpermute_with_routing_map_grad(const at::Tensor & unpermuted_tokens_grad, const at::Tensor & out_index, const at::Tensor & permuted_token_id, const ::std::optional<at::Tensor> & routing_map, const ::std::optional<at::Tensor> & permuted_tokens, const ::std::optional<at::Tensor> & probs, bool drop_and_pad, at::IntArrayRef restore_shape) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(unpermuted_tokens_grad);
      c10_npu::check_npu_tensor_is_safe(out_index);
      c10_npu::check_npu_tensor_is_safe(permuted_token_id);
      c10_npu::check_npu_tensor_is_safe(routing_map);
      c10_npu::check_npu_tensor_is_safe(permuted_tokens);
      c10_npu::check_npu_tensor_is_safe(probs);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, unpermuted_tokens_grad, "wrapper__npu_moe_token_unpermute_with_routing_map_grad", "unpermuted_tokens_grad");
  c10::impl::check_and_update_common_device(common_device, out_index, "wrapper__npu_moe_token_unpermute_with_routing_map_grad", "out_index");
  c10::impl::check_and_update_common_device(common_device, permuted_token_id, "wrapper__npu_moe_token_unpermute_with_routing_map_grad", "permuted_token_id");
  c10::impl::check_and_update_common_device(common_device, routing_map, "wrapper__npu_moe_token_unpermute_with_routing_map_grad", "routing_map");
  c10::impl::check_and_update_common_device(common_device, permuted_tokens, "wrapper__npu_moe_token_unpermute_with_routing_map_grad", "permuted_tokens");
  c10::impl::check_and_update_common_device(common_device, probs, "wrapper__npu_moe_token_unpermute_with_routing_map_grad", "probs");
  const c10::OptionalDeviceGuard device_guard(device_of(unpermuted_tokens_grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_moe_token_unpermute_with_routing_map_grad", unpermuted_tokens_grad, out_index, permuted_token_id, routing_map, permuted_tokens, probs, drop_and_pad, restore_shape);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_moe_token_unpermute_with_routing_map_grad(unpermuted_tokens_grad, out_index, permuted_token_id, routing_map, permuted_tokens, probs, drop_and_pad, restore_shape);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_moe_token_unpermute_with_routing_map_grad(unpermuted_tokens_grad, out_index, permuted_token_id, routing_map, permuted_tokens, probs, drop_and_pad, restore_shape);
}

at::Tensor & wrapper_out__quantize_per_tensor_impl_out(const at::Tensor & inputs, const at::Tensor & scales, const at::Tensor & zero_points, at::ScalarType dtype, at::Tensor & result) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(result);
      c10_npu::check_npu_tensor_is_safe(inputs);
      c10_npu::check_npu_tensor_is_safe(scales);
      c10_npu::check_npu_tensor_is_safe(zero_points);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, result, "wrapper_out__quantize_per_tensor_impl_out", "result");
  c10::impl::check_and_update_common_device(common_device, inputs, "wrapper_out__quantize_per_tensor_impl_out", "inputs");
  c10::impl::check_and_update_common_device(common_device, scales, "wrapper_out__quantize_per_tensor_impl_out", "scales");
  c10::impl::check_and_update_common_device(common_device, zero_points, "wrapper_out__quantize_per_tensor_impl_out", "zero_points");
  const c10::OptionalDeviceGuard device_guard(device_of(result));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_quantize_per_tensor_impl.out", inputs, scales, zero_points, dtype, result);
      at::Tensor & res = op_plugin::_quantize_per_tensor_impl_out(inputs, scales, zero_points, dtype, result);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_quantize_per_tensor_impl_out(inputs, scales, zero_points, dtype, result);
}

at::Tensor & wrapper_out__quantize_per_channel_impl_out(const at::Tensor & inputs, const at::Tensor & scales, const at::Tensor & zero_points, int64_t axis, at::ScalarType dtype, at::Tensor & result) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, result, "wrapper_out__quantize_per_channel_impl_out", "result");
  c10::impl::check_and_update_common_device(common_device, inputs, "wrapper_out__quantize_per_channel_impl_out", "inputs");
  c10::impl::check_and_update_common_device(common_device, scales, "wrapper_out__quantize_per_channel_impl_out", "scales");
  c10::impl::check_and_update_common_device(common_device, zero_points, "wrapper_out__quantize_per_channel_impl_out", "zero_points");
  const c10::OptionalDeviceGuard device_guard(device_of(result));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("_quantize_per_channel_impl.out", inputs, scales, zero_points, axis, dtype, result);
      at::Tensor & res = op_plugin::_quantize_per_channel_impl_out(inputs, scales, zero_points, axis, dtype, result);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::_quantize_per_channel_impl_out(inputs, scales, zero_points, axis, dtype, result);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_dynamic_block_quant(const at::Tensor & x, double min_scale, c10::string_view round_mode, int64_t dst_type, int64_t row_block_size, int64_t col_block_size) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, x, "wrapper__npu_dynamic_block_quant", "x");
  const c10::OptionalDeviceGuard device_guard(device_of(x));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_dynamic_block_quant", x, min_scale, round_mode, dst_type, row_block_size, col_block_size);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_dynamic_block_quant(x, min_scale, round_mode, dst_type, row_block_size, col_block_size);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_dynamic_block_quant(x, min_scale, round_mode, dst_type, row_block_size, col_block_size);
}

::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> wrapper__npu_fused_linear_online_max_sum(const at::Tensor & input, const at::Tensor & weight, const at::Tensor & target, int64_t vocab_start_index, int64_t vocab_end_index, bool return_logits) {
  ...
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, input, "wrapper__npu_fused_linear_online_max_sum", "input");
  c10::impl::check_and_update_common_device(common_device, weight, "wrapper__npu_fused_linear_online_max_sum", "weight");
  c10::impl::check_and_update_common_device(common_device, target, "wrapper__npu_fused_linear_online_max_sum", "target");
  const c10::OptionalDeviceGuard device_guard(device_of(input));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_linear_online_max_sum", input, weight, target, vocab_start_index, vocab_end_index, return_logits);
      ::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> res = op_plugin::npu_fused_linear_online_max_sum(input, weight, target, vocab_start_index, vocab_end_index, return_logits);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_fused_linear_online_max_sum(input, weight, target, vocab_start_index, vocab_end_index, return_logits);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_fused_cross_entropy_loss_with_max_sum(const at::Tensor & logits_max, const at::Tensor & sum_exp_logits, const at::Tensor & predicted_logits, ::std::optional<double> label_smoothing, const ::std::optional<at::Tensor> & input, const ::std::optional<at::Tensor> & weight, const ::std::optional<at::Tensor> & vocab_parallel_logits) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(logits_max);
      c10_npu::check_npu_tensor_is_safe(sum_exp_logits);
      c10_npu::check_npu_tensor_is_safe(predicted_logits);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, logits_max, "wrapper__npu_fused_cross_entropy_loss_with_max_sum", "logits_max");
  c10::impl::check_and_update_common_device(common_device, sum_exp_logits, "wrapper__npu_fused_cross_entropy_loss_with_max_sum", "sum_exp_logits");
  c10::impl::check_and_update_common_device(common_device, predicted_logits, "wrapper__npu_fused_cross_entropy_loss_with_max_sum", "predicted_logits");
  c10::impl::check_and_update_common_device(common_device, input, "wrapper__npu_fused_cross_entropy_loss_with_max_sum", "input");
  c10::impl::check_and_update_common_device(common_device, weight, "wrapper__npu_fused_cross_entropy_loss_with_max_sum", "weight");
  c10::impl::check_and_update_common_device(common_device, vocab_parallel_logits, "wrapper__npu_fused_cross_entropy_loss_with_max_sum", "vocab_parallel_logits");
  const c10::OptionalDeviceGuard device_guard(device_of(logits_max));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_cross_entropy_loss_with_max_sum", logits_max, sum_exp_logits, predicted_logits, label_smoothing, input, weight, vocab_parallel_logits);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_fused_cross_entropy_loss_with_max_sum(logits_max, sum_exp_logits, predicted_logits, label_smoothing, input, weight, vocab_parallel_logits);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_fused_cross_entropy_loss_with_max_sum(logits_max, sum_exp_logits, predicted_logits, label_smoothing, input, weight, vocab_parallel_logits);
}

::std::tuple<at::Tensor,at::Tensor> wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad(const at::Tensor & grad, const at::Tensor & input, const at::Tensor & weight, const at::Tensor & target_mask, const at::Tensor & masked_target, double label_smoothing, const ::std::optional<at::Tensor> & logits_max, const ::std::optional<at::Tensor> & sum_exp_logits, const ::std::optional<at::Tensor> & softmax) {

  if (c10_npu::get_npu_data_unsafe_flag()) {
      c10_npu::check_npu_tensor_is_safe(grad);
      c10_npu::check_npu_tensor_is_safe(input);
      c10_npu::check_npu_tensor_is_safe(weight);
      c10_npu::check_npu_tensor_is_safe(target_mask);
      c10_npu::check_npu_tensor_is_safe(masked_target);
      c10_npu::check_npu_tensor_is_safe(logits_max);
      c10_npu::check_npu_tensor_is_safe(sum_exp_logits);
      c10_npu::check_npu_tensor_is_safe(softmax);
  }
  c10::optional<at::Device> common_device = at::nullopt;
  (void)common_device; // Suppress unused variable warning
  c10::impl::check_and_update_common_device(common_device, grad, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "grad");
  c10::impl::check_and_update_common_device(common_device, input, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "input");
  c10::impl::check_and_update_common_device(common_device, weight, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "weight");
  c10::impl::check_and_update_common_device(common_device, target_mask, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "target_mask");
  c10::impl::check_and_update_common_device(common_device, masked_target, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "masked_target");
  c10::impl::check_and_update_common_device(common_device, logits_max, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "logits_max");
  c10::impl::check_and_update_common_device(common_device, sum_exp_logits, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "sum_exp_logits");
  c10::impl::check_and_update_common_device(common_device, softmax, "wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad", "softmax");
  const c10::OptionalDeviceGuard device_guard(device_of(grad));
  if (C10_UNLIKELY(at_npu::native::env::CheckOpHookEnable())) {
      at_npu::native::OpHook::GetInstance().PreHook("npu_fused_linear_cross_entropy_loss_with_max_sum_grad", grad, input, weight, target_mask, masked_target, label_smoothing, logits_max, sum_exp_logits, softmax);
      ::std::tuple<at::Tensor,at::Tensor> res = op_plugin::npu_fused_linear_cross_entropy_loss_with_max_sum_grad(grad, input, weight, target_mask, masked_target, label_smoothing, logits_max, sum_exp_logits, softmax);
      at_npu::native::OpHook::GetInstance().PostHook(res);
      return res;
  }
  return op_plugin::npu_fused_linear_cross_entropy_loss_with_max_sum_grad(grad, input, weight, target_mask, masked_target, label_smoothing, logits_max, sum_exp_logits, softmax);
}
...
TORCH_LIBRARY(npu, m) {
    ...
    m.def("npu_format_cast.Tensor(Tensor input, Tensor dst, int? customize_dtype=None) -> Tensor", tags_0);
    m.def("npu_format_cast_.acl_format(Tensor(a!) input, int acl_format, int? customize_dtype=None) -> Tensor(a!)", tags_0);
    m.def("npu_format_cast_(Tensor(a!) input, Tensor src, int? customize_dtype=None) -> Tensor(a!)", tags_0);
    ...
    m.def("npu_format_cast(Tensor input, int acl_format, int? customize_dtype=None) -> Tensor", tags_0);
    m.def("_npu_format_cast(Tensor input, int acl_format) -> Tensor", tags_0);
    m.def("_npu_format_cast.aclnn(Tensor input, int acl_format, int customize_dtype) -> Tensor", tags_0);
    ...
    m.def("npu_top_k_top_p_sample(Tensor logits, Tensor top_k, Tensor top_p, Tensor? q=None, float eps=1e-8, bool is_need_logits=False, int top_k_guess=32) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("npu_rms_norm_quant(Tensor x, Tensor gamma, Tensor beta, Tensor scale, Tensor offset, float epsilon=1e-06) -> Tensor", tags_0);
    m.def("npu_add_rms_norm_cast(Tensor x1, Tensor x2, Tensor gamma, float epsilon=1e-06) -> (Tensor, Tensor, Tensor, Tensor)", tags_0);
    m.def("npu_add_rms_norm_quant(Tensor x1, Tensor x2, Tensor gamma, Tensor scales1, Tensor? zero_points1, Tensor? beta=None, Tensor? scales2=None, Tensor? zero_points2=None, *, int axis=-1, float epsilon=1e-06, bool div_mode=True) -> (Tensor, Tensor, Tensor)", tags_0);
    m.def("npu_attention_update(Tensor[] lse, Tensor[] local_out, int update_type) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("npu_all_gather_base_mm(Tensor input, Tensor x2, str hcom, int world_size, *, Tensor? bias=None, Tensor? x1_scale=None, Tensor? x2_scale=None, int gather_index=0, bool gather_output=True, int comm_turn=0, ScalarType? output_dtype=None, str? comm_mode=None) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("npu_apply_rotary_pos_emb(Tensor query, Tensor key, Tensor cos, Tensor sin, str layout='BSH', str rotary_mode='half') -> (Tensor, Tensor)", tags_0);
    ...
    m.def("npu_kv_rmsnorm_rope_cache_v2(Tensor kv, Tensor gamma, Tensor cos, Tensor sin, Tensor index, Tensor(a!) k_cache, Tensor(b!) ckv_cache, *, Tensor? k_rope_scale=None, Tensor? c_kv_scale=None, Tensor? k_rope_offset=None, Tensor? c_kv_offset=None, float epsilon=1e-5, str cache_mode='Norm', bool is_output_kv=False) -> (Tensor, Tensor)", tags_0);
    m.def("npu_kv_rmsnorm_rope_cache_v2_functional(Tensor kv, Tensor gamma, Tensor cos, Tensor sin, Tensor index, Tensor k_cache, Tensor ckv_cache, *, Tensor? k_rope_scale=None, Tensor? c_kv_scale=None, Tensor? k_rope_offset=None, Tensor? c_kv_offset=None, float epsilon=1e-5, str cache_mode='Norm', bool is_output_kv=False) -> (Tensor, Tensor, Tensor, Tensor)", tags_0);
    ...
    m.def("npu_moe_token_permute_with_routing_map(Tensor tokens, Tensor routing_map, *, Tensor? probs=None, int? num_out_tokens=None, bool drop_and_pad=False) -> (Tensor, Tensor, Tensor)", tags_0);
    m.def("npu_moe_token_permute_with_routing_map_grad(Tensor permuted_token_out_grad, Tensor? probs_grad, Tensor sorted_indices, Tensor routing_map, SymInt experts_num, SymInt tokens_num, bool drop_and_pad) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("_npu_dtype_cast(Tensor input, ScalarType dtype) -> Tensor", tags_0);
    ...
    m.def("_npu_dtype_cast_backward(Tensor grad, ScalarType dtype) -> Tensor", tags_0);
    ...
    m.def("npu_grouped_matmul_finalize_routing(Tensor x, Tensor w, Tensor group_list, *, Tensor? scale=None, Tensor? bias=None, Tensor? offset=None, Tensor? pertoken_scale=None, Tensor? shared_input=None, Tensor? logit=None, Tensor? row_index=None, ScalarType? dtype=None, float? shared_input_weight=1.0, int? shared_input_offset=0, int? output_bs=0, int? group_list_type=1, int[]? tuning_config=None) -> Tensor", tags_0);
    ...
    m.def("npu_mm_reduce_scatter_base(Tensor input, Tensor x2, str hcom, int world_size, *, str reduce_op='sum', Tensor? bias=None, Tensor? x1_scale=None, Tensor? x2_scale=None, int comm_turn=0, ScalarType? output_dtype=None, str? comm_mode=None) -> Tensor", tags_0);
    ...
    m.def("npu_ffn_worker_batching(Tensor schedule_context, int expert_num, int[4] max_out_shape, *, int token_dtype=0, int need_schedule=0, int layer_num=0) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor, Tensor)", tags_0);
    ...
    m.def("npu_moe_update_expert(Tensor expert_ids, Tensor eplb_table, *, Tensor? expert_scales=None, Tensor? pruning_threshold=None, Tensor? active_mask=None, int local_rank_id=-1, int world_size=-1, int balance_mode=0) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("npu_moe_distribute_combine_add_rms_norm(Tensor expand_x, Tensor expert_ids, Tensor expand_idx, Tensor ep_send_counts, Tensor expert_scales, Tensor residual_x, Tensor gamma, str group_ep, int ep_world_size, int ep_rank_id, int moe_expert_num, *, Tensor? tp_send_counts=None, Tensor? x_active_mask=None, Tensor? activation_scale=None, Tensor? weight_scale=None, Tensor? group_list=None, Tensor? expand_scales=None, Tensor? shared_expert_x=None, Tensor? elastic_info=None, Tensor? ori_x=None, Tensor? const_expert_alpha_1=None, Tensor? const_expert_alpha_2=None, Tensor? const_expert_v=None, str group_tp=\"\", int tp_world_size=0, int tp_rank_id=0, int expert_shard_type=0, int shared_expert_num=1, int shared_expert_rank_num=0, int global_bs=0, int out_dtype=0, int comm_quant_mode=0, int group_list_type=0, str comm_alg=\"\", float norm_eps=1e-06, int zero_expert_num=0, int copy_expert_num=0, int const_expert_num=0) -> (Tensor, Tensor, Tensor)", tags_0);
    m.def("npu_add_rms_norm_dynamic_quant(Tensor x1, Tensor x2, Tensor gamma, *, Tensor? smooth_scale1=None, Tensor? smooth_scale2=None, Tensor? beta=None, float epsilon=1e-6, bool[2] output_mask=[]) -> (Tensor, Tensor, Tensor, Tensor, Tensor)", tags_0);
    m.def("npu_attention_worker_combine(Tensor schedule_context, Tensor expert_scales, Tensor layer_id, int hidden_size, *, int token_dtype=0, int need_schedule=0) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("npu_quant_matmul_reduce_sum(Tensor x1, Tensor x2, *, Tensor? x1_scale=None, Tensor? x2_scale=None) -> Tensor", tags_0);
    ...
    m.def("npu_scatter_pa_kv_cache_functional(Tensor key, Tensor value, Tensor key_cache, Tensor value_cache, Tensor slot_mapping, *, Tensor? compress_lens=None, Tensor? compress_seq_offsets=None, Tensor? seq_lens=None) -> (Tensor, Tensor)", tags_0);
    m.def("npu_scatter_pa_kv_cache(Tensor key, Tensor value, Tensor(a!) key_cache, Tensor(b!) value_cache, Tensor slot_mapping, *, Tensor? compress_lens=None, Tensor? compress_seq_offsets=None, Tensor? seq_lens=None) -> ()", tags_0);
    ...
    m.def("npu_swiglu_quant(Tensor x, *, Tensor? smooth_scales=None, Tensor? offsets=None, Tensor? group_index=None, bool activate_left=False, int quant_mode=0, int group_list_type=0, ScalarType? dst_type=None) -> (Tensor, Tensor)", tags_0);
    m.def("npu_dequant_swiglu_quant(Tensor x, *, Tensor? weight_scale=None, Tensor? activation_scale=None, Tensor? bias=None, Tensor? quant_scale=None, Tensor? quant_offset=None, Tensor? group_index=None, bool activate_left=False, int quant_mode=0, int swiglu_mode=0, float clamp_limit=7.0, float glu_alpha=1.702, float glu_bias=1.0) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("obfuscation_initialize(int hidden_size, int tp_rank, int cmd, *, ScalarType? data_type=None, int? model_obf_seed_id=0, int? data_obf_seed_id=0, int? thread_num=4, float? obf_coefficient=1.0) -> Tensor", TORCH_FN(at_npu::native::wrapper__obfuscation_initialize), tags_0);
    m.def("obfuscation_finalize(Tensor fd_to_close) -> Tensor", tags_0);
    m.def("obfuscation_calculate(Tensor fd, Tensor x, Tensor param, *, float? obf_coefficient=1.0) -> Tensor", tags_0);
    ...
    m.def("npu_advance_step_flashattn(Tensor(a!) input_tokens, Tensor sampled_token_ids, Tensor(b!) input_positions, Tensor(c!) seq_lens, Tensor(d!) slot_mapping, Tensor block_tables, int num_seqs, int num_queries, int block_size, *, Tensor? spec_token=None, Tensor? accepted_num=None) -> ()", tags_0);
    ...
    m.def("npu_gather_sparse_index_backward(Tensor grad, SymInt[] self_sizes, Tensor index) -> Tensor", tags_0);
    m.def("_npu_index_add(Tensor input, Tensor index, Tensor source, *, Scalar alpha=1) -> Tensor", tags_0);
    m.def("_npu_index_add_(Tensor(a!) input, Tensor index, Tensor source, *, Scalar alpha=1) -> Tensor(a!)", tags_0);
    ...
    m.def("npu_nsa_compress_attention_infer(Tensor query, Tensor key, Tensor value, float scale_value, int head_num, int key_value_head_num, int select_block_size, int select_block_count, int page_block_size, int compress_block_size, int compress_stride, *, str layout='TND', Tensor? atten_mask=None, Tensor? block_table=None, Tensor? topk_mask=None, int[]? actual_seq_qlen=None, int[]? actual_cmp_seq_kvlen=None, int[]? actual_sel_seq_kvlen=None) -> (Tensor, Tensor)", tags_0);
    ...
    m.def("npu_top_k_top_p(Tensor logits, Tensor? p=None, Tensor? k=None) -> Tensor", tags_0);
    ...
    m.def("npu_moe_token_permute_grad(Tensor tokens, Tensor grad_permuted_tokens, Tensor indices, Tensor sorted_indices, bool padded_mode=False) -> Tensor", tags_0);
    ...
    m.def("npu_moe_token_unpermute_grad(Tensor permuted_tokens, Tensor grad_unpermuted_tokens, Tensor sorted_indices, Tensor? probs=None, bool padded_mode=False, int[]? restore_shape=None) -> (Tensor, Tensor)", tags_0);
    m.def("npu_moe_token_unpermute_with_routing_map(Tensor permuted_tokens, Tensor sorted_indices, int[] restore_shape, *, Tensor? probs=None, Tensor? routing_map=None, bool drop_and_pad=False) -> Tensor", tags_0);
    m.def("_npu_moe_token_unpermute_with_routing_map(Tensor permuted_tokens, Tensor sorted_indices, int[] restore_shape, *, Tensor? probs=None, Tensor? routing_map=None, bool drop_and_pad=False) -> (Tensor, Tensor, Tensor, Tensor)", tags_0);
    m.def("npu_moe_token_unpermute_with_routing_map_grad(Tensor unpermuted_tokens_grad, Tensor out_index, Tensor permuted_token_id, Tensor? routing_map, Tensor? permuted_tokens, Tensor? probs, bool drop_and_pad, int[] restore_shape) -> (Tensor, Tensor)", tags_0);
    m.def("_quantize_per_tensor_impl.out(Tensor inputs, Tensor scales, Tensor zero_points, ScalarType dtype, *, Tensor(a!) result) -> Tensor(a!)", tags_0);
    m.def("_quantize_per_channel_impl.out(Tensor inputs, Tensor scales, Tensor zero_points, int axis, ScalarType dtype, *, Tensor(a!) result) -> Tensor(a!)", tags_0);
    m.def("npu_dynamic_block_quant(Tensor x, *, float min_scale=0.0, str round_mode=\"rint\", int dst_type=1, int row_block_size=1, int col_block_size=128) -> (Tensor y, Tensor scale)", tags_0);
    m.def("npu_fused_linear_online_max_sum(Tensor input, Tensor weight, Tensor target, int vocab_start_index, int vocab_end_index, bool return_logits=False) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor)", tags_0);
    m.def("npu_fused_cross_entropy_loss_with_max_sum(Tensor logits_max, Tensor sum_exp_logits, Tensor predicted_logits, *, float? label_smoothing=0.0, Tensor? input=None, Tensor? weight=None, Tensor? vocab_parallel_logits=None) -> (Tensor, Tensor)", tags_0);
    m.def("npu_fused_linear_cross_entropy_loss_with_max_sum_grad(Tensor grad, Tensor input, Tensor weight, Tensor target_mask, Tensor masked_target, float label_smoothing=0.0, Tensor? logits_max=None, Tensor? sum_exp_logits=None, Tensor? softmax=None) -> (Tensor, Tensor)", tags_0);
}
...
TORCH_LIBRARY_IMPL(npu, PrivateUse1, m) {
    ...
    m.impl("_npu_format_cast.aclnn", TORCH_FN(at_npu::native::wrapper_aclnn__npu_format_cast));
    m.impl("npu_top_k_top_p_sample", TORCH_FN(at_npu::native::wrapper__npu_top_k_top_p_sample));
    ...
    m.impl("npu_rms_norm_quant", TORCH_FN(at_npu::native::wrapper__npu_rms_norm_quant));
    ...
    m.impl("npu_attention_update", TORCH_FN(at_npu::native::wrapper__npu_attention_update));
    ...
    m.impl("npu_kv_rmsnorm_rope_cache_v2", TORCH_FN(at_npu::native::wrapper__npu_kv_rmsnorm_rope_cache_v2));
    m.impl("npu_kv_rmsnorm_rope_cache_v2_functional", TORCH_FN(at_npu::native::wrapper__npu_kv_rmsnorm_rope_cache_v2_functional));
    ...
    m.impl("npu_moe_token_permute_with_routing_map", TORCH_FN(at_npu::native::wrapper__npu_moe_token_permute_with_routing_map));
    m.impl("npu_moe_token_permute_with_routing_map_grad", TORCH_FN(at_npu::native::wrapper__npu_moe_token_permute_with_routing_map_grad));
    ...
    m.impl("_npu_dtype_cast", TORCH_FN(at_npu::native::wrapper___npu_dtype_cast));
    ...
    m.impl("_npu_dtype_cast_backward", TORCH_FN(at_npu::native::wrapper___npu_dtype_cast_backward));
    ...
    m.impl("npu_fused_infer_attention_score_v2", TORCH_FN(at_npu::native::wrapper__npu_fused_infer_attention_score_v2));
    m.impl("npu_fused_infer_attention_score_v2.out", TORCH_FN(at_npu::native::wrapper_out_npu_fused_infer_attention_score_v2_out));
    m.impl("_npu_fused_infer_attention_score_v2_get_max_workspace", TORCH_FN(at_npu::native::wrapper___npu_fused_infer_attention_score_v2_get_max_workspace));
    ...
    m.impl("npu_incre_flash_attention", TORCH_FN(at_npu::native::wrapper__npu_incre_flash_attention));
    ...
    m.impl("npu_moe_init_routing_quant", TORCH_FN(at_npu::native::wrapper__npu_moe_init_routing_quant));
    m.impl("npu_grouped_matmul_swiglu_quant", TORCH_FN(at_npu::native::wrapper__npu_grouped_matmul_swiglu_quant));
    m.impl("npu_ffn_worker_batching", TORCH_FN(at_npu::native::wrapper__npu_ffn_worker_batching));
    ...
    m.impl("npu_moe_update_expert", TORCH_FN(at_npu::native::wrapper__npu_moe_update_expert));
    ...
    m.impl("npu_add_rms_norm_dynamic_quant", TORCH_FN(at_npu::native::wrapper__npu_add_rms_norm_dynamic_quant));
    m.impl("npu_attention_worker_combine", TORCH_FN(at_npu::native::wrapper__npu_attention_worker_combine));
    ...
    m.impl("npu_quant_matmul_reduce_sum", TORCH_FN(at_npu::native::wrapper__npu_quant_matmul_reduce_sum));
    ...
    m.impl("npu_scatter_pa_kv_cache_functional", TORCH_FN(at_npu::native::wrapper__npu_scatter_pa_kv_cache_functional));
    m.impl("npu_scatter_pa_kv_cache", TORCH_FN(at_npu::native::wrapper__npu_scatter_pa_kv_cache));
    ...
    m.impl("npu_swiglu_quant", TORCH_FN(at_npu::native::wrapper__npu_swiglu_quant));
    ...
    m.impl("obfuscation_finalize", TORCH_FN(at_npu::native::wrapper__obfuscation_finalize));
    m.impl("obfuscation_calculate", TORCH_FN(at_npu::native::wrapper__obfuscation_calculate));
    ...
    m.impl("npu_gather_sparse_index_backward", TORCH_FN(at_npu::native::wrapper__npu_gather_sparse_index_backward));
    m.impl("_npu_index_add", TORCH_FN(at_npu::native::wrapper___npu_index_add));
    m.impl("_npu_index_add_", TORCH_FN(at_npu::native::wrapper___npu_index_add_));
    ...
    m.impl("npu_moe_token_permute_grad", TORCH_FN(at_npu::native::wrapper__npu_moe_token_permute_grad));
    m.impl("npu_moe_token_unpermute", TORCH_FN(at_npu::native::wrapper__npu_moe_token_unpermute));
    m.impl("npu_moe_token_unpermute_grad", TORCH_FN(at_npu::native::wrapper__npu_moe_token_unpermute_grad));
    m.impl("npu_moe_token_unpermute_with_routing_map", TORCH_FN(at_npu::native::wrapper__npu_moe_token_unpermute_with_routing_map));
    m.impl("_npu_moe_token_unpermute_with_routing_map", TORCH_FN(at_npu::native::wrapper___npu_moe_token_unpermute_with_routing_map));
    m.impl("npu_moe_token_unpermute_with_routing_map_grad", TORCH_FN(at_npu::native::wrapper__npu_moe_token_unpermute_with_routing_map_grad));
    m.impl("_quantize_per_tensor_impl.out", TORCH_FN(at_npu::native::wrapper_out__quantize_per_tensor_impl_out));
    m.impl("_quantize_per_channel_impl.out", TORCH_FN(at_npu::native::wrapper_out__quantize_per_channel_impl_out));
    m.impl("npu_dynamic_block_quant", TORCH_FN(at_npu::native::wrapper__npu_dynamic_block_quant));
    m.impl("npu_fused_linear_online_max_sum", TORCH_FN(at_npu::native::wrapper__npu_fused_linear_online_max_sum));
    m.impl("npu_fused_cross_entropy_loss_with_max_sum", TORCH_FN(at_npu::native::wrapper__npu_fused_cross_entropy_loss_with_max_sum));
    m.impl("npu_fused_linear_cross_entropy_loss_with_max_sum_grad", TORCH_FN(at_npu::native::wrapper__npu_fused_linear_cross_entropy_loss_with_max_sum_grad));
}
