...
at::Tensor npu_format_cast(const at::Tensor & self, const at::Tensor & dst, ::std::optional<int64_t> customize_dtype) {
    ...
    return op.call(self, dst, customize_dtype);
}
at::Tensor & npu_format_cast_(at::Tensor & self, int64_t acl_format, ::std::optional<int64_t> customize_dtype) {
    ...
    return op.call(self, acl_format, customize_dtype);
}
at::Tensor & npu_format_cast_(at::Tensor & self, const at::Tensor & src, ::std::optional<int64_t> customize_dtype) {
    ...
    return op.call(self, src, customize_dtype);
}
...
at::Tensor npu_format_cast(const at::Tensor & self, int64_t acl_format, ::std::optional<int64_t> customize_dtype) {
...
at::Tensor _npu_format_cast(const at::Tensor & self, int64_t acl_format, int64_t customize_dtype) {
...
::std::tuple<at::Tensor,at::Tensor> npu_top_k_top_p_sample(const at::Tensor & logits, const at::Tensor & top_k, const at::Tensor & top_p, const ::std::optional<at::Tensor> & q, double eps, bool is_need_logits, int64_t top_k_guess) {
    ...
    return op.call(logits, top_k, top_p, q, eps, is_need_logits, top_k_guess);
}
...
at::Tensor npu_rms_norm_quant(const at::Tensor & x, const at::Tensor & gamma, const at::Tensor & beta, const at::Tensor & scale, const at::Tensor & offset, double epsilon) {
    ...
    return op.call(x, gamma, beta, scale, offset, epsilon);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> npu_add_rms_norm_quant(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & gamma, const at::Tensor & scales1, const ::std::optional<at::Tensor> & zero_points1, const ::std::optional<at::Tensor> & beta, const ::std::optional<at::Tensor> & scales2, const ::std::optional<at::Tensor> & zero_points2, int64_t axis, double epsilon, bool div_mode) {
    ...
    return op.call(x1, x2, gamma, scales1, zero_points1, beta, scales2, zero_points2, axis, epsilon, div_mode);
}
::std::tuple<at::Tensor,at::Tensor> npu_attention_update(at::TensorList lse, at::TensorList local_out, int64_t update_type) {
    ...
    return op.call(lse, local_out, update_type);
}
...
::std::tuple<at::Tensor,at::Tensor> npu_all_gather_base_mm(const at::Tensor & self, const at::Tensor & x2, c10::string_view hcom, int64_t world_size, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & x1_scale, const ::std::optional<at::Tensor> & x2_scale, int64_t gather_index, bool gather_output, int64_t comm_turn, ::std::optional<at::ScalarType> output_dtype, ::std::optional<c10::string_view> comm_mode) {
    ...
    return op.call(self, x2, hcom, world_size, bias, x1_scale, x2_scale, gather_index, gather_output, comm_turn, output_dtype, comm_mode);
}
...
::std::tuple<at::Tensor,at::Tensor> npu_apply_rotary_pos_emb(const at::Tensor & query, const at::Tensor & key, const at::Tensor & cos, const at::Tensor & sin, c10::string_view layout, c10::string_view rotary_mode) {
    ...
    return op.call(query, key, cos, sin, layout, rotary_mode);
}
...
::std::tuple<at::Tensor,at::Tensor> npu_kv_rmsnorm_rope_cache_v2(const at::Tensor & kv, const at::Tensor & gamma, const at::Tensor & cos, const at::Tensor & sin, const at::Tensor & index, at::Tensor & k_cache, at::Tensor & ckv_cache, const ::std::optional<at::Tensor> & k_rope_scale, const ::std::optional<at::Tensor> & c_kv_scale, const ::std::optional<at::Tensor> & k_rope_offset, const ::std::optional<at::Tensor> & c_kv_offset, double epsilon, c10::string_view cache_mode, bool is_output_kv) {
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor> npu_moe_token_permute_with_routing_map(const at::Tensor & tokens, const at::Tensor & routing_map, const ::std::optional<at::Tensor> & probs, ::std::optional<int64_t> num_out_tokens, bool drop_and_pad) {
    ...
    return op.call(tokens, routing_map, probs, num_out_tokens, drop_and_pad);
}
::std::tuple<at::Tensor,at::Tensor> npu_moe_token_permute_with_routing_map_grad(const at::Tensor & permuted_token_out_grad, const ::std::optional<at::Tensor> & probs_grad, const at::Tensor & sorted_indices, const at::Tensor & routing_map, c10::SymInt experts_num, c10::SymInt tokens_num, bool drop_and_pad) {
    ...
    return op.call(permuted_token_out_grad, probs_grad, sorted_indices, routing_map, experts_num, tokens_num, drop_and_pad);
}
...
at::Tensor _npu_fused_infer_attention_score_v2_get_max_workspace(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, const ::std::optional<at::Tensor> & query_rope, const ::std::optional<at::Tensor> & key_rope, const ::std::optional<at::Tensor> & pse_shift, const ::std::optional<at::Tensor> & atten_mask, at::OptionalSymIntArrayRef actual_seq_qlen, at::OptionalSymIntArrayRef actual_seq_kvlen, const ::std::optional<at::Tensor> & block_table, const ::std::optional<at::Tensor> & dequant_scale_query, const ::std::optional<at::Tensor> & dequant_scale_key, const ::std::optional<at::Tensor> & dequant_offset_key, const ::std::optional<at::Tensor> & dequant_scale_value, const ::std::optional<at::Tensor> & dequant_offset_value, const ::std::optional<at::Tensor> & dequant_scale_key_rope, const ::std::optional<at::Tensor> & quant_scale_out, const ::std::optional<at::Tensor> & quant_offset_out, const ::std::optional<at::Tensor> & learnable_sink, int64_t num_query_heads, int64_t num_key_value_heads, double softmax_scale, int64_t pre_tokens, int64_t next_tokens, c10::string_view input_layout, int64_t sparse_mode, int64_t block_size, int64_t query_quant_mode, int64_t key_quant_mode, int64_t value_quant_mode, int64_t inner_precise, bool return_softmax_lse, ::std::optional<int64_t> query_dtype, ::std::optional<int64_t> key_dtype, ::std::optional<int64_t> value_dtype, ::std::optional<int64_t> query_rope_dtype, ::std::optional<int64_t> key_rope_dtype, ::std::optional<int64_t> key_shared_prefix_dtype, ::std::optional<int64_t> value_shared_prefix_dtype, ::std::optional<int64_t> dequant_scale_query_dtype, ::std::optional<int64_t> dequant_scale_key_dtype, ::std::optional<int64_t> dequant_scale_value_dtype, ::std::optional<int64_t> dequant_scale_key_rope_dtype) {
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,int64_t,int64_t,int64_t> npu_fusion_attention(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, int64_t head_num, c10::string_view input_layout, const ::std::optional<at::Tensor> & pse, const ::std::optional<at::Tensor> & padding_mask, const ::std::optional<at::Tensor> & atten_mask, double scale, double keep_prob, int64_t pre_tockens, int64_t next_tockens, int64_t inner_precise, at::OptionalIntArrayRef prefix, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_seq_kvlen, int64_t sparse_mode, bool gen_mask_parallel, bool sync, c10::string_view softmax_layout) {
    ...
    return op.call(query, key, value, head_num, input_layout, pse, padding_mask, atten_mask, scale, keep_prob, pre_tockens, next_tockens, inner_precise, prefix, actual_seq_qlen, actual_seq_kvlen, sparse_mode, gen_mask_parallel, sync, softmax_layout);
}
...
at::Tensor npu_grouped_matmul_finalize_routing(const at::Tensor & x, const at::Tensor & w, const at::Tensor & group_list, const ::std::optional<at::Tensor> & scale, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & offset, const ::std::optional<at::Tensor> & pertoken_scale, const ::std::optional<at::Tensor> & shared_input, const ::std::optional<at::Tensor> & logit, const ::std::optional<at::Tensor> & row_index, ::std::optional<at::ScalarType> dtype, ::std::optional<double> shared_input_weight, ::std::optional<int64_t> shared_input_offset, ::std::optional<int64_t> output_bs, ::std::optional<int64_t> group_list_type, at::OptionalIntArrayRef tuning_config) {
    ...
    return op.call(x, w, group_list, scale, bias, offset, pertoken_scale, shared_input, logit, row_index, dtype, shared_input_weight, shared_input_offset, output_bs, group_list_type, tuning_config);
}
...
at::Tensor npu_mm_reduce_scatter_base(const at::Tensor & self, const at::Tensor & x2, c10::string_view hcom, int64_t world_size, c10::string_view reduce_op, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & x1_scale, const ::std::optional<at::Tensor> & x2_scale, int64_t comm_turn, ::std::optional<at::ScalarType> output_dtype, ::std::optional<c10::string_view> comm_mode) {
    ...
    return op.call(self, x2, hcom, world_size, reduce_op, bias, x1_scale, x2_scale, comm_turn, output_dtype, comm_mode);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> npu_moe_init_routing_quant(const at::Tensor & x, const at::Tensor & expert_idx, const ::std::optional<at::Tensor> & scale, const ::std::optional<at::Tensor> & offset, int64_t active_num, int64_t expert_capacity, int64_t expert_num, int64_t drop_pad_mode, int64_t expert_tokens_num_mode, bool expert_tokens_before_capacity_flag, int64_t quant_mode) {
    ...
    return op.call(x, expert_idx, scale, offset, active_num, expert_capacity, expert_num, drop_pad_mode, expert_tokens_num_mode, expert_tokens_before_capacity_flag, quant_mode);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> npu_ffn_worker_batching(const at::Tensor & schedule_context, int64_t expert_num, at::IntArrayRef max_out_shape, int64_t token_dtype, int64_t need_schedule, int64_t layer_num) {
    ...
    return op.call(schedule_context, expert_num, max_out_shape, token_dtype, need_schedule, layer_num);
}
...
::std::tuple<at::Tensor,at::Tensor> npu_moe_update_expert(const at::Tensor & expert_ids, const at::Tensor & eplb_table, const ::std::optional<at::Tensor> & expert_scales, const ::std::optional<at::Tensor> & pruning_threshold, const ::std::optional<at::Tensor> & active_mask, int64_t local_rank_id, int64_t world_size, int64_t balance_mode) {
    ...
    return op.call(expert_ids, eplb_table, expert_scales, pruning_threshold, active_mask, local_rank_id, world_size, balance_mode);
}
...
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> npu_add_rms_norm_dynamic_quant(const at::Tensor & x1, const at::Tensor & x2, const at::Tensor & gamma, const ::std::optional<at::Tensor> & smooth_scale1, const ::std::optional<at::Tensor> & smooth_scale2, const ::std::optional<at::Tensor> & beta, double epsilon, ::std::array<bool,2> output_mask) {
    ...
    return op.call(x1, x2, gamma, smooth_scale1, smooth_scale2, beta, epsilon, output_mask);
}
::std::tuple<at::Tensor,at::Tensor> npu_attention_worker_combine(const at::Tensor & schedule_context, const at::Tensor & expert_scales, const at::Tensor & layer_id, int64_t hidden_size, int64_t token_dtype, int64_t need_schedule) {
    ...
    return op.call(schedule_context, expert_scales, layer_id, hidden_size, token_dtype, need_schedule);
}
...
at::Tensor npu_quant_matmul_reduce_sum(const at::Tensor & x1, const at::Tensor & x2, const ::std::optional<at::Tensor> & x1_scale, const ::std::optional<at::Tensor> & x2_scale) {
    ...
    return op.call(x1, x2, x1_scale, x2_scale);
}
...
::std::tuple<at::Tensor,at::Tensor> npu_scatter_pa_kv_cache_functional(const at::Tensor & key, const at::Tensor & value, const at::Tensor & key_cache, const at::Tensor & value_cache, const at::Tensor & slot_mapping, const ::std::optional<at::Tensor> & compress_lens, const ::std::optional<at::Tensor> & compress_seq_offsets, const ::std::optional<at::Tensor> & seq_lens) {
    ...
    return op.call(key, value, key_cache, value_cache, slot_mapping, compress_lens, compress_seq_offsets, seq_lens);
}
void npu_scatter_pa_kv_cache(const at::Tensor & key, const at::Tensor & value, at::Tensor & key_cache, at::Tensor & value_cache, const at::Tensor & slot_mapping, const ::std::optional<at::Tensor> & compress_lens, const ::std::optional<at::Tensor> & compress_seq_offsets, const ::std::optional<at::Tensor> & seq_lens) {
...
::std::tuple<at::Tensor,at::Tensor> npu_swiglu_quant(const at::Tensor & x, const ::std::optional<at::Tensor> & smooth_scales, const ::std::optional<at::Tensor> & offsets, const ::std::optional<at::Tensor> & group_index, bool activate_left, int64_t quant_mode, int64_t group_list_type, ::std::optional<at::ScalarType> dst_type) {
    ...
    return op.call(x, smooth_scales, offsets, group_index, activate_left, quant_mode, group_list_type, dst_type);
}
::std::tuple<at::Tensor,at::Tensor> npu_dequant_swiglu_quant(const at::Tensor & x, const ::std::optional<at::Tensor> & weight_scale, const ::std::optional<at::Tensor> & activation_scale, const ::std::optional<at::Tensor> & bias, const ::std::optional<at::Tensor> & quant_scale, const ::std::optional<at::Tensor> & quant_offset, const ::std::optional<at::Tensor> & group_index, bool activate_left, int64_t quant_mode, int64_t swiglu_mode, double clamp_limit, double glu_alpha, double glu_bias) {
    ...
    return op.call(x, weight_scale, activation_scale, bias, quant_scale, quant_offset, group_index, activate_left, quant_mode, swiglu_mode, clamp_limit, glu_alpha, glu_bias);
}
...
at::Tensor obfuscation_initialize(int64_t hidden_size, int64_t tp_rank, int64_t cmd, ::std::optional<at::ScalarType> data_type, ::std::optional<int64_t> model_obf_seed_id, ::std::optional<int64_t> data_obf_seed_id, ::std::optional<int64_t> thread_num, ::std::optional<double> obf_coefficient) {
    ...
    return op.call(hidden_size, tp_rank, cmd, data_type, model_obf_seed_id, data_obf_seed_id, thread_num, obf_coefficient);
}
at::Tensor obfuscation_finalize(const at::Tensor & fd_to_close) {
    ...
    return op.call(fd_to_close);
}
at::Tensor obfuscation_calculate(const at::Tensor & fd, const at::Tensor & x, const at::Tensor & param, ::std::optional<double> obf_coefficient) {
    ...
    return op.call(fd, x, param, obf_coefficient);
}
...
void npu_advance_step_flashattn(at::Tensor & input_tokens, const at::Tensor & sampled_token_ids, at::Tensor & input_positions, at::Tensor & seq_lens, at::Tensor & slot_mapping, const at::Tensor & block_tables, int64_t num_seqs, int64_t num_queries, int64_t block_size, const ::std::optional<at::Tensor> & spec_token, const ::std::optional<at::Tensor> & accepted_num) {
    ...
    return op.call(input_tokens, sampled_token_ids, input_positions, seq_lens, slot_mapping, block_tables, num_seqs, num_queries, block_size, spec_token, accepted_num);
}
...
at::Tensor npu_gather_sparse_index_backward(const at::Tensor & grad, c10::SymIntArrayRef self_sizes, const at::Tensor & index) {
    ...
    return op.call(grad, self_sizes, index);
}
at::Tensor _npu_index_add(const at::Tensor & self, const at::Tensor & index, const at::Tensor & source, const at::Scalar & alpha) {
    ...
    return op.call(self, index, source, alpha);
}
at::Tensor & _npu_index_add_(at::Tensor & self, const at::Tensor & index, const at::Tensor & source, const at::Scalar & alpha) {
...
::std::tuple<at::Tensor,at::Tensor> npu_nsa_compress_attention_infer(const at::Tensor & query, const at::Tensor & key, const at::Tensor & value, double scale_value, int64_t head_num, int64_t key_value_head_num, int64_t select_block_size, int64_t select_block_count, int64_t page_block_size, int64_t compress_block_size, int64_t compress_stride, c10::string_view layout, const ::std::optional<at::Tensor> & atten_mask, const ::std::optional<at::Tensor> & block_table, const ::std::optional<at::Tensor> & topk_mask, at::OptionalIntArrayRef actual_seq_qlen, at::OptionalIntArrayRef actual_cmp_seq_kvlen, at::OptionalIntArrayRef actual_sel_seq_kvlen) {
    ...
    return op.call(query, key, value, scale_value, head_num, key_value_head_num, select_block_size, select_block_count, page_block_size, compress_block_size, compress_stride, layout, atten_mask, block_table, topk_mask, actual_seq_qlen, actual_cmp_seq_kvlen, actual_sel_seq_kvlen);
}
...
at::Tensor npu_top_k_top_p(const at::Tensor & logits, const ::std::optional<at::Tensor> & p, const ::std::optional<at::Tensor> & k) {
...
at::Tensor npu_moe_token_permute_grad(const at::Tensor & tokens, const at::Tensor & grad_permuted_tokens, const at::Tensor & indices, const at::Tensor & sorted_indices, bool padded_mode) {
    ...
    return op.call(tokens, grad_permuted_tokens, indices, sorted_indices, padded_mode);
}
...
::std::tuple<at::Tensor,at::Tensor> npu_moe_token_unpermute_grad(const at::Tensor & permuted_tokens, const at::Tensor & grad_unpermuted_tokens, const at::Tensor & sorted_indices, const ::std::optional<at::Tensor> & probs, bool padded_mode, at::OptionalIntArrayRef restore_shape) {
    ...
    return op.call(permuted_tokens, grad_unpermuted_tokens, sorted_indices, probs, padded_mode, restore_shape);
}
at::Tensor npu_moe_token_unpermute_with_routing_map(const at::Tensor & permuted_tokens, const at::Tensor & sorted_indices, at::IntArrayRef restore_shape, const ::std::optional<at::Tensor> & probs, const ::std::optional<at::Tensor> & routing_map, bool drop_and_pad) {
    ...
    return op.call(permuted_tokens, sorted_indices, restore_shape, probs, routing_map, drop_and_pad);
}
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> _npu_moe_token_unpermute_with_routing_map(const at::Tensor & permuted_tokens, const at::Tensor & sorted_indices, at::IntArrayRef restore_shape, const ::std::optional<at::Tensor> & probs, const ::std::optional<at::Tensor> & routing_map, bool drop_and_pad) {
...
::std::tuple<at::Tensor,at::Tensor> npu_moe_token_unpermute_with_routing_map_grad(const at::Tensor & unpermuted_tokens_grad, const at::Tensor & out_index, const at::Tensor & permuted_token_id, const ::std::optional<at::Tensor> & routing_map, const ::std::optional<at::Tensor> & permuted_tokens, const ::std::optional<at::Tensor> & probs, bool drop_and_pad, at::IntArrayRef restore_shape) {
    ...
    return op.call(unpermuted_tokens_grad, out_index, permuted_token_id, routing_map, permuted_tokens, probs, drop_and_pad, restore_shape);
}
at::Tensor & _quantize_per_tensor_impl_out(const at::Tensor & inputs, const at::Tensor & scales, const at::Tensor & zero_points, at::ScalarType dtype, at::Tensor & result) {
    ...
    return op.call(inputs, scales, zero_points, dtype, result);
}
at::Tensor & _quantize_per_channel_impl_out(const at::Tensor & inputs, const at::Tensor & scales, const at::Tensor & zero_points, int64_t axis, at::ScalarType dtype, at::Tensor & result) {
    ...
    return op.call(inputs, scales, zero_points, axis, dtype, result);
}
::std::tuple<at::Tensor,at::Tensor> npu_dynamic_block_quant(const at::Tensor & x, double min_scale, c10::string_view round_mode, int64_t dst_type, int64_t row_block_size, int64_t col_block_size) {
    ...
    return op.call(x, min_scale, round_mode, dst_type, row_block_size, col_block_size);
}
::std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor,at::Tensor> npu_fused_linear_online_max_sum(const at::Tensor & input, const at::Tensor & weight, const at::Tensor & target, int64_t vocab_start_index, int64_t vocab_end_index, bool return_logits) {
    ...
    return op.call(input, weight, target, vocab_start_index, vocab_end_index, return_logits);
}
::std::tuple<at::Tensor,at::Tensor> npu_fused_cross_entropy_loss_with_max_sum(const at::Tensor & logits_max, const at::Tensor & sum_exp_logits, const at::Tensor & predicted_logits, ::std::optional<double> label_smoothing, const ::std::optional<at::Tensor> & input, const ::std::optional<at::Tensor> & weight, const ::std::optional<at::Tensor> & vocab_parallel_logits) {
    ...
    return op.call(logits_max, sum_exp_logits, predicted_logits, label_smoothing, input, weight, vocab_parallel_logits);
}
::std::tuple<at::Tensor,at::Tensor> npu_fused_linear_cross_entropy_loss_with_max_sum_grad(const at::Tensor & grad, const at::Tensor & input, const at::Tensor & weight, const at::Tensor & target_mask, const at::Tensor & masked_target, double label_smoothing, const ::std::optional<at::Tensor> & logits_max, const ::std::optional<at::Tensor> & sum_exp_logits, const ::std::optional<at::Tensor> & softmax) {
    ...
    return op.call(grad, input, weight, target_mask, masked_target, label_smoothing, logits_max, sum_exp_logits, softmax);
}
